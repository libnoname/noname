    ...
    game.addVideo('storage',player,['xxy_yingjian',player.storage.xxy_yingjian]);
        ...
        var chat=['冥王也怕我三分','我怎会死亡'].randomGet()
            ...
            "xxy_tiannai":{
                ...
                forced:true,
                content:function (){
          game.broadcastAll()+ui.background.setBackgroundImage("extension/渐意新生/xxy_weewh.jpg");
          game.log(player,'将场地切换为清风逍悦');
          ui.backgroundMusic.src=lib.assetURL+'extension/渐意新生/xxy_nuhuayachongzhi.mp3'; 
