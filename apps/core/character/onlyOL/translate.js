...
const translates = {
	...
	ol_jie_zhuran: "OL界朱然",
	ol_jie_zhuran_prefix: "OL界",
	ol_jie_danshou: "胆守",
	ol_jie_danshou_info: "出牌阶段每项限一次，若你有牌，你可以选择一名角色执行以下一项：1.你弃置其一张牌；2.你获得其一张牌；3.你对其造成1点伤害；4.你与其各摸两张牌。然后你弃置本次执行序号数张牌（不足则全弃）。",
	ol_zhuhuan: "OL界朱桓",
	ol_zhuhuan_prefix: "OL界",
	ol_fenli: "奋励",
	ol_fenli_info: "若你的手牌数/体力值/装备区里的牌数为全场最大，你可以跳过摸牌阶段/出牌阶段/弃牌阶段。",
	ol_pingkou: "平寇",
	ol_pingkou_info: "回合结束时，你可以对至多X名其他角色各造成1点伤害（X为你本回合跳过的阶段数）。你每以此法造成1次伤害，摸一张牌（每名角色限一次）。",
	dm_zhangfei: "魔张飞",
