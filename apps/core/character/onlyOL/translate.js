...
const translates = {
	...
	pxwenxi: "闻喜",
	pxwenxi_info: "你每回合首次使用一个花色的牌后，你摸一张牌。",
	pxhongnong: "弘农",
	pxhongnong_info: "你可以重铸任意张装备牌并回复1点体力。",
	pxsizhou: "司州",
	pxsizhou_info: "你可以获得一名角色一张手牌。",
	pxtaishan: "泰山",
	pxtaishan_info: "将一张【螭纹玉佩】置入手牌。",
	pxchenliu: "陈留",
	pxchenliu_info: "你跳过弃牌阶段。",
	pxjuancheng: "鄄城",
	pxjuancheng_info: "你判定，若为黑色，你获得判定牌并重复此流程。",
	pxjuting: "句町",
	pxjuting_info: "你可以失去1点体力，然后摸三张牌。",
	pxchengdu: "成都",
	pxchengdu_info: "你对自己使用牌后，你摸一张牌（每回合限一次）。",
	pxbeihai: "北海",
	pxbeihai_info: "你将手牌摸至体力上限。",
	pxlinzi: "临淄",
	pxlinzi_info: "你获得弃牌堆中三张随机的梅花牌。",
	pxyanzhou: "兖州",
	pxyanzhou_info: "你回复体力后，你摸一张牌（每回合限一次）。",
	pxhefei: "合肥",
	pxhefei_info: "你可以弃置至多两张牌，然后摸等量的牌。",
	pxqingzhou: "青州",
	pxqingzhou_info: "你可以弃置所有手牌，然后摸等量的牌。",
	pxpingyuan: "平原",
	pxpingyuan_info: "你失去最后的手牌后，你摸一张牌（每回合限一次）。",
	pxbohai: "渤海",
	pxbohai_info: "你可以弃置一张武器牌，然后摸两张牌。",
	pxjulu: "巨鹿",
	pxjulu_info: "你失去黑桃2~9的牌后，你摸一张牌（每回合限一次）。",
	pxjizhou: "冀州",
	pxjizhou_info: "你从牌堆获得一张【万箭齐发】。",
	pxhandan: "邯郸",
	pxhandan_info: "你使用一张非伤害普通锦囊后，你令一名角色获得此牌（每回合限一次）。",
	pxxuchang: "许昌",
	pxxuchang_info: "你可令一名其他角色攻击范围增加至与你相同。",
	pxguangling: "广陵",
	pxguangling_info: "你可以将两张牌当一张【五谷丰登】使用。",
	pxbaxi: "巴西",
	pxbaxi_info: "你可以指定一名其他角色，其当前手牌无次数限制。",
	pxyuzhou: "豫州",
	pxyuzhou_info: "你可以进入连环状态，令一名体力值小于你的角色回复1点体力。",
	pxpengcheng: "彭城",
	pxpengcheng_info: "你可以令一名其他角色交给你一张牌，然后其回复1点体力。",
	pxdonghai: "东海",
	pxdonghai_info: "你令一名角色下个摸牌阶段多摸一张牌。",
	pxxuzhou: "徐州",
	pxxuzhou_info: "你可以指定一名其他角色，其于其的回合外使用牌后摸一张牌。",
	pxlangya: "琅琊",
	pxlangya_info: "你观看牌堆顶的五张牌，然后以任意顺序置于牌堆顶或牌堆底。",
	pxyangzhou: "扬州",
	pxyangzhou_info: "你可以令一名其他角色回复1点体力。",
	pxnanyang: "南阳",
	pxnanyang_info: "你可以重铸一张锦囊牌，与一名角色各回复1点体力。",
	pxxiangyang: "襄阳",
	pxxiangyang_info: "你可以移动场上一张牌。",
	pxjiangxia: "江夏",
	pxjiangxia_info: "你可以令一名其他角色摸两张牌，然后交给你一张牌。",
	pxshangyong: "上庸",
	pxshangyong_info: "你可以与一名其他角色各摸一张牌。",
	pxjingzhou: "荆州",
	pxjingzhou_info: "你可以交给一名角色任意张手牌。",
	pxshouchun: "寿春",
	pxshouchun_info: "你可令一名角色加1点体力上限。",
	pxlujiang: "庐江",
	pxlujiang_info: "你可以拼点，赢的角色摸两张牌。",
	pxdonglai: "东莱",
	pxdonglai_info: "你可令一名角色使用的下一张牌无次数和距离限制。",
	pxlongxi: "陇西",
	pxlongxi_info: "你从牌堆中获得一张防御坐骑牌。",
	pxqinzhou: "秦州",
	pxqinzhou_info: "你可选择一名其他角色，其使用的下一张牌对你无效。",
	pxtianshui: "天水",
	pxtianshui_info: "你可以弃置一名角色一张手牌，若不为【杀】，你摸两张牌。",
	pxjuchao: "居巢",
	pxjuchao_info: "你可以弃置你与一名角色各一张牌。",
	pxyinping: "阴平",
	pxyinping_info: "其他角色计算与你的距离+1。",
	pxhanzhong: "汉中",
	pxhanzhong_info: "你可以与一名其他角色交换手牌。",
	pxliangzhou: "梁州",
	pxliangzhou_info: "你成为【杀】的目标后，使用者弃置一张牌。",
	pxyizhou: "益州",
	...
	pxrencheng: "任城",
	pxrencheng_info: "你每有一张【杀】，手牌上限便+1。",
	pxchangshan: "常山",
	pxchangshan_info: "你从牌堆中获得两张【闪】。",
	pxzhuti: "朱提",
	pxzhuti_info: "你受到属性伤害改为回复等量体力（每回合限一次）。",
	pxzangke: "牂牁",
	pxzangke_info: "你受到伤害后，你可以弃置你与伤害来源各一张牌。",
	pxjingzhao: "京兆",
	pxjingzhao_info: "若有角色本回合对你使用过：【杀】/伤害锦囊牌，伤害锦囊牌/【杀】对你无效。",
	pxfengyi: "冯翊",
	pxfengyi_info: "你可以回复1点体力。",
	pxfufeng: "扶风",
	pxfufeng_info: "你从牌堆获得一张你手牌中未拥有类型的牌。",
	pxanding: "安定",
	pxanding_info: "防止你因传导受到的属性伤害。",
	pxfanyang: "范阳",
	pxfanyang_info: "你可以对攻击范围内的一名角色造成1点伤害。",
	pxbeiping: "北平",
	pxbeiping_info: "你从牌堆中获得两张【杀】。",
	pxxuantu: "玄菟",
	pxxuantu_info: "有角色进入濒死状态时，你获得使其进入此濒死状态的牌（每回合限一次）。",
	pxdaifang: "带方",
	pxdaifang_info: "你的属性【杀】不能被响应。",
	pxlinqiong: "临邛",
	pxlinqiong_info: "你可以令任意名角色同时弃置一张牌。",
	pxqixian: "祁县",
	pxqixian_info: "你可以重铸一张装备牌，视为使用一张【杀】或【过河拆桥】（每回合限一次）。",
	pxyanmen: "雁门",
	pxyanmen_info: "你从牌堆中获得一张武器牌和一张进攻坐骑牌。",
	pxjiuyuan: "九原",
	pxjiuyuan_info: "你使用【杀】可以额外指定任意名目标。",
	pxwuxiang: "武乡",
	pxwuxiang_info: "你从牌堆中获得一张【火攻】。",
	pxyumen: "玉门",
	pxyumen_info: "已连环的角色不能响应你的牌。",
	pxwuwei: "武威",
	pxwuwei_info: "你使用伤害牌可以额外指定一个目标（每回合限一次）。",
	pxjuyan: "居延",
	pxjuyan_info: "你从牌堆中获得三张攻击范围各不相同的武器牌。",
	pxdunhuang: "敦煌",
	pxdunhuang_info: "你的【杀】被抵消后，你摸一张牌。",
	pxningzhou: "宁州",
	pxningzhou_info: "你使用的【杀】不能被抵消，且造成的伤害均视为体力流失。",
	pxailao: "哀牢",
	pxailao_info: "你可以令一名角色选择：其弃置两张牌，或其失去1点体力。",
	pxdianchi: "滇池",
	pxdianchi_info: "一名角色受到火焰伤害后，你可以令其失去1点体力（每回合限一次）。",
	pxbingzhou: "并州",
	pxbingzhou_info: "你可以视为使用一张【决斗】。",
	pxnanfu: "南涪",
	pxnanfu_info: "你可以失去1点体力，视为使用一张【杀】。",
	pxyongzhou: "雍州",
	pxyongzhou_info: "你可以摸两张牌，然后将手牌弃至手牌上限。",
	pxyouzhou: "幽州",
	pxyouzhou_info: "你加1点体力上限。",
	pxliangzhoux: "凉州",
	pxliangzhoux_info: "你可以将一张黑色牌当【杀】使用。",
	pxlean: "乐安",
	pxlean_info: "你从牌堆获得一张属性【杀】和一张【铁索连环】。",
	pxpeixian: "沛县",
	pxpeixian_info: "你的普通锦囊牌不能被响应。",
	pxqiaoxian: "谯县",
	pxqiaoxian_info: "你受到伤害后，可以摸一张牌。",
	pxrunan: "汝南",
	pxrunan_info: "你可以令一名角色摸等同于你手牌上限的牌。",
	pxwudu: "武都",
