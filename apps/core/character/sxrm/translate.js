...
const translates = {
	...
	sxrmjiaozong: "骄纵",
	sxrmjiaozong_info: "准备阶段或当你成为【杀】的目标后，你可以移动场上一张装备牌，以此法装备区被置入牌的角色本回合不能使用与之颜色相同的牌且受到的伤害+1。",
	sxrmfusui: "妇随",
	...
	sxrm_lusu_prefix: "嗔",
	sxrmwanli: "万利",
	sxrmwanli_info: "①首轮开始时，你可以选择一名其他角色并交给其任意张牌，若如此做，第四轮结束时，其交给你三倍数量的牌（不足则全给并失去所有技能）。②摸牌阶段，若你因〖万利①〗选择的角色已还牌或死亡，你多摸三张牌。",
	sxrmlishui: "理说",
	sxrmlishui_info: `当你成为黑色牌的目标后，你可以摸一张牌并与一名未还牌的因〖万利①〗选择的角色拼点：若你赢，其提前一轮还牌。`,
	...
	sxrmfanxin: "燔心",
	sxrmfanxin_info: `①游戏开始或你以此法选择的角色死亡后，你可以选择一名其他角色，称为“燔心”角色。其获得${get.poptip("baonu")}和${get.poptip("wumou")}。②“燔心”角色回合开始时，你可以移去其至多5枚“暴怒”标记并摸等量张牌。`,
	sxrm_jiahua: "嗔贾华",
