...
const translates = {
	...
	clan_xunguan: "族荀灌",
	clanxunguan_zhuiji: "追迹",
	clanxunguan_zhuiji_info: "锁定技，当你每回合首次使用黑色牌后，你令一名角色用一张手牌交换此牌。",
	clanxunguan_yunying: "云影",
	clanxunguan_yunying_info: "锁定技，每个结束阶段，上次“追迹”目标角色每满足一项，你便执行一项：1.本回合扣减过体力，你将所有黑色手牌当无距离限制的【杀】使用；2.本回合失去过手牌，你将手牌摸至X张（X为本回合进入弃牌堆的黑色牌数且至多为5）。",
	clan_zhugeguo: "族诸葛果",
	clanfuyao: "扶摇",
	clanfuyao_shown: "已展示",
	clanfuyao_info: "转换技。出牌阶段，你可以将手牌中展示过和未展示过的牌：阳，展示未展示过的手牌至两者数量相同；阴，弃置展示过或未展示过的手牌至两者数量相同。然后你视为使用一张本阶段未以此法使用过的单目标普通锦囊牌。",
	clanfenshi: "纷势",
	clanfenshi_count: "势力数",
	clanfenshi_info: "宗族技。每回合限一次，若有同族角色手牌数等于场上势力数，则你使用的普通锦囊牌可额外结算一次。族诸葛果视武将名带有“诸葛”的角色为同族角色。你拥有“势”标记，显示当前场上势力数。",
	clan_zhugezhan: "族诸葛瞻",
	clanzhugezhan_chengwang: "承望",
	clanzhugezhan_chengwang_info: "每回合限一次，转换技，当你需要使用牌时（无懈可击除外），你可将手牌：阳：摸至与全场最多相同，然后若你使用了牌，你可令一名角色弃两张牌；阴：弃至与全场最少相同，然后若你使用了牌，你可令一名角色摸两张牌。若你未使用牌，你与当前回合角色各失去1点体力。",
	clanzhugezhan_fenshi: "纷势",
	clanzhugezhan_fenshi_info: "宗族技，每回合限一次，若有同族角色手牌数等于势力数，你的锦囊牌可额外结算一次。",
	clan_hanshao: "族韩韶",
	clanfangzhen: "放赈",
