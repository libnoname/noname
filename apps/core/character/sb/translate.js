...
const translates = {
	...
	sbjieyin: "结姻",
	sbjieyin_info: `使命技。①你的登场势力为蜀。②游戏开始时，你选择并记录一名其他角色，称为“结姻”角色。③“结姻”角色死亡后，你减少1点体力上限；“结姻”角色的出牌阶段开始时，你选择一项：1.令其获得1点护甲；2.你将势力变更为吴，然后获得其至多X张牌（X为游戏轮数且至多为3）。④成功：若“结姻”角色护甲值为5，你每轮首次发动${get.poptip("sbxiaoji")}后获得1点护甲。⑤成功：若“结姻”角色装备区牌数为4，你发动${get.poptip("sbxiaoji")}后，本回合使用【杀】的次数上限+1。⑥失败：若“结姻”角色死亡或你的势力为吴，你清除“结姻”记录，重铸所有红桃手牌，然后摸两张牌。`,
	sbliangzhu: "良助",
