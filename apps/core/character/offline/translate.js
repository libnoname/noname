...
const translates = {
	...
	psjiefa: "竭伐",
	psjiefa_info: `你使用伤害牌指定单一目标时，选择一项：1.若目标体力值大于游戏内角色数，此牌可额外指定一个目标；2.若你的体力上限小于其，你可令此牌额外执行一次。<br>${get.poptip("rule_chengshi")}：你将体力回复至上限或将手牌摸至上限。<br>${get.poptip("rule_beishui")}：你失去X点体力（X为你背水的次数）。`,
