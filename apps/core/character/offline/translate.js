...
const translates = {
	...
	ylyg_sunce_jiang: "激昂",
	ylyg_sunce_jiang_info: "一名角色使用【决斗】或红色【杀】指定目标后，你可以与其各摸一张牌。你的K点牌均视为【杀】。",
	ylyg_sunce_hunzi: "魂姿",
	ylyg_sunce_hunzi_info: `觉醒技，当你的体力值变为1时，你加1点体力上限并获得${get.poptip("reyingzi")}和${get.poptip("yinghun")}。`,
	ylyg_sunce_zhiba: "制霸",
	ylyg_sunce_zhiba_info: "主公技，吴势力角色的准备阶段，你可以令其与另一名角色拼点：若其赢，其视为对该角色使用一张【决斗】。",
	ylyg_caiwenji: "雁翎蔡文姬",
	ylyg_caiwenji_prefix: "雁翎",
	ylyg_caiwenji_duanchang: "断肠",
	ylyg_caiwenji_duanchang_info: "锁定技，当你死亡时，你选择一项令杀死你的角色执行：1.失去所有技能；2.弃置所有牌。",
	ylyg_caiwenji_beige: "悲歌",
	ylyg_caiwenji_beige_info: `当一名角色受到【杀】造成的伤害后，你可以弃置一张牌，然后令其判定并记录花色（当记录了所有花色后，你获得${get.poptip("ylyg_caiwenji_quzhong")}）。若结果为：♥，其回复X点体力（X为此伤害值）；♦，其摸三张牌；♣，伤害来源弃置两张牌；♠，伤害来源翻面。`,
	ylyg_caiwenji_quzhong: "曲终",
	ylyg_caiwenji_quzhong_info: "每名角色的结束阶段，你可以将你本回合弃置的一张牌当【杀】使用；当你在此【杀】结算中发动〖悲歌〗时，交换描述中的‘其’与‘伤害来源’。",
	ylyg_zhurong: "雁翎祝融",
