...
const translates = {
	...
	ps_shen_jiaxu: "★神贾诩",
	ps_shen_jiaxu_prefix: "★|神",
	psxiebing: "卸兵",
	psxiebing_info: "每轮开始时或当你受到伤害后，你可选择一项，直到本轮结束：1.废除一名其他角色的所有装备栏；2.废除所有其他角色的同一种装备栏。每回合限一次，当你受到伤害时，若伤害来源的装备区内没有装备牌，你防止此伤害。",
	pszhongshi: "众矢",
	pszhongshi_info: "限定技，出牌阶段，你可选择一名其他角色，然后你和所有体力值小于其的其他角色依次选择一项：1.失去1点体力；2.对其造成1点伤害。此阶段结束时，若于此阶段内死亡的角色数大于1，此技能视为未发动过。",
	pszhaoluan: "兆乱",
	pszhaoluan_info: "当你在场时，角色死亡后不亮出身份牌不执行身份奖惩。每个回合结束时，你可亮出你或一名死亡角色未亮出的身份牌并选择一名角色，然后若此身份牌为：忠臣：其弃置所有牌；反贼：其摸三张牌。",
