...
const translates = {
	...
	pskuifa: "馈伐",
	pskuifa_info: `你使用伤害牌指定多个目标时，选择一项：1.若此牌指定目标数小于存活人数时，你可令你本回合的出【杀】次数+1；2.若此牌指定目标数不小于你的体力值时，你可摸不为此牌目标的其他角色数张牌。<br>${get.poptip("rule_chengshi")}：此牌不可被响应。<br>${get.poptip("rule_beishui")}：你失去X点体力（X为你的背水次数）。`,
	psnimou: "逆谋",
