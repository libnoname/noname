...
const translates = {
	...
	xijue: "袭爵",
	xijue_gain: "袭爵",
	xijue_info: `锁定技，游戏开始时，你获得4枚“爵”。结束阶段，你获得X枚“爵”（X为你本回合内造成的伤害数）。你可弃置一枚“爵”并在合适的时机发动${get.poptip("xijue_tuxi")}和${get.poptip("xijue_xiaoguo")}。`,
	xijue_info_guozhan: `锁定技，当你首次明置此武将牌时，你获得4枚“爵”。结束阶段，你获得X枚“爵”（X为你本回合内造成的伤害数）。你可弃置一枚“爵”并在合适的时机发动${get.poptip("xijue_tuxi")}和${get.poptip("xijue_xiaoguo")}。`,
	xijue_tuxi: "突袭",
	...
	sanchen_info_guozhan: `出牌阶段，你可选择一名本回合内未选择过的角色。其摸三张牌，然后弃置三张牌。若其未以此法弃置牌或以此法弃置的牌的类别均不相同，则其摸一张牌且你获得技能${get.poptip("pozhu")}直到回合结束。否则你本阶段内不能再发动〖三陈〗。`,
	zhaotao: "昭讨",
	zhaotao_info: `觉醒技，准备阶段，若你本局游戏内发动〖三陈〗的次数大于2，则你减1点体力上限并获得${get.poptip("pozhu")}。`,
	pozhu: "破竹",
	pozhu_info: `出牌阶段，你可以将一张手牌当做${get.poptip("chuqibuyi")}使用。若你未因此牌造成过伤害，则你不能再发动〖破竹〗直到回合结束。`,
	pozhu_info_guozhan: `出牌阶段限一次，你可以将一张手牌当做${get.poptip("chuqibuyi")}使用。`,
	jin_wangyuanji: "晋王元姬",
	jin_wangyuanji_prefix: "晋",
	shiren: "识人",
	shiren_info: `隐匿技。你于其他角色的回合内登场时，若其有手牌，则你可对其发动${get.poptip("yanxi")}。`,
	yanxi: "宴戏",
	yanxi2: "宴戏",
