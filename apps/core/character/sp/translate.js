...
const translates = {
	...
	olkedi: "柯笛",
	olkedi_info: "你于出牌阶段使用的前两张手牌结算后，你可以令一名角色重铸一张牌，若重铸牌与你使用的牌花色相同，你可以使用此牌。",
	olcunze: "存择",
	olcunze_info: "结束阶段，你可以秘密选择一名角色，其于你下回合开始前首次进入濒死时，回复体力至1点，然后你不能使用【桃】直到你的下回合开始。",
	ol_qiaoxuan: "OL桥玄",
    ...
    dc_huanhuaijin:"环怀瑾",
    dc_lianyou:"怜幼",
    dc_lianyou_info:"每轮每项限一次，你受到伤害后可选择一项：1.令一名体力值最少的角色回复2点体力；2.令一名装备区牌最少的角色随机使用牌堆或弃牌堆中两张装备牌；3.摸三张牌并可以交给一名手牌数最少的其他角色三张牌。",
    dc_cili:"慈厉",
    dc_cili_info:"每轮开始时，你可记录一名其他角色的体力值，其下回合结束时，若此回合内其使用的牌数小于记录值，其随机弃置记录值张牌；否则其摸记录值张牌。",
	ol_lvlingqi: "OL吕玲绮",
