...
const translates = {
	...
	shanzhuan: "擅专",
	shanzhuan_info: "①当你对其他角色造成伤害后，若其判定区没有延时类锦囊牌，则你可以将其的一张牌置于其的判定区。若此牌不为延时锦囊牌且此牌为：红色，此牌视为【乐不思蜀】；黑色，此牌视为【兵粮寸断】。②结束阶段，若你本回合内未造成伤害，你可摸一张牌。",
	spniluan: "逆乱",
	...
	juesheng: "决生",
	juesheng_info: "限定技。出牌阶段，你可视为使用一张【决斗】。当此【决斗】造成伤害时，你将伤害值改为X（X为目标角色本局游戏内使用过【杀】的数量+1）且令目标角色获得此技能直到其下回合结束。",
	qinghegongzhu: "清河公主",
	zengou: "谮构",
	...
	ol_puyuan_prefix: "OL",
	olshengong: "神工",
	olshengong_info: "出牌阶段每项限一次。你可以弃置一张武器牌/防具牌/其他装备牌，并发起一次“锻造”。然后你从锻造结果中选择一张牌，置于一名角色的装备区内（可替换原装备）。当有因你发动〖神工〗而加入游戏的牌进入弃牌堆后，你将此牌移出游戏，然后此回合结束阶段，你摸一张牌。",
	olqisi: "奇思",
	...
	dengzhong: "邓忠",
	dzkanpo: "勘破",
	dzkanpo_info: "①当你使用【杀】对目标角色造成伤害后，你可以观看目标角色的手牌，然后获得其中一张与此【杀】花色相同的牌。②每回合限一次，你可以将一张手牌当做【杀】使用。",
	dzgengzhan: "更战",
	dzgengzhan_info: "①其他角色的出牌阶段限一次，当有【杀】因弃置而进入弃牌堆后，你可以获得其中一张【杀】。②其他角色的结束阶段，若其本回合内未使用过【杀】，则你下个出牌阶段使用【杀】的次数上限+1。",
	xiahouxuan: "夏侯玄",
	olhuanfu: "宦浮",
	...
	olrunwei: "润微",
	olrunwei_info: "一名角色的弃牌阶段开始时，若其已受伤，则你可以选择一项：①令其弃置一张牌，其本阶段手牌上限+1；②令其摸一张牌，其本阶段手牌上限-1。",
	caoxi: "曹羲",
	olgangshu: "刚述",
