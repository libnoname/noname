...
const translates = {
	...
	caoying_equip_bg: "装备",
	xinfu_lingren: "凌人",
	xinfu_lingren_info: `出牌阶段限一次，当你使用【杀】或伤害类普通锦囊牌指定目标后，你可以猜测其中的一个目标的手牌中是否有基本牌，锦囊牌或装备牌。若你猜中的项目数：≥1，此牌对该角色的伤害+1；≥2，你摸两张牌；≥3，你获得技能${get.poptip("new_rejianxiong")}${get.poptip("rexingshang")}直到你的下回合开始。`,
	xinfu_fujian: "伏间",
	...
	xinfu_falu: "法箓",
	xinfu_falu_info: "锁定技。①游戏开始时，你获得「紫薇」「后土」「玉清」「勾陈」标记。②当你的牌因弃置而进入弃牌堆后，你根据这些牌的花色获得对应的未拥有的标记：黑桃，「紫薇」；梅花，「后土」；红桃，「玉清」；方块，「勾陈」。",
	xinfu_dianhua: "点化",
	xinfu_dianhua_info: "准备阶段或结束阶段，你可以观看牌堆顶的X张牌（X为你的「紫薇」「后土」「玉清」「勾陈」标记数的总和）。若如此做，你将这些牌以任意顺序放回牌堆顶或牌堆底。",
	zhenyi: "真仪",
	zhenyi_info: "你可以在以下时机弃置相应的标记来发动以下效果：一名角色的判定牌生效前，你可以失去「紫薇」标记，将判定结果改为红桃5或黑桃5；你的回合外，你可以失去「后土」标记，将一张牌当【桃】使用；当你造成伤害时，你可以失去「玉清」标记，令此伤害+1；当你受到属性伤害后，你可以失去「勾陈」标记，从牌堆中随机获得三种类型的牌各一张。",
	zhangren: "张任",
	zoushi: "邹氏",
	zangba: "臧霸",
	gz_jiling: "纪灵",
	...
	new_mumu: "穆穆",
	new_mumu_info: "出牌阶段开始时，你可以选择一项：1.弃置一名其他角色装备区里的一张牌；2.获得一名角色装备区里的一张防具牌，若如此做，你本回合不能使用或打出【杀】。",
	new_zhixi: "止息",
	...
	zishu: "自书",
	zishu_info: "锁定技。①其他角色的结束阶段结束时，你将手牌区里所有你于此回合得到过的牌置入弃牌堆。②当你于回合内不因〖自书②〗而得到牌后，你摸一张牌。",
	yingyuan: "应援",
	yingyuan_info: "当你于回合内使用的牌结算完成后，你可以将其交给一名其他角色（相同牌名的牌每回合限一次）。",
	xinyingyuan: "应援",
	xinyingyuan_info: "当你于回合内使用一张牌后，你可以令一名其他角色随机从牌堆获得一张与该牌类型相同的牌（每种类型的牌每回合限一次）。",
	qianya: "谦雅",
	...
	sheyan: "舍宴",
	sheyan_info: "当你成为普通锦囊牌的目标时（【借刀杀人】等带有指向目标的锦囊除外），你可以为此牌增加一个目标或令此牌对其中一个目标无效。（有效目标数至少为一）",
	fuman: "抚蛮",
	fuman2: "抚蛮",
	...
	refanghun: "芳魂",
	refanghun_info: "当你使用【杀】指定目标后或成为【杀】的目标后，你获得1个“梅影”标记；你可以移去1个“梅影”标记来发动〖龙胆〗并摸一张牌。",
	fanghun_sha: "龙胆",
	fuhan: "扶汉",
	fuhan_info: "限定技，回合开始时，你可以移去所有“梅影”标记，随机观看五名未登场的蜀势力角色，将武将牌替换为其中一名角色，并将体力上限数调整为本局游戏中移去“梅影”标记的数量（至少为2，至多为8），然后回复1点体力。",
	refuhan: "扶汉",
	...
	yjixi: "觊玺",
	yjixi_info: `觉醒技，回合结束后，若你已连续三个自己回合未失去过体力，则你增加1点体力上限并回复1点体力，然后选择一项：获得${get.poptip("rewangzun")}；摸两张牌并获得当前主公的主公技。`,
	xinyongsi: "庸肆",
	xinyongsi1: "庸肆",
	xinyongsi2: "庸肆",
	...
	yongdi: "拥嫡",
	yongdi_info: "限定技，回合开始时，你可令一名其他男性角色增加1点体力上限并回复1点体力，然后若该角色的武将牌上有主公技且其不为主公，其获得此主公技。",
	regushe: "鼓舌",
	...
	benyu: "贲育",
	benyu2: "贲育",
	benyu_info: "当你受到伤害后，你可选择：①将手牌摸至与伤害来源手牌数相同（至多摸至五张）；②弃置大于伤害来源手牌数的牌，然后对其造成1点伤害。",
	zhidao: "雉盗",
	...
	linglong: "玲珑",
	linglong_info: "锁定技，若你的装备区有空置的：武器栏，你使用【杀】的次数上限+1；防具栏，视为你装备着【八卦阵】；坐骑栏，你的手牌上限+1；宝物栏，你视为拥有〖奇才〗。",
	zhenwei: "镇卫",
	zhenwei2: "镇卫",
	...
	kuangfu: "狂斧",
	kuangfu_info: "当你使用【杀】对目标角色造成伤害后，你可以选择一项：弃置其装备区内的一张牌，或将其装备区内的一张牌移动到你的装备区内。",
	xintan: "心惔",
	...
	qirang: "祈禳",
	qirang_info: "当你使用装备牌结算后，你可获得牌堆中的一张锦囊牌。若此牌为：普通锦囊牌，则当你使用此“祈禳”牌选择唯一目标后，可为此牌增加一个目标；延时锦囊牌，则你下回合发动〖羽化〗时的卜算量+1（至多为5）。",
	biluan: "避乱",
	...
	fengpo: "凤魄",
	fengpo_info: "当你每回合首次使用【杀】或【决斗】指定唯一目标后，你可以选择一项：1.摸X张牌，令此牌的伤害值基数+1；2.摸一张牌，令此牌的伤害值基数+X（X为其♦牌的数量）。",
	chenqing: "陈情",
	...
	guiming: "归命",
	guiming_info: "主公技，锁定技，你将〖残蚀〗描述中的“已受伤角色”改为“已受伤角色或其他吴势力角色”。",
	canshi: "残蚀",
	...
	qiangwu_info: "出牌阶段限一次，你可以进行判定。若如此做，直到回合结束，你使用点数小于判定结果的【杀】时不受距离限制，且你使用点数大于判定结果的【杀】时无使用次数限制。",
	...
	tianming_info: "当你成为【杀】的目标后，你可以弃置两张牌（不足则全弃，无牌则不弃），然后摸两张牌；若此时全场体力值最多的角色仅有一名且不是你，该角色也可以如此做。",
	mizhao_info: "出牌阶段限一次，你可以将所有手牌交给一名其他角色。若如此做，你令该角色与你指定的另一名有手牌的角色拼点，拼点赢的角色视为对没赢的角色使用一张【杀】。",
	...
	xinlianji: "连计",
	xinlianji_info: "出牌阶段限一次，你可以弃置一张手牌，令一名其他角色使用牌堆中的一张随机武器牌。然后其选择一项：对你指定的一名角色使用一张【杀】，或令你将其装备区里的武器牌交给任意角色。",
	xinmoucheng: "谋逞",
	...
	zhangling: "张陵",
	zlhuji: "虎骑",
	zlhuji_info: "锁定技，你与其他角色的距离-1，当你于回合外受到伤害后，你进行判定，若结果为红色，视为你对伤害来源使用一张【杀】（无距离限制）。",
	zlshoufu: "授符",
	zlshoufu2: "授符",
	zlshoufu_info: "出牌阶段限一次，你可摸一张牌，然后将一张手牌置于一名没有“箓”的其他角色的武将牌上，称为“箓”；其不能使用和打出与“箓”同类型的牌。该角色受到伤害后，或于弃牌阶段弃置至少两张与“箓”同类型的牌后，将“箓”置入弃牌堆。",
	...
	shanzhuan: "擅专",
	shanzhuan_info: "①当你对其他角色造成伤害后，若其判定区没有延时类锦囊牌，则你可以将其的一张牌置于其的判定区。若此牌不为延时锦囊牌且此牌为：红色，此牌视为【乐不思蜀】；黑色，此牌视为【兵粮寸断】。②结束阶段时，若你本回合内未造成伤害，你可摸一张牌。",
	spniluan: "逆乱",
	...
	wolongfengchu: "卧龙凤雏",
	youlong: "游龙",
	youlong_info: "转换技，每轮每项各限一次，你可以废除你的一个装备栏，视为使用一张未以此法使用过的：阳：普通锦囊牌；阴：基本牌。",
	luanfeng: "鸾凤",
	...
	duxi: "杜袭",
	quxi: "驱徙",
	quxi_info: "限定技。出牌阶段结束时，你可跳过下个弃牌阶段并选择两名手牌数不同的其他角色。你将武将牌翻至背面，令这两名角色中手牌数较少的角色获得另一名角色的一张牌并获得一枚“丰”，另一名角色获得一枚“歉”。拥有“丰”/“歉”的角色的摸牌阶段额定摸牌数+1/-1。拥有“丰”/“歉”的角色死亡时，或每轮开始时，你可转移“丰”/“歉”。",
	bixiong: "避凶",
	bixiong2: "避凶",
	bixiong_info: "锁定技，当你于弃牌阶段弃置手牌后，其他角色不能使用与这些牌花色相同的牌指定你为目标直到你的下回合开始。",
	fuwei: "扶危",
	fuwei_info: "每回合限一次。当你的牌被其他角色弃置或获得后，你可从牌堆中获得一张与这些牌名称相同的牌（若没有则改为摸一张牌）。",
	yuejian: "约俭",
	yuejian_info: "每回合限两次。当其他角色对你使用的牌A结算结束后，你可展示所有手牌。若牌A对应的实体牌中有你的手牌中没有花色的牌，则你获得牌A对应的所有实体牌。",
	ol_dengzhi: "OL邓芝",
	...
	olsujian: "素俭",
	olsujian_given: "已分配",
	olsujian_info: "锁定技。弃牌阶段开始前，你将此阶段的规则改为：{你选择一项：①将所有不为本回合得到的手牌分配给其他角色。②弃置这些手牌，然后弃置一名其他角色至多等量的牌}。",
	ol_wangrong: "OL王荣",
	...
	zuofen: "左棻",
	zhaosong: "诏颂",
	zhaosong_info: "一名其他角色的摸牌阶段结束时，若其没有因〖诏颂〗而获得的标记，则你可令其正面向上交给你一张手牌。根据此牌的类型，该角色获得对应的标记和效果：<br>锦囊牌：“诔”标记。当拥有者进入濒死状态时，其可弃置所有“诔”，将体力回复至1点并摸一张牌。<br>装备牌：“赋”标记。拥有者的出牌阶段开始时，其可弃置所有“赋”，弃置一名角色区域内的至多两张牌。<br>基本牌：“颂”标记。当使用者使用仅指定一个目标的【杀】时，其可弃置“颂”，为此【杀】增加至多两个目标（有距离限制）。",
	lisi: "离思",
	...
	olxianlve: "先略",
	olxianlve_info: "①一号位的回合开始时，你可声明并记录一个普通锦囊牌的名称并移除先前的记录。②每回合限一次，其他角色使用〖先略〗记录过的锦囊牌后，你摸两张牌并可以分配给任意其他角色，然后你可声明并记录一个普通锦囊牌的名称并移除先前的记录。",
	olxianlve_info_identity: "①主公的回合开始时，你可声明并记录一个普通锦囊牌的名称并移除先前的记录。②每回合限一次，其他角色使用〖先略〗记录过的锦囊牌后，你摸两张牌并可以分配给任意其他角色，然后你可声明并记录一个普通锦囊牌的名称并移除先前的记录。",
	olzaowang: "造王",
	olzaowang2: "造王",
	olzaowang_info: "限定技。出牌阶段，你可以令一名角色加1点体力上限，回复1点体力并摸三张牌。",
	olzaowang_info_identity_purple: "限定技。出牌阶段，你可以令一名角色加1点体力上限，回复1点体力并摸三张牌。",
	olzaowang_info_identity: "限定技。出牌阶段，你可以令一名角色加1点体力上限，回复1点体力并摸三张牌，且获得如下效果：主公死亡时，若其身份为忠臣，则其和主公交换身份牌；其死亡时，若其身份为反贼且伤害来源的身份为主公或忠臣，则以主忠胜利结束本局游戏。",
	sp_ol_zhanghe: "SP张郃",
	...
	olfengji: "丰积",
	olfengji_info: "每轮开始时，你选择：⒈本轮摸牌阶段的额定摸牌数-1，且令一名其他角色本轮摸牌阶段的额定摸牌数+2；⒉本轮摸牌阶段的额定摸牌数+1。然后你选择：⒈本轮使用【杀】的次数上限-1，且令一名其他角色本轮使用【杀】的次数上限+2；⒉本轮使用【杀】的次数上限+1。",
	olxuanhui: "旋回",
	...
	zhuitao: "追讨",
	zhuitao_info: "①准备阶段，你可记录一名未被〖追讨〗记录过的其他角色直到你对其造成伤害后。②你至所有〖追讨〗记录过的角色的距离-1。",
	fanjiangzhangda_ab: "范疆张达",
	fanjiangzhangda: "范强张达",
	yuanchou: "怨仇",
	yuanchou_info: "锁定技。当你使用黑色【杀】指定目标角色后或成为黑色【杀】的目标角色后，你令目标角色的防具技能无效直到此【杀】被抵消或造成伤害。",
	juesheng: "决生",
	juesheng_info: "限定技。出牌阶段，你可视为使用一张【决斗】。当此【决斗】造成伤害时，你将伤害值改为X（X为目标角色本局游戏内使用过【杀】的数量，至少为1）且令目标角色获得此技能直到其下回合结束。",
	qinghegongzhu: "清河公主",
	zengou: "谮构",
	zengou_info: "当有角色使用【闪】时，若其在你的攻击范围内，则你可以弃置一张非基本牌或失去1点体力，然后取消此【闪】的目标并获得其对应的实体牌。",
	qhzhangji: "长姬",
	qhzhangji_info: "一名角色的结束阶段，若你本回合内：造成过伤害，则你可以令其摸两张牌；受到过伤害，则你可以令其弃置两张牌。",
	sp_menghuo: "SP孟获",
	sp_menghuo_prefix: "SP",
	spmanwang: "蛮王",
	spmanwang_info: `出牌阶段，你可以弃置任意张牌。然后你依次执行以下选项中的前等量项：⒈获得${get.poptip("sppanqin")}。⒉摸一张牌。⒊回复1点体力。⒋摸两张牌并失去${get.poptip("sppanqin")}。`,
	sppanqin: "叛侵",
	sppanqin_info: `出牌阶段或弃牌阶段结束时，你可将你于本阶段内弃置且位于弃牌堆的所有牌当做【南蛮入侵】使用。然后若此牌被使用时对应的实体牌数不大于此牌的目标数，则你执行并移除${get.poptip("spmanwang")}中的最后一个选项。`,
	tengfanglan: "OL滕芳兰",
	...
	weizi: "卫兹",
	yuanzi: "援资",
	yuanzi_info: "每轮限一次。其他角色的准备阶段开始时，你可将所有手牌交给该角色。若如此做，当该角色于本回合内造成伤害后，若其手牌数不小于你，则你可以摸两张牌。",
	liejie: "烈节",
	liejie_info: "当你受到伤害后，你可以弃置至多三张牌，摸等量的牌，然后可弃置伤害来源的至多X张牌（X为你以此法弃置的红色牌的数量）。",
	ruiji: "OL芮姬",
	ruiji_prefix: "OL",
	qiaoli: "巧力",
	qiaoli_info: "出牌阶段各限一次，你可以将一张武器牌/非武器装备牌当作【决斗】使用。若此【决斗】对应的实体牌为武器牌，当你以此【决斗】对目标角色造成伤害后，你摸X张牌（X为此牌的攻击范围），且可以将其中任意张牌分配给其他角色；若此【决斗】对应的实体牌不为武器牌，此牌不可被响应，然后你随机获得一张装备牌。",
	qiaoli_given: "已分配",
	qingliang: "清靓",
	qingliang_info: "每回合限一次，当你成为其他角色使用【杀】或锦囊牌的目标时，你可展示所有手牌，然后选择一项：⒈你与其各摸一张牌，⒉取消此目标，然后弃置你手牌中一种花色的所有牌。",
	chixueqingfeng: "赤血青锋",
	...
	ol_puyuan_prefix: "OL",
	olshengong: "神工",
	olshengong_info: "出牌阶段每项限一次。你可以弃置一张武器牌/防具牌/其他装备牌，并发起一次“锻造”。然后你从锻造结果中选择一张牌，置于一名角色的装备区内（可替换原装备）。当有因你发动〖神工〗而加入游戏的牌进入弃牌堆后，你将此牌移出游戏，然后你于当前回合的结束阶段摸一张牌。",
	olqisi: "奇思",
	...
	dengzhong: "邓忠",
	dzkanpo: "勘破",
	dzkanpo_info: "①当你使用【杀】对目标造成伤害后，你可以观看目标角色的手牌，然后获得其中一张与此【杀】花色相同的牌。②每回合限一次，你可以将一张手牌当做【杀】使用。",
	dzgengzhan: "更战",
	dzgengzhan_info: "①其他角色的出牌阶段限一次，当有【杀】因弃置而进入弃牌堆后，你可以随机获得一张【杀】。②其他角色的结束阶段，若其本回合内未使用过【杀】，则你下个出牌阶段使用【杀】的次数上限+1。",
	xiahouxuan: "夏侯玄",
	olhuanfu: "宦浮",
	olhuanfu_info: "当你使用【杀】指定第一个目标后，或成为【杀】的目标后，你可以弃置X张牌（X∈[1, 你的体力上限]）。此【杀】结算结束后，若此【杀】累计因执行效果而造成的伤害值等于X，则你摸2X张牌。",
	olqingyi: "清议",
	olqingyi_info: "①出牌阶段限一次，你可以选择至多两名有牌的其他角色。你和这些角色同时弃置一张牌，然后若这些牌类型均相同，则你可以重复此流程。②结束阶段开始时，若你本回合内发动〖清议①〗弃置的牌包含两种颜色，则你获得每种颜色的牌各一张。",
	olzeyue: "迮阅",
	olzeyue_info: "限定技。准备阶段，你可以选择一名于你的上个回合结束后对你造成过伤害的角色A及其武将牌上的一个非锁定技B，令A的B失效。然后每轮结束时，A依次视为对你使用X张【杀】（X为B失效状态下经过的完整轮数）。当你因这些【杀】受到伤害后，你令A恢复技能B。",
	xindiaodu: "调度",
	xindiaodu_info: "①每回合限一次，与你势力相同的角色使用装备牌时，其可以摸一张牌。②出牌阶段开始时，你可以获得与你势力相同的一名角色装备区内的一张牌，然后你可以将此牌交给另一名其他角色。",
	olhuanshi: "缓释",
	...
	olximo: "洗墨",
	olximo_info: `锁定技。当你发动${get.poptip("olbixin")}后，你移除其描述的前五个字符。若你已发动三次${get.poptip("olbixin")}，交换中括号中的两个数字，失去〖洗墨〗并获得${get.poptip("olfeibai")}。`,
	olfeibai: "飞白",
	olfeibai_info: "转换技，锁定技。阳：当你因执行你使用的非黑色牌的效果而造成伤害时，此伤害值+1；阴：当你因执行你使用的非红色牌的效果而回复体力时，此回复值+1。",
	olqizhou: "绮冑",
	...
	zhanghua: "张华",
	olbihun: "弼昏",
	olbihun_info: "锁定技。当你使用牌指定其他角色为目标时，若你的手牌数大于手牌上限，取消之；然后若此牌的目标数为1，其获得此牌。",
	olchuanwu: "穿屋",
	...
	olshilu: "失路",
	olshilu_info: "锁定技。当你受到伤害后，你摸X张牌（X为你的体力值且至多为5）。然后你展示攻击范围内一名角色的一张手牌并令此牌视为无属性【杀】。",
	ol_huban: "OL胡班",
	ol_huban_prefix: "OL",
	olhuiyun: "晖云",
	...
	olhuiqi: "彗企",
	olhuiqi_info: "觉醒技。一名角色回合结束后，若本回合成为过牌的目标的角色数为3且包括你，你回复1点体力并获得〖偕举〗并执行一个额外回合。",
	olxieju: "偕举",
	...
	olchenshuo: "谶说",
	olchenshuo_info: "准备阶段，你可以令一名角色展示一张手牌，然后亮出牌堆顶的一张牌。若这两张牌类型/花色/点数/牌名字数中任一项相同且已展示的牌数小于3，则你重复此流程，然后你获得所有因此技能展示的牌。",
	oltianhou_spade: "骤雨",
	...
	duanjiong: "段颎",
	olsaogu: "扫谷",
	olsaogu_info: "转换技。①出牌阶段，你可以。阳：弃置两张牌（不能包含你本阶段弃置过的花色），然后使用其中的【杀】；阴：摸一张牌。②结束阶段，你可以弃置一张牌，令一名其他角色执行你当前〖扫谷①〗的分支。",
	olcuorui: "挫锐",
	olcuorui_info: "锁定技。①游戏开始时，你将手牌摸至场上存活人数张（至多摸至八张）。②当你成为延时锦囊牌的目标后，你跳过下个判定阶段。",
	olmouzhu: "谋诛",
	...
	olxiaoxi: "骁袭",
	olxiaoxi_info: "每轮的首个回合开始时，你可以视为使用一张无距离限制的【杀】。",
	ol_qianzhao: "牵招",
	olweifu: "威抚",
	...
	oldongdao: "东道",
	oldongdao_info: "农民的回合结束时：阳，你可以令地主进行一个额外回合；阴，其可以进行一个额外回合。",
	zhangyan: "张燕",
	olsuji: "肃疾",
	...
	relianju: "联句",
	relianju_info: "结束阶段，你可以令一名其他角色获得你本回合使用的至多两张位于弃牌堆且颜色相同的牌，称为“思闾”，然后你于其下个结束阶段可以获得其本回合使用的至多两张的位于弃牌堆且颜色相同且颜色不同于你本次获得的牌的颜色的牌，称为“思闾”。",
	resilv: "思闾",
	...
	tianchou: "田畴",
	olshandao: "善刀",
	olshandao_info: "出牌阶段限一次，你可以选择任意名角色，你选择这些角色区域里的各一张牌，依次将这些牌放置到牌堆顶，然后你视为对这些角色使用【五谷丰登】，然后你视为对这些角色外的所有其他角色使用【万箭齐发】。",
	ol_hujinding: "OL胡金定",
	...
	ol_lukai_prefix: "OL",
	olxuanzhu: "玄注",
	olxuanzhu_info: "转换技，每回合限一次，你可以将一张牌称为“玄”置于武将牌上，然后视为使用：阳，任意基本牌；阴，任意普通锦囊牌（须指定目标且仅指定一个目标）。若此次置于武将牌上的“玄”：不为装备牌，你弃置一张牌；为装备牌，你将所有“玄”置入弃牌堆，然后摸等量的牌。",
	oljiane: "謇谔",
	...
	olzuolian: "佐练",
	olzuolian_tag: "展示牌",
	olzuolian_info: "出牌阶段限一次，你可以选择至多X名有手牌的角色（X为你的体力值），你随机展示这些角色的各一张手牌，然后你可以令这些角色依次将展示牌与牌堆和弃牌堆中的属性【杀】进行交换。",
	oljingzhou: "精舟",
	oljingzhou_info: "当你受到伤害时，你可以选择至多X名角色（X为你的体力值）这些角色中处于/未处于连环状态的角色重置/横置武将牌。",
	ol_jiangwan: "蒋琬",
	olziruo: "自若",
	olziruo_info: "转换技，锁定技。①当你使用最{阳：左；阴：右}侧的手牌时，你摸一张牌。②你以此法摸牌后本回合不能整理手牌。",
	olxvfa: "蓄发",
	...
	ol_yuanji_prefix: "OL",
	oljieyan: "节言",
	oljieyan_info: "一名角色一次性失去了恰好两张手牌后，你可以与其从牌堆两端各摸一张牌并展示，若花色不同，此技能本回合失效。",
	oljinghua: "镜花",
	...
	kongshu: "孔淑",
	leiluan: "累卵",
	leiluan_info: "你可以将X张牌当一张你本轮未使用过的基本牌使用（X为已连环的角色数且至少为1）。若你以此法失去最后的手牌，你摸两张牌，从本回合弃牌堆中获得一张普通锦囊牌，然后此技能失效，直到你下次受到伤害后。",
	fuchao: "覆巢",
	fuchao_info: "锁定技，你使用基本牌后，当前回合角色进入连环状态。每轮结束时，你与已连环的角色各摸一张牌，然后已连环的角色弃置X张牌（X为已连环的角色数且至少为1）。",
	olleiluan: "累卵",
	olleiluan_info: "①每回合限一次，你可以将X张牌当作本轮未使用过的基本牌使用。②每轮结束时，若你本轮使用基本牌的次数大于等于X，则你可以摸X张牌，然后视为使用本轮进入弃牌堆的一张普通锦囊牌。（X为你此前连续发动〖累卵〗的轮数且X至少为1）",
	olfuchao: "覆巢",
	...
	liuyan: "刘焉",
	xinfu_guolun: "过论",
	xinfu_guolun_info: "出牌阶段限一次，你可以展示一名其他角色的一张手牌，然后展示你的一张牌。你与其交换这两张牌，然后展示的牌点数较小的角色摸一张牌。",
	xinfu_zhanji: "展骥",
	...
	xinfu_andong: "安东",
	xinfu_andong_info: "当你受到其他角色造成的伤害时，你可以令伤害来源选择一项：1.令你观看其的手牌并获得其中的所有红桃牌；2.防止此伤害，然后其本回合内的红桃手牌不计入手牌上限。",
	xinfu_yingshi: "应势",
	...
	ol_hanfu_prefix: "OL",
	olshuzi: "束辎",
	olshuzi_info: "出牌阶段限一次，你可以交给一名其他角色两张牌，然后其交给你一张手牌，若你交给其的牌包含其交给你的牌的牌名，则你可以选择一项：①对其造成1点伤害；②将场上一张牌移动至其对应区域。",
	olkuangshou: "恇守",
	olkuangshou_info: "锁定技，当你受到伤害后，你摸三张牌，然后弃置X张牌（X为本回合受到过伤害的角色数）。",
	ol_niufu: "OL牛辅",
	ol_niufu_prefix: "OL",
	olshisuan: "蓍算",
	olshisuan_info: "锁定技，当你受到伤害后，你重铸一张牌，然后伤害来源选择一项：①失去1点体力；②交给你一张装备区的牌；③将武将牌翻面。",
	olzonglve: "纵掠",
	...
	oljiaowei: "狡威",
	oljiaowei_info: "锁定技。①你的黑色牌不计入手牌上限。②若你的手牌数大于体力值，则你对体力值不大于你的角色使用黑色牌无距离限制，且其无法响应此牌。",
	olbianyu: "鞭御",
	olbianyu_info: "锁定技，当你使用【杀】造成伤害后或受到【杀】造成的伤害后，你选择受伤角色至多X张手牌（X为其已损失的体力值），令这些牌视为无次数限制的【杀】直到其使用非基本牌。然后若你或其手牌均为【杀】，你摸两张牌。",
	olfengyao: "凤瑶",
	olfengyao_info: "锁定技。①每有一张黑桃牌离开装备区后，你回复1点体力。②当你对其他角色造成伤害时，你弃置你或其场上的一张黑桃牌，令此伤害+1。",
	sp_ol_caocao: "SP曹操",
	sp_ol_caocao_prefix: "SP",
	spolxixiang: "西向",
	spolxixiang_info: "出牌阶段各限一次，你可以将至少X张牌当作无距离和任何次数限制的【杀】或【决斗】对一名角色使用（X为本回合所有角色使用基本牌的次数+1）。此牌结算后，若其体力值：大于你的手牌数，你摸一张牌；大于你的体力值，你回复1点体力，然后获得其一张牌。",
	spolaige: "哀歌",
	spolaige_info: "觉醒技。每回合第二次濒死结算结束后，你失去〖西向〗并获得〖逐北〗，然后将手牌摸至X张，将体力回复至X点（X为该濒死角色的体力上限）。",
	spolzhubei: "逐北",
	spolzhubei_info: "出牌阶段各限一次，你可以令一名其他角色将至少X张牌当作无距离和任何次数限制的【杀】或【决斗】对你使用（X为本回合所有角色使用基本牌的次数+1）。若你以此法受到伤害，你可以获得这些牌；否则你回复1点体力，然后你可以与其交换手牌。",
	ol_nanhualaoxian: "OL南华老仙",
	ol_nanhualaoxian_prefix: "OL",
	olhedao: "合道",
	olhedao_info: `锁定技。①游戏开始时，你可至多拥有两册${get.poptip("olhedao_faq")}。②你的首次濒死结算后，你可至多拥有三册${get.poptip("olhedao_faq")}。`,
	olhedao_faq: "“天书”",
	olhedao_faq_info: "关于“天书”：<br>" + ["“天书”为随机三个时机和三个效果中各选择一个组成的技能，且时机等级越高，效果等级越高", "“天书”初始为未翻开状态，发动一次后翻开此“天书”（未翻开的“天书”技能对其他角色不可见）", "“天书”至多可发动两次，交给其他角色后至多可发动一次，“天书”次数用尽后失去此“天书”", "一名角色可至多拥有一册“天书”"].map(str => `<li>${str}`).join("<br>"),
	olqingshu: "青书",
	olqingshu_info: `锁定技，游戏开始时/准备阶段/结束阶段，你书写一册${get.poptip("olhedao_faq")}。`,
	olshoushu: "授术",
	olshoushu_info: `出牌阶段限一次，你可以将一册未翻开的${get.poptip("olhedao_faq")}交给一名其他角色。`,
	ol_wuanguo: "OL武安国",
	ol_wuanguo_prefix: "OL",
	olliyong: "历勇",
	olliyong_info: "转换技，出牌阶段。阳：你可以将一张你本回合未使用过的花色的牌当作【决斗】使用；阴：你可以从牌堆中获得一张你本回合使用过的花色的牌，令一名其他角色视为对你使用一张【决斗】。",
	ol_qinlang: "OL秦朗",
	...
	olsiqi: "思泣",
	olsiqi_info: "你的红色牌进入弃牌堆时，将之置于牌堆底。当你受到伤害后，你可以亮出牌堆底至多三张连续的红色牌，使用其中【桃】、【无中生有】与装备牌（可指定其他角色为目标），然后你摸剩余不可使用的牌数张牌。",
	olqiaozhi: "巧织",
	olqiaozhi_info: "出牌阶段，你可以弃置一张牌并亮出牌堆顶的两张牌，然后获得其中一张，此技能失效直到你失去以此法获得的牌。",
	ol_guozhao: "OL郭照",
	ol_guozhao_prefix: "OL",
	oljiaoyu: "椒遇",
	oljiaoyu_info: "锁定技。每轮开始时，你进行X次判定（X为你空置装备栏数），然后你声明一种颜色并获得此颜色的判定牌，且你的下回合结束时，你执行一个额外的出牌阶段。此阶段内：你不能使用与声明颜色不同的牌；其他角色不能使用与你装备区牌颜色相同的牌直到有角色受到伤害时。",
	olneixun: "内训",
	olneixun_info: "锁定技，其他角色于回合内使用第一张非装备牌后，若此牌与你本轮〖椒遇〗声明的颜色相同/不同，你交给/获得其一张牌，然后失去牌的角色摸一张牌。你以此法获得的牌不计入手牌上限直到你回合结束。",
	ol_taoqian: "OL陶谦",
	...
	spoljinglei: "惊雷",
	spoljinglei_info: "每回合限一次，一名角色使用【酒】结算结束后，若没有处于濒死的角色，你可以受到1点无来源的雷电伤害，令一名拥有〖煮酒〗的角色将手牌调整至体力上限（至多摸至5），然后若该角色不为你：其须将以此法弃置的牌交给你。",
	ol_yuanhuan: "OL袁涣",
	...
	oljiawei: "假威",
	oljiawei_info: "出牌阶段限一次，你可以选择一名角色，弃置其X张牌，然后亮出牌堆顶X+1张牌，你获得其中的伤害牌并令其获得其中的非伤害牌。若如此做，本回合你使用牌无距离限制（X为你执行过的回合数且至多为你的体力上限）。",
	olqujia: "驱驾",
	olqujia_info: "限定技，回合结束后，若你本回合未杀死角色，你选择一项：1.执行一个额外回合；2.令你本局游戏使用【杀】的次数+1并获得一张【杀】。",
	old_oljiawei: "假威",
	old_oljiawei_info: "【杀】被抵消的回合结束时，你可将任意张手牌当【决斗】对本回合抵消过【杀】的一名角色使用。每轮限一次，若此【决斗】造成伤害，你可令你或当前回合角色将手牌摸至手牌上限（至多摸至五张）。",
	ol_wujing: "OL吴景",
	ol_wujing_prefix: "OL",
	olliubing: "流兵",
	olliubing_info: "锁定技。①你每回合使用的第一张非虚拟【杀】的花色视为♦️。②其他角色于其出牌阶段使用非黑色【杀】结算结束后，若此【杀】未造成过伤害，你获得之。",
	olshanjia: "缮甲",
	olshanjia_info: "①游戏开始时，你获得3枚“损”标记。②当你不因使用而失去一张装备牌后，你失去1枚“损”标记。③出牌阶段限一次，你可以摸三张牌，然后你可以使用一张【杀】。本阶段你使用下X张手牌时弃置一张牌（X为你拥有的“损”标记数）；本阶段结束时，若你本阶段未因此法弃置过非装备牌，则你可以视为使用一张无距离限制的【杀】。",
	ol_zhaozhong: "赵忠",
	olpengbi: "朋比",
	olpengbi_info: "你的第一个回合开始时，你选择获得〖隐天〗或〖蔽日〗，然后你可以令一名其他角色获得另一个技能。",
	olyintian: "隐天",
	olyintian_info: "锁定技，每回合首次有角色回复体力后，你下次造成的伤害+1（此效果不可叠加）。",
	olbiri: "蔽日",
	olbiri_info: "锁定技，每回合首次有角色非因摸牌获得牌后，你摸一张牌。",
	oldici: "抵慈",
	oldici_info: "出牌阶段限一次，你可以令一名角色交给你一张手牌，然后其回复1点体力并解除连环状态，然后其相邻角色进入连环状态。其下次进入连环状态后，其选择交给你一张手牌或受到你对其造成的1点雷属性伤害。",
	ol_peiyuanshao: "OL裴元绍",
	...
	ol_miheng_prefix: "OL",
	olkuangjuan: "狂狷",
	olkuangjuan_info: "出牌阶段限X次（X为你的体力上限），你可将手牌调整至与一名其他角色相同，然后你摸弃置牌数的牌。你因此技能获得的牌本回合无次数限制。",
	olfeibian: "飞辩",
	...
	oljiyun: "集运",
	oljiyun_effect: "集运",
	oljiyun_info: "①游戏开始时，你将牌堆中三张类别不同的牌称为「粮」置于你的武将牌上。②准备阶段，你可令至多X名角色各摸一张牌（X为你拥有的「粮」数且至少为1），这些角色使用其因此获得的牌结算完成后，若你拥有的「粮」数小于3，则你将此牌对应的实体牌称为「粮」置于你的武将牌上。",
	olshuliang: "输粮",
	olshuliang_info: "①每回合限一次，你可使用或打出一张「粮」。②结束阶段，你可将任意「粮」交给至多等量角色。",
	ol_yangfu: "OL杨阜",
	ol_yangfu_prefix: "OL",
	olpingzhong: "屏忠",
	...
	olyouque: "诱阙",
	olyouque_info: "出牌阶段，你可以用点数最小的「饵」拼点。没赢的角色弃置点数大于其拼点牌的所有手牌，视为对赢的角色使用一张【杀】。此【杀】造成伤害后，你摸两张牌，若「饵」的花色没有黑桃，此技能本阶段失效。",
	...
	olleishi: "雷噬",
	olleishi_judge: "雷噬·判",
	olleishi_info: "出牌阶段限X次（X为你上次发动〖狂信〗展示牌的数量），你使用本回合展示过的牌结算完成后，可进行一次判定并获得判定牌，若判定结果与使用牌的花色：相同，你对一名角色造成1点雷电伤害；不同，你展示一张牌，本回合下次判定时，若此牌在你的手牌区内，将此牌作为判定牌。",
	ol_caizhenji: "OL蔡贞姬",
	ol_caizhenji_prefix: "OL",
	olkedi: "柯笛",
	olkedi_info: "当你每回合前两次使用手牌结算后，你可令一名角色重铸一张牌。你可使用以此法重铸的牌直到你的下回合。",
	olkedi_append: "<li>不知道它怎么用的，先搁置，改成重铸之后直接能用一次",
	olcunze: "存择",
	olcunze_info: "结束阶段，你可选择一名角色。直到你下次发动此技能，其下次进入濒死时，回复至1体力。你于此期间不能对其他角色使用【桃】。",
	ol_qiaoxuan: "OL桥玄",
	ol_qiaoxuan_prefix: "OL",
	oltingji: "霆击",
	oltingji_info: "锁定技，你的回合内，未受伤的其他角色视为在你攻击范围内，且不能响应牌。",
	olxuanliu: "旋流",
	olxuanliu_info: "出牌阶段结束时，若你此阶段造成过伤害，你指定一名其他角色，其摸一张牌并可使用一张手牌。若其使用的牌与你此阶段使用过的牌同名，其重复此流程，每回合每牌名限一次。",
	newwuniang: "武娘",
	newwuniang_info: "你可以将一张非基本牌当作无距离限制且不可响应的【杀】使用，然后你可以获得其中一名目标角色的一张牌。若此牌不为基本牌，你可失去1点体力，重置所有角色的〖镇南〗。",
	newzhennan: "镇南",
	newzhennan_info: "限定技，准备阶段，你可以弃置两张牌，视为使用一张指定任意名目标的【南蛮入侵】。然后若你对指定目标：造成了伤害，其随机弃置一张牌，未造成伤害，你本回合对其使用牌无次数限制。",
	newxushen: "许身",
	newxushen_info: "限定技，当你进入濒死状态时，你可以令一名其他角色选择一项：①失去所有技能，获得〖征南〗；②获得〖镇南〗。", //然后你将体力值回复至2点。
	ol_qiaogong: "OL桥公",
	ol_qiaogong_prefix: "OL",
	olmeiyan: "媒言",
	olmeiyan_info: "出牌阶段限一次，你可以与所有体力值大于等于你的角色议事，若议事结果为红色，你获得所有红色意见牌；若议事结果为黑色，你与意见为红色的角色各摸一张牌。",
	olshuoyu: "妁语",
	olshuoyu_info: "每回合限一次，当你或你攻击范围内的角色成为【杀】的目标时，你可以与所有体力值小于等于你的角色议事，若意见为红色，弃置所有意见牌，将此【杀】转移给一名未参与议事的角色。",
	olzuobao: "作保",
	olzuobao_info: "限定技，你参与的议事结果公布前，你可以令此次议事中，所有黑桃意见牌视为红桃。",
	ol_fanyufeng: "OL樊氏",
	ol_fanyufeng_prefix: "OL",
	olzhuoyue: "酌乐",
	olzhuoyue_info: "①当你不因此技能成为非伤害牌的目标后，你可令一名角色视为使用【酒】。②处于【酒】状态的角色成为伤害牌的目标后，你可移除其【酒】状态并令其视为使用【桃】。",
	olqiaowu: "俏舞",
	olqiaowu_info: "每回合各限一次，当你使用的【杀】或【闪】结算完毕后，你可令所有处于【酒】状态的角色使用一张【杀】，若其未使用则摸一张牌。",
	sunyuan: "孙鸢",
	olsaying: "飒影",
	...
	olmiaoxin: "妙心",
	olmiaoxin_info: "锁定技，你受到1点伤害后，摸两张牌；若〖温宜〗剩余发动次数为0，改为摸一张牌并令〖温宜〗剩余发动次数+1。",
	ol_lvlingqi: "OL吕玲绮",
	...
	olchunhui: "春晖",
	olchunhui_info: "准备阶段或当你受到伤害后，令一名其他角色交给你一张手牌。若此牌为黑色，本回合你或其下一次成为红色牌的目标时，各弃置一张手牌。",
	olxiasheng: "夏晟",
	olxiasheng_info: "锁定技，若你手牌中：红色牌较多，你使用黑色牌时摸一张牌；黑色牌较多，你使用红色牌可多指定一个目标（无距离限制）。",
	olqiumu: "秋暮",
	olqiumu_info: `锁定技，本回合成为过你的红色牌目标的角色进入濒死状态时，你将${get.poptip("olchunhui")}、${get.poptip("olxiasheng")}或〖秋暮〗描述中的“红色”改为“黑色”，若描述变化，你获得其所有黑色手牌。`,
	ol_liuye: "OL刘晔",
	ol_liuye_prefix: "OL",
	olpingyuan: "平垣",
	...
	olzeguang: "泽光",
	olzeguang_info: "每回合限一次，当你成为伤害牌的目标后，你可重铸三张牌（不足则全部重铸)。然后若此伤害牌造成伤害，你可令一名角色获得重铸牌。",
	olchengen: "承恩",
	olchengen_info: "每回合结束时，若当前回合角色的手牌数小于等于你，你可与一名角色拼点。若你赢，你可使用拼点牌；若你没赢，拼点目标可对你使用一张【杀】。",
	pangji: "逢纪",
	olbiguo: "愎果",
	olbiguo_info: "摸牌阶段结束时，你可弃置一张牌，改为从牌堆中展示并获得每个类型的牌各一张。然后你本回合成为牌的目标后，你可以与一名其他角色拼点，没赢的角色本回合不能使用或打出与双方拼点牌类型相同的牌。",
	oldouyu: "斗誉",
	oldouyu_info: "你的拼点牌亮出前，你可以与对方交换拼点牌，若你赢，你摸两张牌。",
	...
	olremaozhu: "茂著",
	olremaozhu_info: `锁定技，回合开始时，或你绘制了一幅“地图”的所有城市，你将手牌中的花色补至4，并展开一幅“地图”。回合结束时，你获得一个本回合已展开的“地图”技能，直到你下回合结束。`,
	olremaozhu_faq: "关于【茂著】“地图”",
	get olremaozhu_faq_info() {
		const mapSkill = new Map([
			["pxbingzhou", ["pxqixian", "pxyanmen", "pxjiuyuan", "pxwuxiang"]],
			["pxjizhou", ["pxbohai", "pxchangshan", "pxjulu", "pxpingyuan"]],
			["pxjingzhou", ["pxnanyang", "pxshangyong", "pxxiangyang", "pxjiangxia"]],
			["pxliangzhou", ["pxjuyan", "pxdunhuang", "pxyumen", "pxwuwei"]],
			["pxliangzhoux", ["pxhanzhong", "pxbaxi", "pxmianzhu", "pxfuling"]],
			["pxningzhou", ["pxdianchi", "pxailao", "pxquting", "pxnanfu"]],
			["pxqinzhou", ["pxlongxi", "pxtianshui", "pxwudu", "pxyinping"]],
			["pxqingzhou", ["pxlean", "pxdonglai", "pxlinzi", "pxbeihai"]],
			["pxsizhou", ["pxwenxi", "pxhandan", "pxhongnong", "pxwenxian"]],
			["pxxuzhou", ["pxlangya", "pxpengcheng", "pxdonghai", "pxguangling"]],
			["pxyanzhou", ["pxtaishan", "pxjuancheng", "pxchenliu", "pxrencheng"]],
			["pxyangzhou", ["pxshouchun", "pxhefei", "pxjuchao", "pxlujiang"]],
			["pxyizhou", ["pxchengdu", "pxlinqiong", "pxzangke", "pxzhuti"]],
			["pxyongzhou", ["pxanding", "pxfengyi", "pxfufeng", "pxjingzhao"]],
	...
	// 并州
	pxbingzhou: "并州",
	pxbingzhou_info: "当你获得此技能后，你可以视为使用一张【决斗】。",
	pxyanmen: "雁门",
	pxyanmen_info: "当你获得此技能后，你从牌堆中获得一张武器牌和一张进攻坐骑牌。",
	pxjiuyuan: "九原",
	pxjiuyuan_info: "你使用【杀】可以额外指定任意名目标。",
	pxqixian: "祁县",
	pxqixian_info: "每回合限一次。你可以重铸一张装备牌，视为使用一张【杀】或【过河拆桥】。",
	pxwuxiang: "武乡",
	pxwuxiang_info: "当你获得此技能后，你从牌堆中获得一张【火攻】。",
	// 冀州
	pxjizhou: "冀州",
	pxjizhou_info: "当你获得此技能后，你从牌堆中获得一张【万箭齐发】。",
	pxbohai: "渤海",
	pxbohai_info: "当你获得此技能后，你可以弃置一张武器牌，然后摸两张牌。",
	pxchangshan: "常山",
	pxchangshan_info: "当你获得此技能后，你从牌堆中获得两张【闪】。",
	pxjulu: "巨鹿",
	pxjulu_info: "每回合限一次。当你失去点数为黑桃2-9的牌后，你摸一张牌。",
	pxpingyuan: "平原",
	pxpingyuan_info: "每回合限一次。当你失去最后的手牌后，你摸一张牌。",
	// 荆州
	pxjingzhou: "荆州",
	pxjingzhou_info: "当你获得此技能后，你可以交给一名角色任意张手牌。",
	pxnanyang: "南阳",
	pxnanyang_info: "当你获得此技能后，你可以重铸一张锦囊牌，与一名角色各回复1点体力。",
	pxshangyong: "上庸",
	pxshangyong_info: "当你获得此技能后，你可以与一名其他角色各摸一张牌。",
	pxxiangyang: "襄阳",
	pxxiangyang_info: "当你获得此技能后，你可以移动场上一张牌。",
	pxjiangxia: "江夏",
	pxjiangxia_info: "当你获得此技能后，你可以令一名其他角色摸两张牌，然后交给你一张牌。",
	// 凉州
	pxliangzhou: "凉州",
	pxliangzhou_info: "你可以将一张黑色牌当【杀】使用。",
	pxjuyan: "居延",
	pxjuyan_info: "当你获得此技能后，你从牌堆中获得三张攻击范围各不相同的武器牌。",
	pxdunhuang: "敦煌",
	pxdunhuang_info: "你的【杀】被抵消后，你摸一张牌。",
	pxyumen: "玉门",
	pxyumen_info: "已连环的角色不能响应你的牌。",
	pxwuwei: "武威",
	pxwuwei_info: "每回合限一次。你使用伤害牌时可以额外指定一个目标。",
	// 梁州
	pxliangzhoux: "梁州",
	pxliangzhoux_info: "当你成为【杀】的目标后，使用者弃置一张牌。",
	pxhanzhong: "汉中",
	pxhanzhong_info: "当你获得此技能后，你可以与一名其他角色交换手牌。",
	pxbaxi: "巴西",
	pxbaxi_info: "当你获得此技能后，你可以指定一名其他角色，其使用当前手牌无次数限制。",
	pxmianzhu: "绵竹",
	pxmianzhu_info: "结束阶段，你观看牌堆顶三张牌，然后可以获得其中类型不同的牌各一张。",
	pxfuling: "涪陵",
	pxfuling_info: "你的装备牌不能被其他角色弃置。",
	// 宁州
	pxningzhou: "宁州",
	pxningzhou_info: "你使用的【杀】不能被抵消，且造成的伤害均视为体力流失。",
	pxdianchi: "滇池",
	pxdianchi_info: "每回合限一次。一名角色受到火焰伤害后，你可以令其失去1点体力。",
	pxailao: "哀牢",
	pxailao_info: "当你获得此技能后，你可以令一名角色选择一项：1.弃置两张牌；2.失去1点体力。",
	pxquting: "句町",
	pxquting_info: "当你获得此技能后，你可以失去1点体力，然后摸三张牌。",
	pxnanfu: "南涪",
	pxnanfu_info: "当你获得此技能后，你可以失去1点体力，然后视为使用一张【杀】。",
	// 秦州
	pxqinzhou: "秦州",
	pxqinzhou_info: "当你获得此技能后，你可以选择一名其他角色，其使用的下一张牌对你无效。",
	pxlongxi: "陇西",
	pxlongxi_info: "当你获得此技能后，你从牌堆中获得一张防御坐骑牌。",
	pxtianshui: "天水",
	pxtianshui_info: "当你获得此技能后，你可以弃置一名角色一张手牌，若此牌不为【杀】，你摸两张牌。",
	pxwudu: "武都",
	pxwudu_info: "你使用牌无次数限制。",
	pxyinping: "阴平",
	pxyinping_info: "其他角色计算与你的距离+1。",
	// 青州
	pxqingzhou: "青州",
	pxqingzhou_info: "当你获得此技能后，你可以弃置所有手牌，然后摸等量的牌。",
	pxlean: "乐安",
	pxlean_info: "当你获得此技能后，你从牌堆获得一张属性【杀】和一张【铁索连环】。",
	pxdonglai: "东莱",
	pxdonglai_info: "当你获得此技能后，你可以令一名角色使用的下一张牌无距离和任何次数限制。",
	pxlinzi: "临淄",
	pxlinzi_info: "当你获得此技能后，你获得弃牌堆中三张随机的梅花牌。",
	pxbeihai: "北海",
	pxbeihai_info: "当你获得此技能后，你将手牌摸至体力上限。",
	// 司州
	pxsizhou: "司州",
	pxsizhou_info: "当你获得此技能后，你可以获得一名角色一张手牌。",
	pxwenxi: "闻喜",
	pxwenxi_info: "当你每回合首次使用一个花色的牌后，你摸一张牌。",
	pxhandan: "邯郸",
	pxhandan_info: "每回合限一次。当你使用一张非伤害普通锦囊后，你令一名角色获得此牌。",
	pxhongnong: "弘农",
	pxhongnong_info: "当你获得此技能后，你可以重铸任意张装备牌并回复1点体力。",
	pxwenxian: "温县",
	pxwenxian_info: "当你获得此技能后，你加1点体力上限并回复1点体力，然后获得一张【虚妄之冕】。",
	// 徐州
	pxxuzhou: "徐州",
	pxxuzhou_info: "当你获得此技能后，你可以令一名其他角色获得以下效果：当其于其的回合外使用牌后，其摸一张牌。",
	pxlangya: "琅琊",
	pxlangya_info: "当你获得此技能后，你观看牌堆顶的五张牌，然后以任意顺序置于牌堆顶或牌堆底。",
	pxpengcheng: "彭城",
	pxpengcheng_info: "当你获得此技能后，你可以令一名其他角色交给你一张牌，然后其回复1点体力。",
	pxdonghai: "东海",
	pxdonghai_info: "当你获得此技能后，你令一名角色下个摸牌阶段多摸一张牌。",
	pxguangling: "广陵",
	pxguangling_info: "你可以将两张牌当一张【五谷丰登】使用。",
	// 兖州
	pxyanzhou: "兖州",
	pxyanzhou_info: "每回合限一次。当你回复体力后，你摸一张牌。",
	pxtaishan: "泰山",
	pxtaishan_info: "当你获得此技能后，你将一张【螭纹玉佩】置入手牌。",
	chiwenyupei: "螭纹玉佩",
	chiwenyupei_info: "锁定技。出牌阶段结束时，你回复1点体力；摸牌阶段，若你未受伤，你多摸两张牌。",
	pxjuancheng: "鄄城",
	pxjuancheng_info: "当你获得此技能后，你判定，若为黑色，你获得判定牌并重复此流程。",
	pxchenliu: "陈留",
	pxchenliu_info: "你跳过弃牌阶段。",
	pxrencheng: "任城",
	pxrencheng_info: "你的手牌上限+X（X为你【杀】的数量）。",
	// 扬州
	pxyangzhou: "扬州",
	pxyangzhou_info: "当你获得此技能后，你可以令一名其他角色回复1点体力。",
	pxshouchun: "寿春",
	pxshouchun_info: "当你获得此技能后，你可以令一名角色增加1点体力上限。",
	pxlujiang: "庐江",
	pxlujiang_info: "当你获得此技能后，你可以拼点，赢的角色摸两张牌。",
	pxhefei: "合肥",
	pxhefei_info: "当你获得此技能后，你可以弃置至多两张牌，然后摸等量的牌。",
	pxjuchao: "居巢",
	pxjuchao_info: "当你获得此技能后，你可以弃置你与一名角色各一张牌。",
	// 益州
	pxyizhou: "益州",
	pxyizhou_info: "你不能成为延时锦囊牌的目标。",
	pxchengdu: "成都",
	pxchengdu_info: "每回合限一次。当你对自己使用牌后，你摸一张牌。",
	pxlinqiong: "临邛",
	pxlinqiong_info: "当你获得此技能后，你可以令任意名角色同时弃置一张牌。",
	pxzangke: "牂牁",
	pxzangke_info: "当你受到伤害后，你可以弃置你与伤害来源各一张牌。",
	pxzhuti: "朱提",
	pxzhuti_info: "每回合限一次。当你受到属性伤害时，你改为回复等量体力。",
	// 雍州
	pxyongzhou: "雍州",
	pxyongzhou_info: "当你获得此技能后，你可以摸两张牌，然后将手牌弃至手牌上限。",
	pxanding: "安定",
	pxanding_info: "当你因传导受到的属性伤害时，防止之。",
	pxfengyi: "冯翊",
	pxfengyi_info: "当你获得此技能后，你可以回复1点体力。",
	pxfufeng: "扶风",
	pxfufeng_info: "当你获得此技能后，你从牌堆获得一张你手牌中未拥有类型的牌。",
	pxjingzhao: "京兆",
	pxjingzhao_info: "若有角色本回合对你使用过：【杀】/伤害锦囊牌，伤害锦囊牌/【杀】对你无效。",
	// 幽州
	pxyouzhou: "幽州",
	pxyouzhou_info: "当你获得此技能后，你增加1点体力上限。",
	pxxuantu: "玄菟",
	pxxuantu_info: "每回合限一次。一名角色进入濒死状态时，你获得使其进入此濒死状态的牌。",
	pxbeiping: "北平",
	pxbeiping_info: "当你获得此技能后，你从牌堆中获得两张【杀】。",
	pxfanyang: "范阳",
	pxfanyang_info: "当你获得此技能后，你可以对攻击范围内的一名角色造成1点伤害。",
	pxdaifang: "带方",
	pxdaifang_info: "你的属性【杀】不能被响应。",
	// 豫州
	pxyuzhou: "豫州",
	pxyuzhou_info: "当你获得此技能后，你可以进入连环状态，令一名体力值小于你的角色回复1点体力。",
	pxxuchang: "许昌",
	pxxuchang_info: "当你获得此技能后，你可令一名其他角色攻击范围增加至与你相同。",
	pxpeixian: "沛县",
	pxpeixian_info: "你的普通锦囊牌不能被响应。",
	pxqiaoxian: "谯县",
