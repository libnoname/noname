...
const translates = {
	...
	ol_puyuan_prefix: "OL",
	olshengong: "神工",
	olshengong_info: "出牌阶段每项限一次。你可以弃置一张武器牌/防具牌/其他装备牌，并发起一次“锻造”。然后你从锻造结果中选择一张牌，置于一名角色的装备区内（可替换原装备）。当有因你发动〖神工〗而加入游戏的牌进入弃牌堆后，你将此牌移出游戏，然后你于此回合结束阶段后摸一张牌。",
	olqisi: "奇思",
	...
	olshuoyu: "妁语",
	olshuoyu_info: "每回合限一次，你攻击范围内的角色成为【杀】的目标时，你可以与所有体力值小于等于你的角色议事，若意见为红色，弃置所有意见牌，将此【杀】转移给一名未参与议事的角色。",
	olzuobao: "作保",
