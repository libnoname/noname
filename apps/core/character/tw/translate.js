...
const translates = {
	...
	twjizhi: "寄志",
	twjizhi_info: `${get.poptip("rule_chihengji")}，当你进入濒死状态时，你可以选择任意角色，你令这些角色失去${get.poptip("twhuju")}，然后你回复等量体力并获得等量的伤害牌。将其余角色的${get.poptip("twhuju")}转化为“阳”，然后退幻。`,
	...
	twmiaolve: "妙略",
	twmiaolve_info: `游戏开始时，你获得两张${get.poptip("dz_mantianguohai")}。当你受到1点伤害后，你可选择：①获得一张${get.poptip("dz_mantianguohai")}并摸一张牌。②获得一张${get.poptip("rule_zhinang")}。`,
	twyingjia: "迎驾",
	...
	twweipo: "危迫",
	twweipo_info: `出牌阶段限一次。你可以令一名角色弃置一张牌，然后令其获得一张${get.poptip("binglinchengxiax")}或一张由你选择的${get.poptip("rule_zhinang")}牌。`,
	twmouzhi: "谋识",
	...
	tw_feiyi_prefix: "TW",
	twshengxi: "生息",
	twshengxi_info: `①准备阶段，你可以获得一张${get.poptip("tiaojiyanmei")}。②结束阶段，若你本回合使用过牌且未造成伤害，则你可以获得一张${get.poptip("rule_zhinang")}并摸一张牌。`,
	twkuanji: "宽济",
	...
	twylyanshi: "延势",
	twylyanshi_info: `限定技。你可以将一张【杀】当作【决斗】、${get.poptip("binglinchengxiax")}或任意${get.poptip("rule_zhinang")}使用或打出。`,
	twylyanshix: "延势·改",
	twylyanshix_info: `限定技。你可以将一张【杀】当作【决斗】、${get.poptip("binglinchengxiax")}或任意${get.poptip("rule_zhinang")}使用或打出。${get.poptip("rule_lizhan")}：重置〖延势〗。`,
	twjuexing: "绝行",
	...
	huan_luxun_prefix: "幻",
	twniwo: "逆涡",
	twniwo_info: `出牌阶段开始时，你可选择一名其他角色，然后选择你与其等量的手牌，然后你选择一项：1.直到本回合结束，你与其均无法使用或打出你以此法选择的牌；2.交换你与其以此法选择的牌，且${get.poptip("twlifeng")}失效直到回合结束。`,
	twlifeng: "砺锋",
	twlifeng_info: "出牌阶段限两次，你可以弃置两张不同点数的牌，然后对与你距离X以内的角色各造成1点伤害（X为两牌点数之差）。该角色因此受到伤害时，其可重铸一张手牌，若此牌点数与你弃置的两张牌点数相同，其防止此伤害。若你弃置牌点数的差大于本阶段上一次弃置牌点数的差，则你摸一张牌且此技能本阶段可发动次数+1。",
	old_twlifeng: "砺锋",
