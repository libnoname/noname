...
const translates = {
	...
	huan_zhouyu: "幻周瑜",
	huan_zhouyu_prefix: "幻",
	twdumou: "督鍪",
	twdumou_info: "你每阶段首次{获得或失去牌（因你使用装备失去之除外）}后，可选择一项：1.展示牌堆顶的一张牌并令一名角色获得之；2.重铸一名角色三张牌。每回合结束时，本回合因此技能获得牌唯一最多的存活角色失去1点体力。",
	twdumou_tag: "督鍪",
	twhantian: "撼天",
	twhantian_info: "出牌阶段限一次，你可视为使用一张【火攻】，此牌目标须优先展示其本回合获得的牌。你造成的火焰伤害+X（X为受到伤害角色本回合获得的牌的次数）。",
	huan_zhanghe: "幻张郃",
