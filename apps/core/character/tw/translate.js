...
const translates = {
	...
	twjianyan: "翦魇",
	twjianyan_info: `${get.poptip("rule_chihengji")}，游戏开始时，你令所有其他角色获得${get.poptip("twhuju")}。当有角色进入濒死状态时，你可以选择任意名其他角色（数量可为0），你令这些角色失去${get.poptip("twhuju")}，然后你回复等量体力并获得等量的非伤害牌。将其余角色的${get.poptip("twhuju")}转化为“阴”，然后入幻。`,
	twhuju: "虎踞",
	...
	twjizhi: "寄志",
	twjizhi_info: `${get.poptip("rule_chihengji")}，当你进入濒死状态时，你可以选择任意名其他角色，你令这些角色失去${get.poptip("twhuju")}，然后你回复等量体力并摸等量的伤害牌。将其余角色的${get.poptip("twhuju")}转化为“阳”，然后退幻。`,
