...
const translates = {
	...
	yj_fazheng: "TW☆法正",
	yj_fazheng_prefix: "TW|☆",
	youtan: "藏铗",
	youtan_info: "锁定技，你于出牌阶段外获得牌时，记录此牌花色；当你成为其他角色使用未记录花色牌的目标后，除非其弃置一张牌，否则此牌对你无效。",
	ciren: "堕洄",
	ciren_info: "其他角色的准备阶段，其可以交给你一张牌，然后你须选择一项：1.交给其另一张同花色牌；2.令其摸一张牌。",
	zhancai: "跃渊",
	zhancai_info: `出牌阶段限四次，你可以摸${get.poptip("youtan")}记录花色数张牌，然后清除一个花色记录。`,
};
