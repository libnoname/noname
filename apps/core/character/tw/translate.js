...
const translates = {
	...
	dumou: "督鍪",
	dumou_info: "你每阶段首次获得与失去牌后，可选择一项：1.展示牌堆顶的一张牌并令一名角色获得之；2.重铸一名角色三张牌。每回合结束时，本回合因此技能获得牌唯一最多的角色失去1点体力。",
	dumou_tag: "督鍪",
	hantian: "熯天",
	hantian_info: "出牌阶段限一次，你可视为使用一张【火攻】，此牌目标须优先展示其本回合获得的牌。你造成的火焰伤害+X（X为受到伤害角色本回合获得的牌的次数）。",
	hantian_tag: "熯天",
