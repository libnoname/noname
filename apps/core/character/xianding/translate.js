...
const translates = {
	dc_wangyuanji: "新杀王元姬",
	dc_wangyuanji_prefix: "新杀",
	dcshiyu: "识预",
	dcshiyu_info: "每轮限一次，其他角色的回合开始时，你可秘密猜测每种类型的牌本回合是否被该角色使用，其回合结束时，你每猜对一种，你获得其一张牌并防止其本轮下次对你造成的伤害；每猜错一种，你与其依次对对方造成1点伤害。若你全部猜对，此技能本轮可使用次数+1。",
	dcshuaijian: "率俭",
	dcshuaijian_info: "你的回合开始和结束时，你可以执行一项：1.令手牌数最多的一名角色将手牌弃置至不为全场最多，然后你令一名角色摸弃牌数张牌；2.令装备区牌数最多的一名角色将装备区牌弃置至不为全场最多，然后你令一名角色回复弃牌数点体力。",
	cuizhi: "崔芷",
	dcranlv: "燃缕",
	...
	dcsbfangong: "返攻",
	dcsbfangong_info: `限定技，出牌阶段，你可回满体力值并摸五张牌。你因${get.poptip("dcsbyouyi")}失去的体力值和牌数的总和每累计达到7后，此技能视为未发动过。`,
	dc_sb_masu: "新杀谋马谡",
	dc_sb_masu_prefix: "新杀谋",
	dcsbchengce: "呈策",
	dcsbchengce_info: `每轮开始时，你可以观看牌堆顶两张牌并用任意张手牌替换其中等量牌，然后你令一名其他角色观看牌堆顶两张牌并获得其中一张。若其获得的牌为：非伤害牌，你获得三张非伤害牌，其获得${get.poptip("dcsbxinzhan")}直到本轮结束；伤害牌，你获得三张伤害牌，其随机三张非伤害手牌视为【杀】直到本轮结束。`,
	dcsbxinzhan: "心战",
	dcsbxinzhan_info: "每回合各限一次，你每回合首次使用【杀】或普通锦囊牌指定其他角色为唯一目标时，可猜测此牌是否被响应。此牌结算完成后，若你猜对，你观看目标手牌并获得其一张牌；若你没猜对，其视为对你使用一张【决斗】。",
