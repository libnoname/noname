...
const translates = {
	lizhaoyi: "李昭仪",
	dcmingjie: "明节",
	dcmingjie_info: "游戏开始选择一名其他角色，你与其获得对方因弃牌阶段弃置的牌，你或其的阶段被跳过时各摸2张牌并可令对方防止下次受到的伤害。所选角色阵亡时，你立即阵亡。",
    dcxianfu: "娴辅",
    dcxianfu_info: "每回合限一次，你成为牌目标时，可跳过你下回合的除准备阶段和结束阶段外的一个阶段令此牌对你无效，且你与'明节'角色同时互相观看手牌并同时获得对方至多3张手牌。",
    dcxianfu_skip: "娴辅-跳过阶段",
	dc_sb_guanyu: "新杀谋关羽",
