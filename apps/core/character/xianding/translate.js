...
const translates = {
	...
	zisheng: "恣胜",
	zisheng_info: "你使用点数大于3且为3的倍数的牌时，可从牌堆中随机三张点数为3的牌(若多张则点数相加)，选择其中一张获得；你弃置或获得其他角色牌时，可对该角色造成与弃置或获得牌数相等的伤害（不超过该角色当前体力值）。",
	xianlue: "显略",
	xianlue_info: "出牌阶段每名角色限一次，你可以观看本回合受到过伤害或失去过牌的一名其他角色的手牌并记录其中所有牌的点数。当本次记录点数的数量超过3、 6、9时，你摸三张牌。若已因此记录了所有点数，则清除记录且“豪贤”视为未发动过。你每次造成伤害令其他角色进入濒死状态后，本次记录触发后续的点数减少3个。",
	haoxian: "豪贤",
	haoxian_info: "限定技，出牌阶段，你可以将弃牌堆中所有点数为3的牌洗入牌堆（无则跳过），然后获得其他角色手牌中所有点数为3的牌。",
	dc_sb_guanyu: "新杀谋关羽",
	dc_sb_guanyu_prefix: "新杀谋",
	guanwu: "冠武",
	guanwu_info: "锁定技，回合开始时，从场上，弃牌堆，牌堆中获得【青龙偃月刀】。本轮你每使用两张【杀】，你本轮的杀伤害+1。",
	weishi: "威势",
	weishi_info: "每回合每项限一次，1、你成为其他角色非伤害牌目标后，可弃置半数手牌（向上取整），令此牌对你无效；2、你成为其他角色伤害牌目标结算后，你摸两张牌，并可对其使用一张【杀】。",
	jvao: "倨傲",
	jvao_info: "出牌阶段限一次，你可以弃置一张牌视为对攻击范围内任意名其他角色使用一张【杀】或普通锦囊牌，若如此做，此牌目标下次使用【杀】或普通锦囊牌必须指定你为目标，且无距离次数限制。",
	dengwantang: "邓晚棠",
	daijia: "黛颊",
	...
	lizhaoyi: "李昭仪",
	dcmingjie: "明节",
	dcmingjie_info: "游戏开始选择一名其他角色，你与其获得对方因为弃牌阶段弃置的牌，你与其的阶段被跳过时各摸2张牌并可令对方防止下次受到的伤害。所选角色阵亡时，你立即阵亡。",
	dcxianfu: "娴辅",
	dcxianfu_info: "每回合限一次，你成为牌目标时，可跳过你下个除准备阶段和结束阶段外的一个阶段并与“明节”角色交换手牌，若如此做，此牌对你无效。",
	v_mateng: "威马腾",
	v_mateng_prefix: "威",
	dcheji: "合骑",
	dcheji_info: "游戏开始时，你获得3个“骑”，你不以此法使用【杀】结算后，可视为对拥有“骑”的其他角色使用X张【杀】(X 为该角色“骑”的数量，此杀造成的伤害无伤害来源)， 你对拥有“骑”的角色使用牌无距离限制。",
	dchuirui: "挥锐",
	dchuirui_info: "出牌阶段开始或受到伤害后，你可选择一项发动：1、获得两个“骑” ；2、移动场上任意一个“骑”至任意其他角色处；3、移除一个你的“骑”视为使用一张【杀】。",
	dcxiaohui: "骁贲",
	dcxiaohui_info: "连招技(装备牌+黑色牌)你可移动一个“骑”并可移除所有其他角色的“骑”，其他角色每失去一个“骑” 便受到一点伤害。",
};
