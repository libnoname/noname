...
const translates = {
	...
	liuxuan: "刘璿",
	mogui: "漠规",
	mogui_info: "你的回合内，可以执行以下选项并移除：①判定阶段开始时，令一名角色回复1点体力并弃置判定区所有牌；②摸牌阶段开始时，令一名角色摸牌阶段摸牌数+1，出牌阶段使用【杀】次数+1；③弃牌阶段开始时弃置至多5张牌，若以此法弃置了牌，令一名角色手牌上限+1并摸等量张牌。",
	zunjian: "遵谏",
	zunjian_info: `觉醒技，若你回合开始时已移除${get.poptip("mogui")}所有选项，你回复1点体力并选择一项：1、摸2张牌并重置${get.poptip("mogui")}；2、再回复1点体力，然后失去${get.poptip("mogui")}修改${get.poptip("rencheng_modified")}。`,
	rencheng: "仁诚",
	rencheng_info: "出牌阶段限一次，你可以摸三张牌然后可交给一名其他角色至多三张牌，若其因此获得牌的类型数：为1，其下个出牌阶段使用【杀】的次数+1；为2，其下个摸牌阶段摸牌数+2；为3，你与其各回复1点体力并摸一张牌。",
	rencheng_modified: "仁诚",
	rencheng_modified_info: "出牌阶段限一次，你摸3张牌然后你可交给一名其他角色至多3张牌，若这些牌中：有基本牌，其下个出牌阶段使用牌不限距离；有锦囊牌，你可弃置一名角色区域内1张牌；有装备牌，你与其各回复1点体力。",
	zhangyu: "张裕",
	dcxiangchen: "相谶",
	...
	dc_sb_xusheng: "新杀谋徐盛",
	dcsbqinqiang: "勤强",
	dcsbqinqiang_info: "每回合每项限一次，你使用手牌时，可选择一项：1、令此牌伤害+X；2、摸X张牌（X为你本回合当前连续使用同颜色的牌数）",
	dcsbyizhen: "疑阵",
	dcsbyizhen_info: "当你受到伤害后，你可以与伤害来源互相观看对方手牌，然后各弃置其中一张牌，若这两张牌颜色相同，则你获得之。",
	xuwen: "徐妏",
	dcfuhui: "赋绘",
