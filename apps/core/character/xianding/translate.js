...
const translates = {
	...
	v_liubei_prefix: "威",
	dcliexiang: "烈骧",
	dcliexiang_info: "出牌阶段限一次，你可摸至多五张牌，然后你选择一名其他角色。你以此法选择的角色按照你选择的顺序依次执行：{你对其造成1点伤害，然后若你的手牌数：1.大于其，本回合你出【杀】次数+1且你可以交给一名其他角色至多X张牌；2.等于其，你获得其一张牌且其下回合使用的前X张牌无效；3.小于其，你失去X点体力，此技能本回合修改为“出牌阶段限两次”且可额外选择至多X名其他角色（X为你选择的摸牌数）。}。",
	dcrengou: "仁彀",
