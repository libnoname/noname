const translates = {
	...
	reyingshui: "营说",
	reyingshui_info: "出牌阶段限一次，你可将一张牌交给攻击范围内的一名其他角色，然后其选择一项：①交给你至少两张装备牌。②其受到1点伤害。",
	rewangzu: "望族",
	...
	dcshizong: "恃纵",
	dcshizong_info: "当你需要使用一张基本牌时，你可以交给一名其他角色X张牌，然后其可以将一张牌置于牌堆底，视为你使用之。若其不为当前回合角色或未放置牌，此技能失效直到回合结束（X为你本回合发动〖恃纵〗的次数）。",
	pangshanmin: "庞山民",
	dccaisi: "才思",
	...
	dcmanwang: "蛮王",
	dcmanwang_info: "出牌阶段，你可以弃置任意张牌。然后你依次执行以下选项中的前等量项：⒈获得〖叛侵〗。⒉摸一张牌。⒊回复1点体力。⒋摸两张牌并失去〖叛侵〗。",
	dcpanqin: "叛侵",
	...
	dchuoxin: "惑心",
	dchuoxin_info: "当你使用非装备牌时，你可以展示一名其他角色的一张手牌并标记为“筝”。若此牌与你使用的牌花色相同或已被标记过，你可以获得之。",
	yue_zhugeguo: "乐诸葛果",
	...
	dccongfeng: "从风",
	dccongfeng_info: "你/其他角色不因此技能获得其他角色/你的牌后，可以额外随机获得一张。",
