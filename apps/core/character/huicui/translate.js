...
const translates = {
	...
	dczhoufa: "咒法",
	dczhoufa_info: "出牌阶段限一次，你可将一张非基本牌当伤害牌使用，此牌无次数限制且造成的伤害为雷电伤害。",
	dcshouqun: "兽群",
	dcshouqun_info: "摸牌阶段，你可以改为展示牌堆顶X张牌(X为你的体力上限)，并选择一项：1、获得其中的坐骑牌、锦囊牌、【杀】和【酒】，然后若你因此获得的牌数不超过2，你体力上限+1（不能超过初始上限）；2、获得所有展示牌，然后直到你的下回合开始，你获得“驭象”且每次受到火焰伤害后，体力上限-1。",
	dcyuxiang: "驭象",
	dcyuxiang_info: "锁定技，你计算与其他角色的距离-2。你对距离2以内的角色使用的【杀】不能被响应。",
	re_panfeng: "潘凤",
	xinkuangfu: "狂斧",
