...
const translates = {
	...
	keaizhishen: "可爱之神",
	dcmaimeng: "卖萌",
	dcmaimeng_info: "你的体力值变化后，你选择一项执行：1.摸X张牌并防止你本回合下次受到的伤害；2.令一名其他角色交给你x张牌且其本回合使用的下一张牌无效（X为本回合此技能发动次数）",
	weiquzhishen: "委屈之神",
	dcweiqu: "委屈",
	...
	nizhuanzhishen: "逆转之神",
	dcfanzhuan: "反转",
	dcnizhuan_info: "每轮限一次，你可以将你的体力值调整为已损失体力值并摸变化值张牌",
	dcniyun: "逆运",
	dcniyun_info: "你的攻击范围，使用杀次数均+X（X为你已损失体力值）",
	meituizhishen: "美腿之神",
	dcshentui: "伸腿",
