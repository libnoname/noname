...
const translates = {
	...
	mbsaojian: "扫奸",
	mbsaojian_info: "出牌阶段限一次，你可以观看一名其他角色的手牌并选择其中的一张（队友可为你推荐弃置的牌），然后该角色重复弃置一张手牌，直到其以此法弃置了五张牌／弃置了你选择的牌／没有可弃置的手牌。",
	mbsaojian_info_identity: "出牌阶段限一次，你可以观看一名其他角色的手牌并选择其中的一张，然后该角色重复弃置一张手牌，直到其以此法弃置了五张牌／弃置了你选择的牌／没有可弃置的手牌。",
	jsrg_dongzhuo: "衰董卓",
