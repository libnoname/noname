...
const translates = {
	...
	mb_qirang: "祈禳",
	mb_qirang_info: "当有装备牌进入你的装备区时，你可从牌堆中获得一张锦囊牌，你使用此锦囊牌时无距离限制并摸一张牌。",
	mb_yvhua: "羽化",
	mb_yvhua_info: "锁定技，你的非基本牌不计入手牌上限；结束阶段，若你的手牌数大于体力值，你观看牌堆顶X张牌（X为你手牌类别数），将其中任意数量的牌置于牌堆顶，其余的牌置于牌堆底。",
	mb_caochun: "手杀曹纯",
	...
	re_heqi_prefix: "手杀",
	reqizhou: "绮胄",
	reqizhou_info: `锁定技，你使用装备时，根据使用过的装备牌名数获得技能：1.${get.poptip("yingzi")}；2.${get.poptip("jiang")}；3.${get.poptip("xinpojun")}；4.${get.poptip("dbchongjian")}；5.${get.poptip("fenwei")}。`,
	reshanxi: "闪袭",
	reshanxi_info: "出牌阶段限一次，你可以弃置一张基本牌，然后弃置一名其他角色的一张手牌：1.若你弃置的牌为红色，你获得对方弃置的牌；2.若对方因此弃置的牌名未因此效果弃置过，你对其造成1点伤害。",
	chendeng: "手杀陈登",
	chendeng_prefix: "手杀",
	zhouxuan: "周旋",
