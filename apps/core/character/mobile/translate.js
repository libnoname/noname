...
const translates = {
	...
	mbjiwei: "济危",
	mbjiwei_info: "锁定技。①其他角色的回合结束时，你摸2X张牌（X为本回合满足的项数：1.有角色失去过牌；2.有角色受到过伤害）。②准备阶段，若所有角色均存活且你的手牌数不小于5，你将手牌中颜色较多的牌分配给任意名其他角色。",
	mbjiwei_append: `<span style="font-family:yuanli">该技能为海外版本，覆盖了手杀版本</span>`,
	mb_ganfuren: "手杀甘夫人",
