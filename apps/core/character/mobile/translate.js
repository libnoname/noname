...
const translates = {
	...
	reliangyin: "良姻",
	reliangyin_info: "①当有牌被置于武将牌上时，你可令一名角色摸一张牌。②当有角色获得一名角色武将牌上的牌时，你可令一名角色弃置一张牌。③最后一名角色的回合结束后，你可令本轮唯一成为此技能目标的角色回复1点体力，或令本轮唯一未成为此技能目标的角色失去1点体力。",
	rekongsheng: "箜声",
	rekongsheng_info: "准备阶段、当你失去或回复体力后，你可以将当前回合角色的任意张牌扣置于其武将牌上。若如此做，该角色的结束阶段，你可以观看并使用其中一张牌，然后其获得其余的牌。当你死亡时，所有角色收回其“箜声”牌。",
	re_yanyan: "手杀界严颜",
