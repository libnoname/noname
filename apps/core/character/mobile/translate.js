...
const translates = {
	...
	rejuzhan: "拒战",
	rejuzhan_info: `转换技，游戏开始时，若你的势力为蜀，你的初始状态改为阴；阳：当你或者此状态下第三次有角色成为【杀】的目标后，你可以与此【杀】的使用者各摸一张牌，然后其本回合不能对你使用牌；阴：当你或者此状态下第三次有角色使用【杀】指定目标后，你可以获得此【杀】的目标角色一张牌，然后你本回合不能对其使用牌。${get.poptip("rule_chengshi")}：你于出牌阶段内使用【杀】的次数+1，且此【杀】结算完毕后，你获得之。`,
	mb_gaoxiang: "手杀高翔",
