...
const translates = {
	...
	key_fuuko: "伊吹风子",
	lucia_duqu: "毒躯",
	lucia_duqu_info: "Charlotte技，①当你对其他角色造成伤害或受到其他角色的伤害时，你令对方获得一张花色点数随机的【毒】。<br>②当你因【毒】失去体力时，你改为回复等量的体力。",
	lucia_duqu_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	lucia_zhenren: "振刃",
	...
	umi_lunhui: "轮回",
	umi_lunhui_info: "Charlotte技，一名其他角色的回合结束时，若你的手牌数小于体力值，则你可以失去1点体力。若如此做，你摸两张牌并进行一个额外回合，且你于此回合内计算与此角色的距离视为1。",
	umi_lunhui_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	umi_shiroha: "轮回 - 延时效果",
	umi_qihuan: "七幻",
	umi_qihuan_info: "Charlotte技，限定技，当你处于濒死状态时，你可以移去此武将牌。若如此做，你回复X点体力（X为场上势力数）。然后，你可获得场上已死亡角色武将牌上的至多两个技能。",
	umi_qihuan_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	komari_tiankou: "甜口",
	...
	tsumugi_huilang: "回廊",
	tsumugi_huilang2: "回廊",
	tsumugi_huilang_info: "Charlotte技，回合结束时，你可以将任意张牌扣置于武将牌下（均称为「隐」）。回合开始时，你获得所有「隐」，然后可令等量的角色各摸一张牌。",
	tsumugi_huilang_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	...
	hisako_zhuanyun: "转运",
	hisako_zhuanyun_info: "Charlotte技，你的判定会朝向对你有利的方向倾斜。",
	hisako_zhuanyun_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	hinata_qiulve: "球略",
	...
	nagisa_tiandu: "天妒",
	nagisa_tiandu_info: "Charlotte技，当你的判定牌生效后，你可以获得此牌。",
	nagisa_tiandu_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	nagisa_fuxin: "抚心",
	...
	mio_tishen: "替身",
	mio_tishen_info: "Charlotte技，限定技，准备阶段，你可以将体力值回复至体力上限并摸等同于回复量的牌，然后将武将牌替换为【西园美鸟】。",
	mio_tishen_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	midori_nonghuan: "弄幻",
	midori_nonghuan_info: "Charlotte技，出牌阶段限X次（X为你的体力值），你可以获得一名本阶段内未选择过的其他角色的区域内的一张牌。你摸一张牌，然后将一张牌交给该角色。然后你清除此技能结算过程中所有卡牌移动事件的移动记录。",
	midori_nonghuan_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	//即技能结算完成后，所有涉及到的牌移动事件不会再被getHistory获取
	midori_tishen: "替身",
	midori_tishen_info: "Charlotte技，限定技，准备阶段，你可以将体力值回复至体力上限并摸等同于回复量的牌，然后将武将牌替换为【西园美鱼】。",
	midori_tishen_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	kyoko_juwu: "聚物",
	...
	kyoko_zhiheng: "制衡",
	shizuru_nianli: "念力",
	shizuru_nianli_info: "Charlotte技，每轮限一次，你可以展示一张♦/♣/♥/♠手牌，然后视为使用一张不计入次数限制和记录的雷【杀】/【闪】/【桃】/【无懈可击】。",
	shizuru_nianli_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	shizuru_benzhan: "奔战",
	...
	yuu_lveduo: "掠夺",
	yuu_lveduo_info: "Charlotte技，每轮限一次，其他角色的回合开始时，若你本局游戏内未对其发动过〖掠夺〗且你的武将牌正面朝上，你可以将武将牌翻面并获得该角色本回合内的控制权。此回合结束时，你将武将牌翻回正面。锁定技，若你的武将牌背面朝上，则你不能使用或打出牌。",
	...
	yuu_lveduo_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	ryoichi_baoyi: "爆衣",
	...
	kotori_yumo_gain: "驭魔",
	kotori_yumo_info: "Charlotte技，游戏开始时，你获得蓝色、红色、绿色、黄色、灰色魔物各一个。当有角色受到伤害后，若你没有对应的标记，你根据其势力获得一个对应魔物：魏：蓝、蜀：红、吴：绿、群：黄、灰：晋、键：紫。回合开始时，你可以弃置一个对应的魔物并获得以下技能之一直到回合结束：蓝：魏业、红：蜀义、绿：吴耀、黄：群心、灰：晋势、紫：键魂。",
	kotori_yumo_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	kotori_skill_wei: "魏业",
	...
	kotori_huazhan: "花绽",
	kotori_huazhan_info: "Charlotte技，每回合每种魔物限一次，你可将一个蓝色/红色/绿色/黄色/紫色/灰色魔物当做【树上开花】使用。",
	kotori_huazhan_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	jojiro_shensu: "神速",
	...
	shiroha_yuzhao_info: "Charlotte技，游戏开始时，你将牌堆顶的X张牌扣置于你的武将牌上，称为「兆」。一名角色的回合开始时，若你有「兆」且其至你的距离不大于1，则你将牌堆顶的X张牌扣置为「兆」，然后将等量的「兆」置于牌堆顶。（X为势力数）",
	shiroha_yuzhao_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	shiroha_guying: "孤影",
	...
	hiroto_zonglve: "纵略",
	hiroto_zonglve_info: "Charlotte技，你的手牌上限+3。出牌阶段限一次，你可以将一张手牌背面朝下放置，并展示一名其他角色的一张手牌。若这两张牌：颜色相同，你对其造成1点伤害并弃置其展示的牌。颜色不同，你获得该角色区域内的两张牌。",
	hiroto_zonglve_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	hiroto_tuolao: "脱牢",
	...
	kano_poyu: "破羽",
	kano_poyu_info: "Charlotte技，当你成为【杀】或伤害性锦囊牌的目标后，若仁库中有牌，你可判定。然后你可从仁库中移去一张与此牌类型或花色相同的牌，令此牌对你无效。",
	kano_poyu_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	liyingxia_sanli: "三礼",
	...
	erika_shisong: "识诵",
	erika_shisong_info: "Charlotte技，①你的手牌上限+X（X为你的护甲数）。②当你于回合内使用第Y张牌时，若此牌与你上回合使用的第Y张牌类型相同，则你摸一张牌。",
	erika_shisong_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	erika_yousheng: "佑生",
	...
	nao_duyin: "独隐",
	nao_duyin2: "独隐",
	nao_duyin_info: "Charlotte技，一名其他角色的回合开始时，若你本局游戏内未对其发动过〖独隐〗，则你可以弃置一张牌或将武将牌翻面。若如此做，你不能成为其使用牌的目标，且对其使用牌没有距离限制且不计入使用次数直到你的下回合结束。",
	nao_duyin_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	nao_wanxin: "挽心",
	...
	key_kotarou: "天王寺瑚太朗",
	kotarou_aurora: "丝刃",
	kotarou_aurora_info: "Charlotte技，当扣减体力或增加体力上限后，若你的装备区内：有武器牌，你视为使用一张【杀】；没有武器牌，你使用牌堆中的一张不为赠物的武器牌。",
	kotarou_aurora_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	kotarou_rewrite: "改写",
	kotarou_rewrite_damage: "改写",
	kotarou_rewrite_recover: "改写",
	kotarou_rewrite_sha: "改写",
	kotarou_rewrite_block: "改写",
	kotarou_rewrite_info: "Charlotte技，出牌阶段，你可选择：①视为使用一张本局游戏没有以此法使用过的基本牌或普通锦囊牌；②移动场上的一张牌；③增加1点体力上限并失去1点体力（体力上限至多为5）；④下一次造成的伤害+1；⑤下一次回复的体力值+1；⑥本回合内的手牌上限和使用【杀】的使用次数+1。若你于本回合内发动过〖改写〗的次数超过两次，则你令此技能失效，且于回合结束后将体力上限降至3点，失去〖丝刃〗和〖改写〗。",
	kotarou_rewrite_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	key_kyou: "藤林杏",
	kyou_zhidian: "掷典",
	...
	key_kiyu: "露娜Ｑ",
	kiyu_yuling: "玉灵",
	kiyu_yuling_info: "Charlotte技，你不是有距离限制的锦囊牌的合法目标；你成为【杀】的目标后，使用者需弃置X张牌（X为其至你的距离）。",
	kiyu_yuling_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	kiyu_rexianyu: "先预",
	kiyu_rexianyu_info: "Charlotte技，每轮限一次。出牌阶段结束时，你可以选择一名其他角色。该角色于下个出牌阶段内使用第X张牌时，其可以将一张牌当做你本阶段内使用的第X张基本牌或普通锦囊牌使用（X至多为3）；若如此做，你摸一张牌，且其本回合的手牌上限+1。",
	kiyu_rexianyu_append: `<span style="font-family:yuanli">Charlotte技：该技能不受【技能失效】效果以及【技能失去】效果的影响</span>`,
	key_tomoyo: "坂上智代",
	tomoyo_wuwei: "武威",
