...
export default {
	...
	characterPack: {
		mode_tafang: {
			tafang_mech_guangmingquan: get.convertedCharacter({ sex: "", group: "", hp: 3, skills: [], isBoss: true, extraModeData: 3 }),
			tafang_mech_nengliangqiu: get.convertedCharacter({ sex: "", group: "", hp: 3, skills: [], isBoss: true, extraModeData: 3 }),
			tafang_mech_jiguanren: get.convertedCharacter({ sex: "", group: "", hp: 3, skills: [], isBoss: true, extraModeData: 3 }),
			tafang_mech_weixingxianjing: get.convertedCharacter({ sex: "", group: "", hp: 3, skills: [], isBoss: true, extraModeData: 4 }),
			tafang_mech_mutong: get.convertedCharacter({ sex: "", group: "", hp: 3, skills: [], isBoss: true, extraModeData: 4 }),
			tafang_mech_gongchengche: get.convertedCharacter({ sex: "", group: "", hp: 3, skills: [], isBoss: true, extraModeData: 4 }),
		},
	},
	cardPack: {
		mode_tafang: {},
