...
import { sort as jiubianSort } from "./jiubian.js";
import { sort as zifengSort } from "./zifeng.js";

const sortList = [normalSort, zhenSort, shiSort, bianSort, quanSort, jiubianSort, zifengSort];
