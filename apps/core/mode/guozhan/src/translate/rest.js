...
export default {
	...
	gz_ol_suchao: "肃朝",
	gz_ol_suchao_info: "出牌阶段限一次，你可以对至多三名手牌数大于你的角色各造成1点伤害。若如此做，此阶段结束时，这些角色各回复1点体力且可以对你使用一张【杀】。",
	gz_ol_zhulian: "诛连",
	gz_ol_zhulian_info: "锁定技，你的回合内，于本回合使用过【桃】，或成为过【桃】目标的角色受到的伤害+1。",
	gz_ol_jianshuo: "OL国战蹇硕",
	gz_ol_jianshuo_prefix: "OL国战",
	gz_ol_shantong: "擅统",
	gz_ol_shantong_info: "同势力角色的准备阶段，若其武将牌均明置，其可以暗置一张武将牌，令其此回合使用的下一张牌无距离和次数限制。若如此做，此回合其明置该武将牌后，你对其造成1点伤害并获得其所有手牌。",
	gz_ol_qiuchou: "群仇",
	...
	_aozhan_event_bujinzetui_info: "本轮内：每名角色回合结束时，若其于本回合未造成过伤害，其失去1点体力。",
	_aozhan_event_shengzheweiwang: "胜者为王",
	_aozhan_event_shengzheweiwang_info: "本轮内：有角色死亡时，杀死其的角色本局摸牌阶段摸牌数+3。",
	_aozhan_event_jili: "激励",
	_aozhan_event_jili_info: "本轮内：【杀】无距离和次数限制。",
	_aozhan_event_huoqi: "祸起",
	_aozhan_event_huoqi_info: "本轮内：所有角色受到的伤害+1。",
	_aozhan_event_luoshi: "落石",
	_aozhan_event_luoshi_info: "翻开此牌时，所有已确定势力的角色依次变更副将。",
	_aozhan_event_jianli: "贱礼",
	_aozhan_event_jianli_info: "本轮内：所有角色可以跳过其摸牌阶段，然后获得弃牌堆中至多两张奇珍牌。",
	guozhan_jin: "文德武备",
