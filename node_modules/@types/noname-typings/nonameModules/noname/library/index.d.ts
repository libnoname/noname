export class Library {
    ...
    respondMap: {
        ...
        damage: string[];
        all: any[];
        khquanjiu: (string | ((card: any, player: any) => boolean))[];
    };
        ...
        general: {
            ...
            config: {
                ...
                experimental_enable: {
                     ...
                     * @param {boolean} bool
                     */
                    onclick(bool: boolean): Promise<void>;
                    unfrequent: boolean;
                };
                extension_alert: {
                    name: string;
     ...
     * @param {Function} fn
     */
    genAsync(fn: Function): (...args: any[]) => Promise<ReturnType<GeneratorFunction>>;
    genAwait(item: any): Promise<any>;
    gnc: {
        of: (fn: any) => (...args: unknown[]) => Promise<ReturnType<any>>;
        is: {
    ...
    translate: {
        ...
        sheshen: string;
        sheshen_info: string;
        identity_mingcha: string;
        identity_mingcha_info: string;
    };
    experimental: import("./experimental/index.js").Experimental;
    element: {
        content: {
            emptyEvent: (event: any) => Promise<void>;
            _save: () => void;
            chooseNumbers(event: any, trigger: any, player: any): Promise<void>;
            ...
            chooseToMove(event: Element.GameEvent, trigger: Element.GameEvent, player: Element.Player): Promise<void>;
            showCharacter: () => void;
            ...
            cardsGotoPile: () => void;
            chooseToEnable: (event: globalThis.GameEventPromise, trigger: globalThis.GameEventPromise, player: Element.Player) => Promise<void>;
            chooseToDisable: (event: globalThis.GameEventPromise, trigger: globalThis.GameEventPromise, player: Element.Player) => Promise<void>;
            swapEquip: () => void;
            disableJudge: () => void;
            enableJudge: () => void;
            phasing: () => void;
            ...
            equipCard: () => void;
            gameDraw: () => void;
            phaseLoop(event: any, trigger: any, player: any): Promise<never>;
            loadPackage: () => void;
            ...
            chooseToGive: () => void;
            chooseToDiscard: ((event: any, trigger: any, player: any) => Promise<void>)[];
            ...
            chooseToCompare: ((event: any, trigger: any, player: any, result: any) => Promise<void>)[];
            chooseToCompareEffect(event: any, trigger: any, player: any): Promise<void>;
            chooseSkill: () => void;
            discoverCard: () => void;
            chooseButton: () => void;
            chooseCardOL: () => void;
            ...
            chooseButtonTarget: ((event: any, _trigger: any, player: any, result: any) => Promise<void>)[];
            chooseControl: () => void;
            chooseBool: () => void;
            chooseDrawRecover(event: any, trigger: any, player: any): Promise<void>;
            ...
            swapHandcardsx: () => void;
            gainMultiple: () => void;
            gain: ((event: any, trigger: any, player: any) => Promise<void>)[];
            addToExpansion: () => void;
            lose: ((event: any, trigger: any, player: any) => Promise<void>)[];
            damage: () => void;
            recover: () => void;
            loseHp: () => void;
            doubleDraw: () => void;
            ...
            dying: () => void;
            die: () => void;
            revive: (event: any, trigger: any, player: any) => Promise<void>;
    ...
    filter: {
         ...
         * @param {string} skill
         * @param {string[]} triggernameList
         * @returns {boolean}
         */
        filterTrigger: (event: GameEvent, player: Player, triggername: string, skill: string, indexedData: any, triggernameList: string[]) => boolean;
        /**
         *
         * @param {GameEvent} event
         * @param {Player} player
         ...
         * @returns { boolean }
         */
        cardDiscardable: (card: Card, player: Player, event?: string) => boolean;
        /**
