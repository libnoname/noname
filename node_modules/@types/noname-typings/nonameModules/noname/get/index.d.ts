export class Get extends GetCompatible {
     ...
     * @returns { string }
     */
    cardDescription(node: Card | VCard | CardBaseUIData, player: Player): string;
    /**
     ...
     * @returns { string[] }
     */
    cardTranslation(filter?: Function): string[];
    /**
     * 获取装备牌对应的技能
     ...
     * @returns { String[] }
     */
    zhinangs(filter?: Function | boolean): string[];
    /**
     * 用于获取武将的姓氏和名字
     ...
     */
    bottomCards(num?: number, putBack?: boolean): Card[] | Card;
    /**
     * 返回本回合进入[过]弃牌堆的牌
     * @returns { Card[] }
     */
     ...
     * @returns { string[] }
     */
    charactersOL(func?: (name: string) => boolean): string[];
    trimip(str: any): any;
    mode(): any;
    ...
    rank(name: any, num: any): string | number;
    ...
    rawName(str: any, noab?: boolean): any;
    /**
     * 作用修改：只读前缀 不读_ab
     */
     ...
     * @returns {string[]}
     */
    canRespond(card: string | Card | VCard | object, player?: false | Player): string[];
    /**
     * 返回牌堆顶的牌
     * @param { number } [num = 1] 默认为1
     ...
     * @returns { Card[] | Card } num为0返回Card，否则返回Cards
     */
    cards(num?: number, putBack?: boolean): Card[] | Card;
    judge(card: any): any;
    judge2(card: any): any;
    ...
    player(): import("../library/element/player.js").Player;
    /**
     * 返回玩家的数组
     * @param {*} [sort]
    ...
    skillInfoTranslation(name: any, player: any, noHTML: boolean): string;
    /**
     * @returns {string}
     */
     ...
     * @returns { string }
     */
    strNumber(num: number, forced?: boolean): string;
    /**
     * 返回扑克牌中的表示形式对应的数字
     * @param { string } str
     ...
     * @returns { number }
     */
    numString(str: string, forced?: boolean): number;
    /**
     * 将阿拉伯数字转换为中文的表达形式
     * @param { number } num
     ...
     */
    cardPile(name: Function | string | object | true, position?: string | boolean, start?: string): Card | ChildNode | null;
    /**
     * 从牌堆获得一张牌
     * @param { function | string | object | true } name 牌的筛选条件或名字，true为任意一张牌
     * @param { string } [start] 遍历方式。默认top
     ...
     * @returns { Card | ChildNode | null }
     */
    cardPile2(name: Function | string | object | true, start?: string): Card | ChildNode | null;
    /**
     * 从弃牌堆获得一张牌
     * @param { function | string | object | true } name 牌的筛选条件或名字，true为任意一张牌
     * @param { string } [start] 遍历方式。默认top
     ...
     * @returns { Card | ChildNode | null }
     */
    discardPile(name: Function | string | object | true, start?: string): Card | ChildNode | null;
     ...
     * @returns { number }
     */
    order(item: any, player?: import("../library/element/player.js").Player | import("noname-typings/nonameModules/noname/library/element/player.js").Player): number;
