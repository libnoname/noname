export class Game extends GameCompatible {
     ...
     * @returns { string[] }
     */
    initCharactertList(filter?: boolean): string[];
    /**
     * 交换任意两个元素的位置，附带过渡动画
	 ...
	 * @returns {string}
	 */
	addTempTag(id: string, translation: string): string;
    /**
     * 添加新的属性杀
     */
     ...
     * 洗牌
     */
    washCard(): false | any[] | import("../library/element/gameEvent.js").GameEvent;
    /**
     * 基于钩子的添加势力方法
     */
    ...
    loseAsync(arg?: {
        [key: string]: any;
    }): import("../library/element/gameEvent.js").GameEvent;
     ...
     */
    getGlobalHistory<T extends keyof GameHistory>(key: T, filter?: (event: GameEventPromise) => boolean, last?: GameEventPromise): GameHistory[T];
    /**
     * @template { keyof GameHistory } T
     * @param { T } key
     * @param { (event: GameEventPromise) => boolean } filter
     ...
     * @returns { GameHistory[T] }
     */
    getAllGlobalHistory<T extends keyof GameHistory>(key: T, filter?: (event: GameEventPromise) => boolean, last?: GameEventPromise): GameHistory[T];
    /**
     ...
     * @returns { GameHistory[T] }
     */
    getRoundHistory<T extends keyof GameHistory>(key: T, filter: (event: GameEventPromise) => boolean, num?: number, keep?: boolean, last: GameEventPromise): GameHistory[T];
    /**
     * @overload
     * @returns { void }
     */
     ...
     * @param { Function } func
     */
    waitForPlayer(func: Function): import("../library/element/gameEvent.js").GameEvent;
    /**
     * @param { number } time
     ...
     * @returns
     */
    trySkillAudio(skill: string, player: Player | string, directaudio?: boolean, nobroadcast?: boolean, skillInfo?: any, args?: any[]): HTMLAudioElement | (() => HTMLAudioElement);
    /**
     * @param { Player | string } player
     * @returns
     */
     ...
     */
    createEvent(name: string, trigger?: false, triggerEvent?: GameEvent): import("../library/element/gameEvent.js").GameEvent;
    /**
     * @param { string } name
     ...
     * @returns { Card }
     */
    createCard(name: Card | VCard | object | string, suit?: string, number?: number | string, nature?: string): Card;
    /**
     * @overload
     * @returns { Card }
     */
     ...
     */
    loop(event?: GameEvent): Promise<void>;
    pause(): {
     ...
     * @param { number } [time2]
     */
    delaye(time?: number, time2?: number, ...args: any[]): import("../library/element/gameEvent.js").GameEvent;
    /**
     * @param { number } [time]
     * @param { number } [time2]
     */
    delayex(time?: number, time2?: number, ...args: any[]): import("../library/element/gameEvent.js").GameEvent;
    /**
     * @param { number } [time]
     * @param { number } [time2]
     */
    delay(time?: number, time2?: number): Promise<void>;
    /**
     * @param { number } [time]
     * @param { number } [time2]
     */
    delayx(time?: number, time2?: number): Promise<void>;
    /**
     * @deprecated
     */
     ...
     */
    loadModeAsync(name: string, callback?: (exports: importModeConfig) => any, onerror?: (error: unknown) => any): Promise<importModeConfig>;
    /**
     * @param { string } name
     * @param {*} configx
     */
     ...
     * @param { Player } player
     */
    phaseLoop(player: Player): import("../library/element/gameEvent.js").GameEvent;
    /**
     * @param { Player } [player]
     */
    ...
    asyncDraw(players: Player[], num?: number | number[] | ((player: Player) => number), drawDeck?: {
        drawDeck: boolean;
    }, bottom?: boolean): Promise<Omit<import("noname-typings/nonameModules/noname/library/element/gameEvent.js").GameEvent, "then">[]>;
    /**
     * @param { Player[] } players
     * @param { number | number[] | (player: Player) => number } num
     * @param { { drawDeck: boolean } } [drawDeck]
     ...
     */
    expandSkills(skills: string[], subSkill?: boolean): string[];
    /**
	 ...
	 * @returns { GameEventPromise }
	 */
	chooseAnyOL(targets: Player[], func: function, args: Any[]): GameEventPromise;
    /**
     ...
     * @returns { Card[] }
     */
    createFakeCards(cards: Card[] | Card, isBlank: boolean, tempname: string): Card[];
    /**
     ...
     */
    deleteFakeCards(cards: Card[] | Card): Card[];
}
