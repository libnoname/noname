const translates = {
	...
	wolongfengchu: "卧龙凤雏",
	youlong: "游龙",
	youlong_info: "转换技，每轮每项各限一次，你可以废除你的一个装备栏，视为使用一张未以此法使用过的：阴：普通锦囊牌；阳：基本牌。",
	luanfeng: "鸾凤",
	...
	oltuishi: "侻失",
	oltuishi_info: "锁定技。①你不能使用【无懈可击】。②当你使用点数为字母的牌时，你令此牌无效并摸一张牌，且你对手牌数小于你的角色使用的下一张牌无距离和次数限制。③当你使用伤害类卡牌结算完毕后，若此牌为你本回合使用的第三张或以上未造成伤害的卡牌，则你令〖嚣翻〗于本回合失效。",
	ol_tw_zhangji: "张既",
	skill_zhangji_A: "技一",
	...
	kongshu: "孔淑",
	olleiluan: "累卵",
	olleiluan_info: "①每回合限一次，你可以将X张牌当作本轮未使用过的基本牌使用。②每轮开始时，若你上一轮使用基本牌的次数大于等于X，则你可以摸X张牌，然后视为使用上一轮进入弃牌堆的一张普通锦囊牌。（X为你此前连续发动〖累卵〗的轮数且X至少为1，且〖累卵②〗视为发动轮次的上一轮发动）",
	olfuchao: "覆巢",
	...
	spolxixiang: "西向",
	spolxixiang_info: "出牌阶段各限一次，你可以将至少X张牌当作无距离和任何次数限制的【杀】或【决斗】对一名角色使用（X为本回合所有角色本回合使用基本牌的次数+1）。此牌结算后，若其体力值：大于你的手牌数，你摸一张牌；大于你的体力值，你回复1点体力，然后获得其一张牌。",
	spolaige: "哀歌",
	spolaige_info: "觉醒技。每回合第二次濒死结算结束后，你失去〖西向〗并获得〖逐北〗，然后将手牌摸至X张，将体力回复至X点（X为该濒死角色的体力上限）。",
	spolzhubei: "逐北",
	spolzhubei_info: "出牌阶段各限一次，你可以令一名其他角色将至少X张牌当作无距离和任何次数限制的【杀】或【决斗】对你使用（X为本回合所有角色本回合使用基本牌的次数+1）。若你以此法受到伤害，你可以获得这些牌；否则你回复1点体力，然后你可以与其交换手牌。",
	...
	olfengwei: "奉蔚",
	olfengwei_info: "锁定技，每轮开始时，你摸至多四张牌。若你有本轮获得的“奉蔚”牌，则你受到牌造成的伤害+1。",
	olzonghu: "宗护",
	...
	oljiyun: "集运",
	oljiyun_effect: "集运",
	oljiyun_info: "游戏开始时，将牌堆中三张类别不同的牌置于你的武将牌上，称为「粮」。准备阶段，你可令任意角色各摸一张牌，这些角色使用其因此获得的牌结算完成后，若「粮」的数量小于3，将此牌置于你的武将牌上，称为「粮」。",
	olshuliang: "输粮",
	olshuliang_info: "每回合限一次，你可使用或打出一张「粮」。结束阶段，你可将任意「粮」交给至多等量其他角色，然后你摸X张牌(X为获得「粮」的角色数）。",
	ol_yangfu: "OL杨阜",
	ol_yangfu_prefix: "OL",
	olpingzhong: "屏忠",
