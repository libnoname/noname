...
const translates = {
	...
	olshanjia: "缮甲",
	olshanjia_info: "①游戏开始时，你获得3枚“败甲”标记。②当你不因使用失去一张装备牌后，你失去1枚“败甲”标记。③出牌阶段限一次，你可以摸三张牌，然后你可以使用一张【杀】。本阶段你使用下X张手牌时弃置一张牌（X为你此时拥有的“败甲”标记数）；本阶段结束时，若你本阶段未因此法弃置过非装备牌，则你可以视为使用一张无距离限制的【杀】。",
	ol_zhaozhong: "赵忠",
	olpengbi: "朋比",
	...
	olzhuoyue: "酌乐",
	olzhuoyue_info: "当你成为非伤害类牌的目标后（非因此技能)，你可令一名角色视为使用【酒】。处于【酒】状态的角色成为伤害牌目标后，你可移除其【酒】状态并令其视为使用【桃】。",
	olqiaowu: "俏舞",
	olqiaowu_info: "转换技，每回合限一次，当你使用的【杀】或【闪】结算完毕后，你可令所有处于【酒】状态的角色：阳：摸一张牌；阴：选择是否使用一张【杀】。",
	sunyuan: "孙鸢",
	olsaying: "飒影",
