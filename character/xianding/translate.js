...
const translates = {
	...
	caohua: "曹华",
	caiyi: "彩翼",
	caiyi_info: "转换技。结束阶段，你可令一名角色选择并执行一项，然后移除此选项。阳：⒈回复X点体力。⒉摸X张牌，⒊复原武将牌。⒋随机执行一个已经移除过的阴选项；阴：⒈受到X点伤害。⒉弃置X张牌。⒊翻面并横置。⒋随机执行一个已经移除过的阳选项。（X为该阴阳态剩余选项的数量）。",
	guili: "归离",
	...
	yanghong: "杨弘",
	dcjianji: "间计",
	dcjianji_info: "出牌阶段限一次。你可以令至多X名座位连续的角色依次弃置一张牌。然后其中手牌数最多的角色可以视为对另一名被选择的其他角色使用一张【杀】（X为你的攻击范围）。",
	dcyuanmo: "远谟",
	...
	dcfenhui: "奋恚",
	dcfenhui_info: "限定技。出牌阶段，你可以令一名角色获得X枚“恨”标记，你摸等量的牌（X为本局游戏你使用牌指定其为目标的次数，至多为5）。你获得如下效果：⒈当其受到伤害时，你移去其1枚“恨”，令此伤害+1；⒉当其脱离濒死或死亡时，若其有“恨”，你减1点体力上限，修改〖守执〗并获得〖兴门〗。",
	dcxingmen: "兴门",
	dcxingmen_info: "①当你因〖守执〗弃置而失去牌后，你可以回复1点体力。②当你因摸牌而得到牌后，若牌数不小于2，则你使用这些牌时无次数限制且不能被响应。",
	dc_sb_jiaxu: "新杀谋贾诩",
	...
	dcwuxie: "无胁",
	dcwuxie_info: "出牌阶段结束时，你可以选择一名其他角色，与其交换手牌，然后你将手牌中全部伤害牌置于牌堆底。",
	liutan: "柳婒",
	dcjingyin: "经音",
	...
	dcdufeng: "独锋",
	dcdufeng_info: "锁定技，出牌阶段开始时，你须执行至少一项：①失去1点体力；②废除一个装备栏。然后你摸X张牌，且你的攻击范围与使用【杀】的次数上限均为X直到回合结束（X为你已废除的装备栏数与损失的体力值之和，至多为你的体力上限）。",
	dc_sb_chengyu: "新杀谋程昱",
	...
	dcsbkongwu: "孔武",
	dcsbkongwu_info: "转换技，出牌阶段限一次，你可以弃置至多体力上限张牌，选择一名其他角色：阳，弃置其至多等量张牌；阴，视为对其使用等量张【杀】。此阶段结束时，若其手牌数和体力值均不大于你，其下回合摸牌阶段摸牌数-1且装备区里的所有牌失效。",
	wenyuan: "文鸳",
	dckengqiang: "铿锵",
	dckengqiang_info: "每回合限一次，当你使用伤害牌时，你可以选择一项：1.摸体力上限张牌；2.令此牌伤害+1且获得造成伤害的牌。",
	dckuichi: "匮饬",
	...
	dcpeiniang: "醅酿",
	dcpeiniang_info: "①你可以将〖异瞳〗记录花色的牌当作【酒】使用（无任何次数限制）。②其他角色处于濒死状态时，你可以对其使用【酒】（回复效果）。",
	v_zhangliao: "威张辽",
	...
	dcguangyong_info: "锁定技。①当你使用牌指定自己为目标后，你增加1点体力上限。②当你使用牌指定其他角色为目标后，你选择一名有牌的其他目标角色，减少1点体力上限并获得其一张牌（体力上限至多减至1，加至8）。",
	dcjuchui: "据陲",
	dcjuchui_info: "连招技（装备牌+指向性锦囊牌）。你可以选择其中一个目标角色，若其体力上限不大于你，则你令其失去或回复1点体力；若其体力上限大于你，则你选择一个类别，从牌堆中获得一张此类别的牌，其本回合不能使用此类别的牌。",
	dc_sb_xunyu: "新杀谋荀彧",
	...
	dcsbbaojia: "保驾",
	dcsbbaojia_info: "游戏开始时，你选择一名其他角色。你与其每回合首次受到渠道为牌的伤害时，你可废除1个装备栏并防止此伤害，且此牌结算完毕后你获得之。",
	dcsbdouwei: "斗围",
	dcsbdouwei_info: "出牌阶段，你可弃置一张伤害牌，视为对任意名攻击范围内包含你的其他角色使用之，当目标因此进入濒死时，你回复1点体力并恢复一个装备栏然后本回合此技能失效。",
	dc_sb_caohong: "新杀谋曹洪",
	...
	dc_wuzhi: "吴质",
	dcweiti: "伪涕",
	dcweiti_info: "出牌阶段限一次，你可以令一名角色选择一项：1.受到1点伤害，获得两张与所有手牌点数均不同的牌；2.回复1点体力，然后弃置两张点数不同的牌。",
	dcyuanrong: "圆融",
	dcyuanrong_info: "回合结束时，你可以将本回合进入弃牌堆的一张黑色牌当任意普通锦囊牌使用，然后将本回合进入弃牌堆的一张红色牌当任意基本牌使用。",
	dc_zhushuo: "朱铄",
	dczsshuhe: "疏和",
	dczsshuhe_info: "每回合限一次，其他角色使用伤害牌时，你可以从牌堆获得一张【酒】，令其选择一项：1.令此牌无效并视为使用一张不计入次数限制的【酒】；2.令你摸一张牌。",
	dcjilie: "急烈",
	dcjilie_info: "出牌阶段限一次，你可弃置体力值张牌，每弃置一种花色的牌便进行两次判定。若判定结果为【杀】，你可视为使用此牌（无距离限制且此【杀】伤害为本回合你使用【杀】的次数）。",
	cuilingyi: "崔令仪",
	dchuashang: "华裳",
	dchuashang_info: "①游戏开始时，将每种颜色各一张牌置入你的装备区，若你的装备区存在两种颜色的牌，你使用牌无距离限制。②你使用一张牌结算完毕后，你可将一张相同花色的非装备手牌置入你的装备区。③当你的手牌数少于X，你将手牌数补至X（X为你装备区的花色数）。",
	dchuashang_equip: "华裳",
	...
	dcsbchuanyu: "传舆",
	dcsbchuanyu_tag: "舆",
	dcsbchuanyu_info: "①每轮开始时，你可交给一名角色一张牌，称为「舆」。②每当「舆」因使用进入弃牌堆时，你可将其交给本轮未获得过「舆」的一名角色。③每轮结束时，你可令本轮所有获得过「舆」的角色依次视为对你指定的一名角色使用【杀】(不限距离），然后弃置所有「舆」。",
	dcsbyitou: "倚投",
	dcsbyitou_info: "其他角色的出牌阶段开始时，若其手牌数为全场最多，你可将所有手牌交给该角色，直到本回合结束，该角色造成伤害后，你摸1张牌。",
	...
	dczhendu: "酖毒",
	dczhendu_info: "出牌阶段结束时，你可以展示至多五张基本或普通锦囊牌，然后你的下个回合开始时视为依次使用这些牌中的基本牌或普通锦囊牌（无距离限制）。你使用这些牌期间有角色回复体力或受到伤害后，你摸一张牌（因此获得的牌不计入本回合手牌上限）。",
	v_machao: "威马超",
	v_machao_prefix: "威",
	dczhongtao: "众讨",
	...
	v_sunce_prefix: "威",
	dczhifeng: "猘锋",
	dczhifeng_info: "每回合限X次（X为场上人数）。当你的手牌数：大于体力值时，你可将至少一张黑色牌当作不计入次数的【酒】使用；小于体力值时，你可将一张红色牌当作无距离限制的【杀】使用或打出，然后将手牌摸至体力上限；等于体力值时，你可将任意张牌当作【决斗】对至多两名角色使用。",
	dcweijing: "威靖",
	dcweijing_info: "其他吴势力角色的回合开始时，你可令其执行一项：1、受到你造成的1点伤害；2、交给你一张牌，然后其可发动一次对应条件的〖猘锋〗。",
	dc_sb_xusheng_prefix: "新杀谋",
	dc_sb_xusheng: "新杀谋徐盛",
	dcsbqinqiang: "勤强",
	dcsbqinqiang_info: "结束阶段，你可以弃置至多四张手牌，然后摸两倍数量的牌。",
	dcsbyizhen: "疑阵",
	dcsbyizhen_info: "其他角色使用牌指定你为目标后，若此牌花色在你手牌中：唯一最多，你弃置此花色的一张牌；最少，此牌结算后你获得之。",
	xuwen: "徐妏",
	dcfuhui: "赋绘",
	dcfuhui_info: "每种牌名每回合限一次，你可将两张手牌当作任意一张基本牌或普通锦囊牌使用。若这两张手牌的花色组合为本回合首次使用，你摸一张牌。",
	dcmohua: "摹画",
	...
	guotiying: "郭缇萦",
	dckanyu: "堪舆",
	dckanyu_info: "一名角色进行判定或当你受到伤害后，你可观看牌堆顶与牌堆底各一张牌，然后可获得其中任意张牌，并将剩余牌以任意顺序放回。若你以此法获得牌，【闪电】对你的生效范围增加你所获得牌的花色点数组合。",
	dczhee: "谪厄",
	...
	dcweiwei: "维卫",
	dcweiwei_info: "每回合限一次，你成为其他角色使用牌的目标后，你可与其各摸两张牌并交换一张手牌。此牌结算后你可以使用其交给你的牌；若你交给其的牌此回合结束时仍在其手牌中则对其造成1点伤害。",
	dc_sb_zhuran: "新杀谋朱然",
	...
	dcshuren: "淑任",
	dcshuren_info: "出牌阶段限一次，你可以废除一个装备栏，你选择一名其他角色，亮出牌堆顶的三张牌，你与其一次挑选其中一张牌获得，若此装备栏有牌则此技能视为未发动过并回复一点体力。",
	dcsaran: "飒然",
	dcsaran_info: "你的装备区内每有一张牌，你于出牌阶段内可使用的【杀】次数+1，你受到或造成一点伤害后，从牌堆或弃牌堆中随机使用一张装备牌并可选择一个装备栏恢复。",
	linglie: "凌烈",
	dcshouhu: "狩虎",
	dcshouhu_info: "出牌阶段限一次，你视为对一名其他角色使用【杀】，结算后本回合你与其计算距离+1；若其因此死亡，你摸至体力上限且以此法获得的牌无次数限制。本阶段有角色进入你的攻击范围时，此技能视为未发动过。",
	...
	dcfuji: "缚己",
	dcfuji_info: "每轮限一次，其他角色出牌阶段开始时，你可令其观看你的手牌。若如此做，本回合结束时你回复1点体力并摸三张牌，且本回合你成为其他角色使用牌的目标时，你可将所有手牌交给一名其他角色并令此牌无效。",
	//dcfuji_info: "你的回合结束时，可令一名其他角色观看你的手牌。若如此做，其使用牌指定你为目标时，你可交给其这些牌中的任意张牌并令此牌无效；你的下个回合开始时，若这些牌仍在你手牌中，其获得这些牌并回复1点体力。",
	dc_huanjie: "新杀桓阶",
	...
	dcsbhengye: "横野",
	dcsbhengye_info: "锁定技，①你造成伤害后，令你以下一项数值+1（至多+3）：1.摸牌阶段摸牌数；2.出牌阶段使用【杀】的次数；3.手牌上限，4.攻击范围。②若你〖横野①〗中任意项已+3，你的回合开始时，你回复1点体力。③你杀死一名角色后，重置此技能。",
	dcsbyingbo: "英博",
	dcsbyingbo_info: "你使用伤害牌时，若此牌本轮已有角色使用过同名牌，此牌造成的伤害改为火焰伤害且伤害+1；否则此牌不可被响应且结算结束后你可将其交给一名其他角色。",
	dc_sb_xuyou: "新杀谋许攸",
	dc_sb_xuyou_prefix: "新杀谋",
	dcsbmoyou: "谟猷",
	dcsbmoyou_info: "你每使用两张手牌结算后，可以摸三张牌，并选择一种花色弃置手牌中所有此花色的牌，若你手牌含有的类型数因此减少，本回合下次使用牌无次数与距离限制。",
	dcsbshiao: "恃傲",
	dcsbshiao_info: "锁定技，你的牌进入弃牌堆后，若此牌造成过伤害，本回合你摸牌时摸牌数+1：若此牌因弃置进入弃牌堆，本回合你摸牌时摸牌数-1。",
	houzhaoning: "侯昭宁",
	dcwangzi: "望资",
	dcwangzi_info: "每轮限一次，一名角色的出牌阶段开始时，你可弃置至一半手牌（向上取整，且至多弃五张）并令其从牌堆获得等量黑色牌，此阶段其使用这些牌后你与其各摸一张牌。",
	dcherong: "和戎",
	dcherong_info: "出牌阶段限一次，你可与一名其他角色各展示一张手牌然后选择一张手牌交换，若这两张牌：1.类型相同，防止你或其下次受到的伤害，其下次造成伤害后你与其从牌堆获得一张装备牌；2.类型不同，你弃置其两张牌，然后你对其造成1点伤害。",
	dc_sb_pangtong: "新杀谋庞统",
	dc_sb_pangtong_prefix: "新杀谋",
	dcsbyinmou: "寅谋",
	dcsbyinmou_info: "转换技，①游戏开始时，你可以转换此技能状态；②每个回合结束时，若本回合有角色失去手牌数大于剩余手牌数，你可观看牌堆顶三张牌并交给其中一名角色其中一张，此牌离开其手牌区时，阳：摸体力值张牌（至多摸五）；阴：弃置体力值张手牌。",
	...
	dcsbhongce: "宏策",
	dcsbhongce_info: "①首轮开始时，你令一名角色选择一项执行：1.将半数手牌替换为伤害牌，视为使用一张【杀】；2.重铸一张手牌，视为使用一张单目标普通锦囊牌；3.摸三张牌且这些牌不计入手牌上限。②出牌阶段限一次，你可令一名角色执行你〖宏策①〗选择的项。",
	dc_sb_wuyi: "新杀谋吴懿",
	dc_sb_wuyi_prefix: "新杀谋",
	dcsbshibian: "识变",
	dcsbshibian_info: "每轮开始时，你可选择一名其他角色，本轮其攻击范围内的角色视为在你攻击范围内，且你使用【杀】或普通锦囊牌可指定一名其攻击范围内的角色为额外目标。",
	dcsbbibu: "庇部",
	dcsbbibu_info: "你的上家或下家每回合首次成为其他角色的【杀】或普通锦囊牌的唯一目标时，你可摸一张牌并令此牌无效；你的上家或下家每回合首次使用【杀】或普通锦囊牌结算结束后，你可摸一张牌，视为使用此牌。",
	dc_sb_fazheng: "新杀谋法正",
	dc_sb_fazheng_prefix: "新杀谋",
	dcsbzhenjian: "缜鉴",
	dcsbzhenjian_info: "每轮开始时，你可选择一名其他角色并秘密选择一个普通锦囊牌的牌名，本轮其使用普通锦囊牌时，若与你选择的牌名不同，你可为此牌增加或减少1个目标（至少为1），否则你摸一张牌且此技能本回合失效。",
	dcsbxixing: "悉性",
	...
	dcsblingshu: "领戍",
	dcsblingshu_info: "若你本回合未造成或受到过伤害，你可将一张非基本牌当作基本牌使用或打出。你每回合首次造成或受到伤害后，可从弃牌堆中获得一张你本回合失去的牌。",
	dcsbwankang: "顽抗",
	dcsbwankang_info: "你处于濒死状态时，可以回复1点体力，然后获得一个“抗”并摸两张牌；若如此做，本回合结束时你可对本回合对你造成过伤害的角色使用任意张【杀】（每使用一张便移去一个“抗”，以此法杀死角色则移去全部“抗”），然后若你还有“抗”，你死亡。",
	v_liubei: "威刘备",
	v_liubei_prefix: "威",
	dcliexiang: "烈骧",
	dcliexiang_info: "出牌阶段限一次，你可摸至多X张牌（X为游戏人数且至多为5），然后选择一名其他角色，若你的手牌数：1.大于其，其本回合视为在你攻击范围内且不能响应你的牌；2.等于其，你弃置其一张牌并对其造成1点伤害；3.小于其，你失去2点体力，此技能视为未发动过，且可选目标数改为2。",
	dcrengou: "仁彀",
	dcrengou_info: `其他蜀势力角色的出牌阶段限一次，其可弃置一张基本牌并令你回复1点体力，然后你可令其发动一次X为2的${get.poptip("dcliexiang")}。`,
};
