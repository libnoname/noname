...
const translates = {
	...
	dc_liuye: "刘晔",
	dcpoyuan: "破垣",
	dcpoyuan_info: "游戏开始时或回合开始时，若你的装备区内：没有【霹雳投石车】，则你可以将一张【霹雳投石车】置入装备区；有【霹雳投石车】，则你可以弃置一名其他角色至多两张牌。",
	dchuace: "画策",
	...
	lvju: "吕据",
	dczhengyue: "征越",
	dczhengyue_info: "①回合开始时，若你武将牌上没有“征越”牌，你可将牌堆顶至多五张牌以任意顺序置于武将牌上（你至多拥有五张“征越”牌）。②当你使用牌结算完毕后，若此牌与你武将牌上的第一张“征越”牌的花色或点数或牌名相同，你弃置武将牌上的第一张“征越”牌并摸两张牌；否则你将此牌对应的实体牌置于武将牌上并调整任意“征越”牌的顺序，每以此法放置两张牌，当前回合不可再使用手牌。",
	v_sunquan: "威孙权",
	v_sunquan_prefix: "威",
	dcwoheng: "斡衡",
	...
	caoyuan: "曹媛",
	dcwuyan: "妩艳",
	dcwuyan_info: "出牌阶段/当你受到伤害后，你可以选择一名男性角色A和另一名其他角色B，A选择是否对B使用一张手牌。若A因此使用牌，则你摸两张牌；若A未因此造成伤害，你可令A失去1点体力，然后〖妩艳〗于本阶段失效。",
	dczhanyu: "占欲",
	...
	dcjiwei: "极威",
	dcjiwei_info: "其他魏势力角色出牌阶段限一次，其可以交给你一张手牌，然后你可令其发动一次至多弃置三张牌的〖典论〗",
	dcsugang: "肃纲",
	...
	y_dc_falu: "法箓",
	y_dc_falu_info: "你失去一张手牌时，记录此牌花色（只保留最后三个记录）；然后若你已记录三个花色且记录的花色：均相同，移去记录花色并从牌堆中获得其余花色的牌各一张；均不同，你可以移去记录花色并令一名角色失去或回复1点体力。",
	y_dc_zhenyi: "真仪",
	...
	v_caocao_prefix: "威",
	dcduoyue: "掇月",
	dcduoyue_info: "出牌阶段开始时，你可进行至多三次拼点，赢的角色摸当前拼点次数张牌。若你赢，你可改为对一名角色造成1点伤害并终止后续拼点。",
	dcjunhe: "军合",
	dcjunhe_info: "准备阶段，你可弃置任意张颜色或类别相同的牌并获得“军合”效果：你下X次（X为你弃置的牌数+1）：造成伤害时令此伤害+1；受到伤害后摸两张牌”。",
	dcxiongwei: "雄威",
	dcxiongwei_info: "你和魏势力角色拼点后，你获得其拼点的牌。若如此做，且该角色没有“军合“效果，则你可以将任意次数的“军合”转移给该角色。",
	v_sunce: "威孙策",
	v_sunce_prefix: "威",
	dczhifeng: "猘锋",
	dczhifeng_info: "每回合限X次（X为场上人数）。当你的手牌数：大于体力值时，你可将至少两张黑色牌当作不计入次数的【酒】使用。；小于体力值时，你可将一张红色牌当作【杀】或【闪】使用或打出，然后将手牌摸至体力上限。；等于体力值时，你可将任意张牌当作【决斗】使用。",
	dcweijing: "威靖",
	dcweijing_info: "吴势力角色的回合开始时，你可令其执行一项：1，受到你造成的1点伤害：2、交给你一张牌，然后其可发动一次对应条件的〖猘锋〗。",
	...
	xuwen: "徐妏",
	dcfuhui: "赋绘",
	dcfuhui_info: "每种牌名每回合限一次，你可将两张不同花色的手牌当作任意一张基本牌或普通锦囊牌使用。若这两张手牌的花色组合为本回合首次使用，你摸一张牌。",
	dcmohua: "摹画",
	dcmohua_info: "每轮限一次，其他角色回合结束时，你可依序使用其出牌阶段使用的相同牌名的非装备牌（使用者视为该角色）。若此牌目标与其使用该牌时完全相同，你摸此牌目标数的牌。",
	suyue: "苏越",
	dcgongtu: "宫图",
	dcgongtu_info: "游戏开始时，你可以依次选择两种类型，一名角色使用牌时，若上一张被使用的牌与此牌的类型与你选择的顺序相同，你从牌堆获得一张指定点数的牌。",
	dchangzhu: "夯筑",
	dchangzhu_info: "出牌阶段限一次，你可以将任意张牌置于武将牌上，称为“基”，然后令一名其他角色不能使用或打出与这些牌点数相同的牌直到你的下回合开始。若“基”中：有重复点数，弃置所有重复点数的“基”并摸两张牌；包含了13个点数，你将所有“基”交给一名角色并令其回复所有体力。",
	guotiying: "郭缇萦",
	dckanyu: "堪舆",
	dckanyu_info: "一名角色进行判定或你受到伤害时，你可观看牌堆顶与牌堆底各一张牌，然后可获得其中任意张牌，并将剩余牌以任意顺序放回牌堆顶。若你以此法获得牌，【闪电】对你的生效范围增加你所获得牌的花色点数组合。",
	dczhee: "谪厄",
	dczhee_info: "锁定技，游戏开始时/每回合结束时，你将牌堆/弃牌堆中的一张【闪电】置入你的判定区。",
	taohuang: "陶璜",
	dczhijue: "制绝",
	dczhijue_info: "锁定技，你计算与其他角色的距离-2。当你造成伤害后，此技能失效直到回合结束。",
	dcweiwei: "维卫",
	dcweiwei_info: "每回合限一次，你成为其他角色使用牌的目标后，你可与其各摸两张牌，然后交换一张手牌。若其交给你的牌你可以使用则结算后你使用之；若你交给其的牌此回合结束时仍在其手牌中则对其造成一点伤害。",
	dc_sb_zhuran: "新杀谋朱然",
	dc_sb_zhuran_prefix: "新杀|谋",
	dcsbzhenyu: "镇御",
	dcsbzhenyu_info: "当你需要使用【杀】或【闪】时，你可以横置一名角色，然后视为使用此牌。若如此做。此技能失效直到你从手牌中使用【杀】或【闪】。",
	dcsbjielu: "截路",
	dcsbjielu_info: "出牌阶段，你可以重置一名已横置的角色并弃置其一张牌，然后若此回合下一次进入弃牌堆的牌点数大于此此牌，你对其造成一点伤害。",
	...
	liuyijun: "刘懿君",
	dcdulu: "妒戮",
	dcdulu_info: "出牌阶段限一次，你可选择一名对你使用过牌的其他角色，对其造成1点伤害，然后直到你的下个回合结束，其进入濒死时你弃置其所有黑色牌。",
	dcfuji: "缚己",
