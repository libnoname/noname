const translates = {
	...
	wenyuan: "文鸳",
	dckengqiang: "铿锵",
	dckengqiang_info: "每回合限一次，当你造成伤害时，你可以选择一项：1.摸体力上限张牌；2.令此伤害+1并获得造成伤害的牌。",
	dckuichi: "匮饬",
	...
	dclianjie: "连捷",
	dclianjie_info: "每回合每个点数限一次，你使用手牌指定目标后，若此牌点数不大于你的所有手牌（无点数视为0），你可令一名角色将其一张点数最小的手牌置于牌堆底，然后你将手牌摸至体力上限，以此法获得的牌本回合无距离次数限制。",
	dcjiangxian: "将贤",
	...
	pangfengyi: "庞凤衣",
	dcyitong: "异瞳",
	dcyitong_info: "锁定技。①游戏开始时，你记录一个花色。②当你每回合首次成为〖异瞳〗记录花色的牌的目标后，你从牌堆或弃牌堆获得与此牌花色不同的牌各一张。",
	dcpeiniang: "醅酿",
	dcpeiniang_info: "①你可以将〖异瞳〗记录花色的牌当作【酒】使用（无任何次数限制）。②其他角色处于濒死状态时，你可以对其使用【酒】（回复效果）。③因你使用【酒】执行的体力回复效果至少令目标角色将体力值回复至1点。",
	wei_zhangliao:"威张辽",//TODO
	newj_yuxi: "驭袭",
	newj_yuxi_info: "当你受到或造成伤害时，你摸一张牌且使用此牌无次数限制并不计入次数限制。",
	newj_porong: "破戌",
	newj_porong_info: "连招技（伤害牌+【杀】）你可以令此【杀】目标无法响应，并获得其相邻角色各一张手牌。",
};
