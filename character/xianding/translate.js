const translates = {
	...
	caoyuan: "曹媛",
	dcwuyan: "妩艳",
	dcwuyan_info: "出牌阶段/当你受到伤害后，你可以选择一名男性角色A和另一名其他角色B，A选择是否对B使用一张手牌。若A因此使用牌，则你摸两张牌；若A未因此使用牌或未因此造成伤害，你可令A失去1点体力，然后〖妩艳〗于本阶段失效。",
	dczhanyu: "占欲",
	...
	v_caopi_prefix: "威",
	dcdianlun: "典论",
	dcdianlun_info: "出牌阶段限一次，你可以弃置任意张点数差相同（即等差数列）的手牌，然后摸等量的牌，这些牌本回合不受〖肃纲〗的使用限制。",
	dcdianlun_infox: "你弃置至多三张点数差相同（即等差数列）的手牌，然后摸等量的牌，这些牌本回合不受〖肃纲〗的使用限制。",
	dcjiwei: "极威",
	dcjiwei_info: "其他魏势力角色出牌阶段限一次，其可以交给你一张手牌，然后你可令其发动一次至多弃置三张牌的〖典论〗",
	dcsugang: "肃纲",
	dcsugang_info: "出牌阶段开始时，你可以进行判定并获得生效的判定牌，然后你选择至多2项：1.此牌本回合可以当任意伤害牌使用；2.展示一张手牌，然后本回合所有角色均只能使用判定结果与展示牌点数之间的手牌；3.本回合获得〖行殇〗且〖典论〗中的“等量”改为“两倍”",
	dc_wuzhi: "吴质",
	dcweiti: "伪涕",
	...
	dc_zhushuo: "朱铄",
	dczsshuhe: "疏和",
	dczsshuhe_info: "每回合限一次，其他角色使用伤害牌时，你可以从牌堆获得一张【酒】，其可令此牌无效并视为使用一张不计入次数限制的【酒】或令你摸一张牌。",
	dcjilie: "急烈",
	dcjilie_info: "出牌阶段限一次，你可弃置每种花色的牌各一张，每弃置一种花色的牌便进行两次判定。若判定结果为【杀】，你可视为使用此牌（无距离限制且此【杀】伤害为本回合你使用【杀】的次数）。",
	cuilingyi: "崔令仪",
	dchuashang: "华裳",
	dchuashang_info: "①你使用一张牌结算完毕后，你可将一张相同花色的非装备手牌置入你的装备区。②当你的手牌数少于X，你将手牌数补至X（X为你装备区的花色数）。",
	dcyuzhi: "逾制",
	dcyuzhi_info: "锁定技，当你成为【杀】的目标时，需选择一项执行：1.弃置一张装备区内的牌并失去此选项至本轮结束；2.此【杀】伤害增加你装备区非装备牌数。",
	dc_sb_hulie: "新杀谋胡烈",
	dc_sb_hulie_prefix: "新杀谋",
	dcsbchuanyu: "传舆",
	dcsbchuanyu_tag: "舆",
	dcsbchuanyu_info: "①每轮开始时，你可摸一张牌然后交给一名角色一张牌，称为「舆」。②每当「舆」因使用进入弃牌堆时，你可将其交给本轮未获得过「舆」的一名角色。③每轮结束时，你可令本轮所有获得过「舆」的角色依次视为对你指定的一名角色使用【杀】(不限距离），然后弃置所有「舆」。",
	dcsbyitou: "倚投",
	dcsbyitou_info: "其他角色的出牌阶段开始时，若其手牌数为全场最多，你可将所有手牌交给该角色，直到你的下回合开始，该角色造成伤害后，你摸1张牌。",
	...
	renwan: "任婉",
	dcjuanji: "狷急",
	dcjuanji_info: "摸牌阶段开始时，你可以摸体力上限张牌；出牌阶段开始时，你可以失去1点体力，然后视为对一名角色使用一张【杀】；弃牌阶段开始时，你可以调整手牌至手牌上限，然后弃置一名角色区域里至多两张牌。",
	dcrenshuang: "纫霜",
	dcrenshuang_info: "锁定技，①你每轮首次进入濒死时，回复体力至1点并增加1点体力上限（至多以此法增加3点）。②你脱离濒死时，复原武将牌并视为使用一张普通锦囊牌。",
	x_dc_falu: "法箓",
	...
	dcsbshijin: "恃矜",
	dcsbshijin_info: "限定技，出牌阶段，若你本回合造成过伤害，你可以获得每种类型的牌各一张，且直到你的下个回合开始前，你受到伤害时防止之并摸一张牌。你的下个回合开始时，弃置所有【杀】和锦囊牌并失去等量体力，若你未因此失去体力，此技能视为未发动过。",
};
