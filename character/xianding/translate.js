...
const translates = {
	...
	liuyijun: "刘懿君",
	dcdulu: "妒戮",
	dcdulu_info: "出牌阶段每名角色各限一次，你可选择一名对你使用过牌的其他角色，对其造成1点伤害，然后直到你的下个回合结束，其进入濒死时你弃置其所有黑色牌。",
	dcfuji: "缚己",
	dcfuji_info: "其他角色出牌阶段开始时，若其手牌数全场最多，你可令其观看你的手牌，本阶段其使用牌指定你为目标时，你可交给其所有手牌并令此牌对你无效。若你以此法失去手牌，本回合结束时你回复1点体力并摸至体力上限（至多摸五张）。",
	...
	houzhaoning: "侯昭宁",
	dcwangzi: "望资",
	dcwangzi_info: "每轮限一次，一名角色的出牌阶段开始时，你可弃置一半手牌（向上取整）并令其从牌堆获得等量黑色牌，此阶段其使用这些牌造成伤害时摸一张牌。",
	dcherong: "和戎",
	dcherong_info: "出牌阶段限一次，你可与一名其他角色各展示一张手牌然后选择一张手牌交换，若这两张牌：1.类型相同，你下次受到伤害时其失去1点体力并防止此伤害，其下次造成伤害后从牌堆获得一张装备牌；2.类型不同，你弃置其一张牌，然后你与其各对对方造成1点伤害。",
	dc_sb_pangtong: "新杀谋庞统",
	dc_sb_pangtong_prefix: "新杀谋",
	dcsbyinmou: "寅谋",
	dcsbyinmou_info: "转换技，①游戏开始时，你可以转换此技能状态；②一名角色的回合结束时，若其本回合失去手牌数大于手牌数，你可观看牌堆顶三张牌并交给其其中一张，其失去此牌时，阳：将手牌摸至体力上限（至多摸五）；阴：弃置体力值张手牌。",
	...
	dcsbbibu: "庇部",
	dcsbbibu_info: "你的上家或下家每回合首次成为【杀】或普通锦囊牌的唯一目标时，你可摸一张牌并将此牌目标改为你；你的上家或下家每回合首次使用【杀】或普通锦囊牌结算结束后，你可弃置一张牌，视为使用此牌。",
	dc_sb_fazheng: "新杀谋法正",
