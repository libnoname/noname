const translates = {
	...
	dcsbzhiwang: "质亡",
	dcsbzhiwang_info: "锁定技，结束阶段，你弃置装备区里的所有牌。若你以此法弃置了牌，选择弃牌堆里的一张牌并令一名其他角色使用之（此牌对你造成的伤害视为无来源）。",
	...
	xuxin: "徐馨",
	dcyuxian: "育贤",
	dcyuxian_info: "当你于出牌阶段使用牌时，你记录此牌花色直到你的下个出牌阶段（至多记录四个花色）。其他角色于其回合内使用与你记录花色顺序相同的牌时，你可与其各摸一张牌。",
	dcminshan: "愍善",
	...
	dcyuanrong: "圆融",
	dcyuanrong_info: "回合结束时，你可以本回合进入弃牌堆的一张黑色牌当任意普通锦囊牌使用，然后将本回合进入弃牌堆的一张红色牌当任意基本牌使用。",
	dc_zhushuo: "朱铄",
	dczsshuhe: "疏和",
	...
	dcsbzhouxi: "骤袭",
	dcsbzhouxi_info: "出牌阶段限一次，你弃置所有当前无法指定其他角色为目标的手牌，并根据弃牌数依次选择等量项：1.本回合计算与其他角色距离-X；2.视为对至多X名角色使用【顺手牵羊】；3.视为对至多X名角色使用【杀】。若你执行了所有选项，此技能视为未发动过（X未此项被选择的次序）。",
	dcsbshijin: "恃矜",
