const translates = {
	dc_sp_puyuan_prefix: "新杀SP",
	dc_sp_puyuan: "新杀SP蒲元",
	dc_sp_huanling: "唤灵",
	dc_sp_huanling_info: "出牌阶段开始时或你受到伤害后，你可以重铸一张牌，然后获得场上、弃牌堆或牌堆一张花色相同的装备牌，并随机出现该装备的三个兵主技能选择其中一个令一名角色获得。若该角色不为你，你摸X张牌。(X为其技能数)",
	dc_sp_shenduan: "神锻",
	dc_sp_shenduan_info: "锁定技，每个副类别每回合限一次，你使用一张装备牌后，根据副类别执行对应效果：武器：视为使用一张【杀】；防具：增加1点体力上限并回复1点体力；进攻马：弃置每名其他角色各一张牌；防御马：摸一张牌且本局手牌上限+1。",
	puyuan: "蒲元",
	pytianjiang: "天匠",
	...
	lvju: "吕据",
	dczhengyue: "征越",
	dczhengyue_info: "①回合开始时，若你武将牌上没有“征越”牌，你可将牌堆顶至多五张牌以任意顺序置于武将牌上（你至多拥有五张“征越”牌）。②当你使用牌结算完毕后，若此牌与你武将牌上的第一张“征越”牌的花色或点数或牌名相同时，则你将武将牌上的第一张“征越”牌置入弃牌堆并摸两张牌；否则你将此牌对应的实体牌置于武将牌上并调整任意“征越”牌的顺序，每以此法放置两张牌，当前回合不可再使用手牌。",
	v_sunquan: "威孙权",
	v_sunquan_prefix: "威",
	dcwoheng: "斡衡",
	...
	dcsbjuemou: "绝谋",
	dcsbjuemou_info: "转换技，游戏开始时可自选阴阳状态。你使用锦囊牌时，你可以：阳：对自己造成1点伤害并摸已损失体力值数张牌；阴：令一名角色弃置另一名角色一张牌并受到其造成的1点伤害。若你因此技能进入濒死，你将体力值回复至1点。",
	dcsbjuemou_rewrite: "绝谋·改",
	dcsbjuemou_rewrite_info: "转换技，游戏开始时可自选阴阳状态。你使用锦囊牌时，或回合开始和结束时，你可以：阳：对自己造成1点伤害并摸已损失体力值数张牌；阴：令一名角色弃置另一名角色一张牌并受到其造成的1点伤害。若你因此技能进入濒死，你将体力值回复至1点。",
	dcsbfuzhan: "复盏",
	dcsbfuzhan_info: "限定技，当有角色脱离濒死状态时，你可回复满体力值，然后修改〖绝谋〗。",
	renwan: "任婉",
	dcjuanji: "狷急",
	...
	dcsbjunmou: "隽谋",
	dcsbjunmou_info: "转换技，游戏开始时可自选阴阳状态。若你成为牌的目标，此牌结算后你可摸一张牌并选择一张手牌，阳：此牌视为无次数限制的火【杀】；阴：重铸此牌并横置一名角色。",
	dcsbzhanyan: "绽炎",
	...
	dcjizhan: "极斩",
	dcjizhan_info: "连招技（装备牌+黑色牌）你选择一项：1.弃置其他角色共计至多X张牌；2.对一名角色造成X点伤害，然后此技能本回合失效（X为本回合〖极斩〗的发动次数）。",
	dc_sb_luotong: "新杀谋骆统",
