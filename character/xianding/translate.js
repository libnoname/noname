const translates = {
	...
	dcsbbizuo: "弼佐",
	dcsbbizuo_info: "限定技，一名角色的回合结束时，若一号位体力全场最低，你可令一名角色执行一个额外回合。本回合除你与该角色外，其余角色非锁定技失效；本回合结束后，你分配当前回合所有不因弃置而进入弃牌堆的牌。",
	dcsbshimou: "势谋",
	...
	v_machao_prefix: "威",
	dczhongtao: "众讨",
	dczhongtao_info: "出牌阶段限一次，你可以选择至多X+1种花色（X为你已损失的体力值），然后随机获得场上、牌堆或弃牌堆中你选择花色的各一张牌。若如此做，你使用三种类别的牌后，此技能视为未发动过。",
	dcjizhan: "极斩",
	dcjizhan_info: "连招技（坐骑或防具牌+黑色牌）你选择一项：1.弃置其他角色共计至多X张牌；2.对一名角色造成X点伤害，然后此技能本回合失效（X为本回合〖极斩〗的发动次数）。",
	dc_sb_luotong: "新杀谋骆统",
