const translates = {
	...
	dcsbjunmou: "隽谋",
	dcsbjunmou_info: "转换技。①游戏开始时，你可以转换此技能状态；②一张牌结算结束后，若此牌的目标包括你，你可以摸一张牌并选择一张手牌，阳：此牌视为无次数限制的火【杀】；阴：重铸此牌并横置一名角色。",
	dcsbzhanyan: "绽炎",
	dcsbzhanyan_info: "限定技，出牌阶段，你可选择任意名横置的其他角色并摸等量张牌，然后这些角色同时展示一张手牌，你可弃置相同花色牌并对展示对应花色的角色各造成1点火焰伤害，若这些角色均受到伤害则重复此流程， 且此技能结算期间你每失去一张牌则摸一张牌。",
	dongxu: "董絮",
	dcqingleng: "清冷",
	...
	dcsbjuce: "举策",
	dcsbjuce_info: "你于回合内首次使用基本或普通锦囊牌指定目标时，可额外选择一个目标。若如此做，该角色下回合使用基本或普通锦囊牌须额外指定你为目标。",
	dcsbkangming: "抗明",
	dcsbkangming_info: "当你成为其他角色使用牌的目标后，若你不是本回合第一次成为其使用牌的目标，则此牌结算后你摸一张牌并选择一项：1.对其使用一张牌；2.再摸三张牌且此技能失效至你的回合开始。",
	...
	dc_sb_xusheng: "新杀谋徐盛",
	dcsbqinqiang: "勤强",
	dcsbqinqiang_info: "结束阶段，你可以弃置至多四张手牌，然后摸两倍数量的牌。若如此做，直到你的下回合开始，其他角色使用牌指定你为目标后，若此牌花色是你手牌中最多的花色，你弃置其中一张牌；若你手中没有此花色的牌，此牌结算后你获得之。",
	xuwen: "徐妏",
	dcfuhui: "赋绘",
