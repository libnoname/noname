const translates = {
	...
	dc_sb_xusheng: "新杀谋徐盛",
	dcqinqiang: "勤强",
	dcqinqiang_info: "结束阶段，你可以弃置至多4张手牌，然后摸两倍数量的牌。若如此做，直到你的下回合开始其他角色使用牌指定你为目标后，若此牌花色是你手牌中最多的花色，你弃置其中一张牌；若你手中没有此花色的牌，此牌结算后你获得之。",
	xvwen: "徐妏",
	dcfuhui: "赋绘",
	dcfuhui_info: "每种牌名每回合限一次，你可将两张不同花色的手牌当作任意一张基本牌或普通锦囊牌使用，若两张手牌的花色组合为本回合首次，你可摸一张牌。",
	dcmohua: "摹画",
	dcmohua_info: "每轮限一次，其他角色回合结束时，你可依序使用其出牌阶段使用的相同牌名的非装备牌（视为该角色使用），若此牌目标与其使用该牌时完全相同，你摸此牌目标数的牌。",
	puyuan: "蒲元",
	pytianjiang: "天匠",
