...
const translates = {
	...
	db_wenyang: "手杀文鸯",
	dbquedi: "却敌",
	dbquedi_info: "每回合限一次。当你使用【杀】或【决斗】指定唯一目标后，你可选择：①获得目标角色的一张手牌。②弃置一张基本牌，并令此牌的伤害值基数+1。③" + get.poptip("beishui") + "：减1点体力上限。",
	dbzhuifeng: "椎锋",
	...
	spyilie: "毅烈",
	spyilie_info: "出牌阶段开始时，你可选择：①本阶段内使用【杀】的次数上限+1。②本回合内使用【杀】被【闪】抵消时，摸一张牌。③" + get.poptip("beishui") + "：失去1点体力。",
	spfenming: "奋命",
	...
	sp_zongyu: "手杀宗预",
	zhibian: "直辩",
	zhibian_info: "准备阶段，你可以和一名其他角色拼点。若你赢，你可选择：①将其装备区/判定区内的一张牌移动到你的对应区域。②回复1点体力。③" + get.poptip("beishui") + "：跳过下个摸牌阶段；若你没赢，你失去1点体力。",
	yuyan: "御严",
