...
const translates = {
	...
	clan_xunyu_prefix: "族",
	clandingan: "定安",
	clandingan_info: "锁定技，当一个牌名的牌每回合第二次被使用后，你与任意非目标角色各摸一张牌（每回合每名角色限一次），然后你对手牌最多的其他角色造成1点伤害，或令其随机弃置手牌中最多的同名牌。",
	clanfuning: "抚宁",
	...
	clanxsyingxiang: "萦香",
	clanxsyingxiang_info: "锁定技，当其他角色获得你的牌后，将此牌称为“萦香”牌。当有角色失去“萦香”牌后，你和手牌中有“萦香”牌的角色各摸一张牌。若不因使用而失去，你发动一次〖清绝〗（每轮限一次）。",
};
