...
const translates = {
	...
	mbzengou: "谮构",
	mbzengou_info: "出牌阶段限一次，你可以观看一名其他角色的手牌，然后你选择一项：①视为使用两张其手牌中未拥有的基本牌牌名的牌（不计入次数且无次数限制且不可重复）；②将你与其手牌中共同牌名的牌替换为牌堆中等量的【杀】，这些【杀】不计入手牌上限直到各自的结束阶段。然后你移去其“诬”标记并选择一个基本牌牌名，令其获得1枚此牌名对应的“诬”标记（每回合使用的前三张牌结算完毕后，若拥有此牌名的“诬”标记，则失去1点体力并移去1枚此牌名的“诬”标记）。",
	mbfeili: "诽离",
	...
	mbbingfa_info: `每轮开始时，你可选择两条${get.poptip({
		...
		name: "律法",
		type: "character",
		info: `<li>造成伤害最多者受到2点无来源伤害<br><li>获得牌数最多者手牌上限-2<br><li>体力变化次数最多者减少1点体力上限<br><li>区域内牌数最多者交给每名其他角色各一张牌`,
