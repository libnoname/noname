...
const translates = {
	...
	mbzengou: "谮构",
	mbzengou_info: "出牌阶段限一次，你可以观看一名其他角色的手牌，然后你选择一项：①视为使用两张其手牌中未拥有的基本牌牌名的牌（无距离和次数限制）；②将你与其手牌中共同牌名的牌替换为牌堆中等量的【杀】，这些【杀】不计入手牌上限直到各自的结束阶段。然后你选择一个基本牌牌名，令其获得1枚此牌名对应的“诬”标记（每回合使用第一张牌结算完毕后，若拥有此牌名的“诬”标记，则失去1点体力并移去1枚此牌名的“诬”标记）。",
	mbfeili: "诽离",
