...
const translates = {
	...
	pothongyi: "弘毅",
	pothongyi_info: "锁定技。①游戏开始时，你获得2个「毅」标记；当你造成或受到伤害后，你获得1个「毅」标记；你至多拥有4个「毅」标记。②准备阶段，你选择一项，并于结束阶段执行另一项：1.摸X张牌（X为你拥有的「毅」标记数）；2.移去所有「毅」标记",
	...
	potyinzhan: "饮战",
	potyinzhan_info: "锁定技，你使用【杀】对一名角色造成伤害时，若：1.你的体力值小于等于其，此伤害+1；2.你的牌数小于等于其，你于此【杀】结算结束后弃置其一张牌；乘势：若前两项均符合，你回复1点体力，获得其弃置的牌。",
	potkuanggu: "狂骨",
