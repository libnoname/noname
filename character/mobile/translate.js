...
const translates = {
	...
	mbchoumang: "仇铓",
	mbchoumang_info: "每回合限一次，你使用【杀】指定唯一目标或成为【杀】的唯一目标后，可以选择一项：①令此【杀】伤害+1；②若此【杀】被【闪】抵消，你可以获得与你距离为1以内的一名其他角色区域里的一张牌；③<noname-poptip tip=\"beishui\"></noname-poptip>：弃置你与其装备栏里的武器牌。",
	mb_simazhou: "手杀司马伷",
	...
	mbhuxiao: "虎啸",
	mbhuxiao_info: "出牌阶段限一次，你可选择一项：1.对一名体力值大于等于你的角色造成1点火焰伤害：2.本回合使用牌无距离限制；3.<noname-poptip tip=\"beishui\"></noname-poptip>：弃置一张红色牌。",
	mbwuji: "武继",
	...
	mbsijian: "死谏",
	mbsijian_info: "每回合限两次，当你失去最后的手牌后，或当你进入濒死状态时，你可以选择一项：1.选择一名其他角色，其使用下一张牌后需弃置一张牌。2.令当前回合角色摸两张牌。若此时没有角色处于濒死状态，你可以<noname-poptip tip=\"beishui\"></noname-poptip>：失去X点体力（X为你此前发动过背水的次数）。",
	mb_huangzu: "手杀黄祖",
	...
	potyinzhan: "饮战",
	potyinzhan_info: "锁定技，你使用【杀】对一名角色造成伤害时，若：1.你的体力值小于等于其，此伤害+1；2.你的牌数小于等于其，你于此【杀】结算结束后弃置其一张牌；<noname-poptip tip=\"chengshi\"></noname-poptip>：你回复1点体力，获得其弃置的牌。",
	potkuanggu: "狂骨",
	potkuanggu_info: "你对距离1以内的一名角色造成伤害后，可以选择一项：1.回复1点体力；2.摸一张牌。",
	potkuanggu_pot_weiyan_achieve: "狂骨·二级",
	potkuanggu_pot_weiyan_achieve_info: "你对距离1以内的一名角色造成伤害后，可以选择一项：1.回复1点体力；2.摸一张牌；3.<noname-poptip tip=\"beishui\"></noname-poptip>：弃置一张牌并令你此阶段使用【杀】的次数+1。",
	pot_lusu: "势鲁肃",
	pot_lusu_prefix: "势",
	pothaoshi: "好施",
	...
	mbjingtu: "净土",
	mbjingtu_info: "限定技，出牌阶段，你可选择一项：1.获得所有黑色“业”并对一名角色造成等量伤害；2.获得所有红色“业”，令一名角色增加等量点体力上限并恢复等量体力；3.<noname-poptip tip=\"beishui\"></noname-poptip>，两种颜色的“业”数量均大于1且相同。然后你失去〖浮图〗并获得〖佛宗〗。",
	mbjiebian: "劫辩",
