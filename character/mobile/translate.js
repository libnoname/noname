...
const translates = {
	...
	friendfangqiu: "方遒",
	friendfangqiu_info: "限定技，当你执行“卧龙演策”后，你可以展示你的“卧龙演策”预测。若如此做，本次“卧龙演策”的预测全部验证后，执行“[]”中效果的值均+1，然后若卧龙演策预测的牌数大于等于3且预测全部正确，该技能可以再次发动。",
	...
	mbzengou: "谮构",
	mbzengou_info: "出牌阶段限一次，你可以观看一名其他角色的手牌，然后你选择一项：①视为使用两张其手牌中未拥有的基本牌牌名的牌（不计入次数且无次数限制且不可重复）；②将你与其手牌中共同牌名的牌替换为牌堆中等量的【杀】，这些【杀】不计入手牌上限直到各自的结束阶段。然后你移去其“诬”标记并选择一个基本牌牌名，令其获得1枚此牌名对应的“诬”标记（每回合使用第一张牌结算完毕后，若拥有此牌名的“诬”标记，则失去1点体力并移去1枚此牌名的“诬”标记）。",
	mbfeili: "诽离",
	...
	mbjingtu: "净土",
	mbjingtu_info: `限定技，出牌阶段，你可选择一项：1.获得所有黑色“业”并对一名角色造成等量伤害；2.获得所有红色“业”，令一名角色增加等量点体力上限并恢复等量体力；3.${get.poptip("rule_beishui")}，两种颜色的“业”数量均大于1且相同。然后你失去〖浮图〗并获得〖佛宗〗。`,
	mbjiebian: "劫辩",
	...
	mbxushen: "许身",
	mbxushen_info: "限定技，出牌阶段，你可以摸至多三张牌并失去等量体力，然后若你因此进入濒死状态，则当你脱离此次濒死状态后，你可以将〖武圣〗〖当先〗〖制蛮〗分配给本次濒死令你回复过体力的角色（若其已拥有，改为摸三张牌）。",
	mbzhennan: "镇南",
	...
	mblingfa_info: "①第一轮开始时，你可令本轮其他角色使用【杀】时，若其有牌，则其需弃置一张牌，否则你对其造成1点伤害。②第二轮游戏开始时，你可令本轮其他角色使用【桃】结算结束后，若其有牌，则其需交给你一张牌，否则你对其造成1点伤害。③非前两轮游戏开始时，你可以失去〖令法〗并获得〖治暗〗和〖奸雄〗。",
	mbzhian_info: "每轮限两次，每回合限一次。其他角色使用装备牌或延时锦囊牌后，你可选择：⒈弃置位于场上的此牌。⒉弃置一张手牌并获得位于场上的此牌。⒊对其造成1点伤害。",
	pot_huanjie: "势桓阶",
