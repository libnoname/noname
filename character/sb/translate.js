const translates = {
	...
	sbzhenliang: "贞良",
	sbzhenliang_info: "转换技。阴：出牌阶段限一次，你可以弃置X张与“任”颜色相同的牌并对攻击范围内的一名角色造成1点伤害（X为你与其体力值值差且X至少为1）。阳：你的回合外，一名角色使用或打出牌结算完成后，若此牌与“任”类别相同，则你可以令至多两名角色各摸两张牌。",
	sb_xiaoqiao: "谋小乔",
	...
	sbjiefan: "解烦",
	sbjiefan_info: "出牌阶段限一次，你可以令一名角色选择一项：⒈令所有攻击范围内含有其的角色依次弃置一张牌；⒉其摸等同于攻击范围内含有其的角色数的牌；⒊背水：依次执行上述所有选项，然后此技能失效直到你杀死一名角色。",
	sb_gongsunzan: "谋公孙瓒",
	...
	sb_jiaxu_prefix: "谋",
	sbwansha: "完杀",
	sbwansha_info: "①你的回合内，不处于濒死状态的其他角色不能使用【桃】。②每轮限一次，一名角色进入濒死状态时，你可以观看其手牌并选择其中零至两张牌（其他人不可见），然后其选择一项：1.你将这些牌分配给任意名不为其的角色；2.其弃置除这些牌以外的牌。",
	sbwansha_rewrite: "完杀·改",
	sbwansha_rewrite_info: "①你的回合内，不处于濒死状态的其他角色不能使用【桃】。②每轮限一次，一名角色进入濒死状态时，你可以观看其手牌并选择其区域内的零至两张牌（其他人不可见），然后其选择一项：1.你将这些牌分配给任意名不为其的角色；2.其弃置除这些牌以外的牌。",
	sbluanwu: "乱武",
	...
	sbweimu_rewrite_info: "锁定技。①当你成为黑色锦囊牌的目标时，取消之。②每轮开始时，若你上一轮成为其他角色使用牌的目标的次数不大于1，你从弃牌堆中随机获得一张黑色锦囊牌或防具牌。",
	sb_zhugejin: "谋诸葛瑾",
	...
	sb_guojia_prefix: "谋",
	sbtiandu: "天妒",
	sbtiandu_info: "转换技，出牌阶段开始时，阴：你可以弃置两张手牌，然后视为使用一张普通锦囊牌；阳：你进行判定并获得判定牌，然后若判定结果与你本局游戏因〖天妒〗弃置的牌花色相同，你受到1点无来源伤害。",
	sbyiji: "遗计",
	...
	sbdengfeng: "登锋",
	sbdengfeng_info: "准备阶段，你可以选择一名其他角色并选择一项：①令其获得其装备区的一张牌。②你获得牌堆中的一张【杀】。③背水：你失去1点体力。",
	sb_guohuai: "谋郭淮",
	sb_guohuai_prefix: "谋",
	sbjingce: "精策",
