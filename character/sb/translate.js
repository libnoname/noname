...
const translates = {
	...
	sb_sunquan: "谋孙权",
	sbzhiheng: "制衡",
	sbzhiheng_info: "出牌阶段限一次。你可以弃置任意张牌并摸等量的牌，你每以此法弃置了一个区域的所有牌，额外摸一张牌。",
	sbtongye: "统业",
	sbtongye_info: "锁定技，回合结束时，若你每个区域均有与你此区域牌数相同的其他角色，你从牌堆或弃牌堆中获得一张未以此法获得过的牌名的牌。",
	sbjiuyuan: "救援",
	...
	sbzhiji: "志继",
	sbzhiji_info: "觉醒技。准备阶段，若你的手牌数不大于体力值，你减少1点体力上限，回复1点体力并摸两张牌，获得〖北伐〗。",
	sbbeifa: "北伐",
	sbbeifa_info: "蓄力技（3/9）。①出牌阶段，你可以消耗任意点蓄力值，将一张手牌当做等字数且未被记录的仅能对其他角色使用的牌使用或打出，然后记录之。②你于回合内受到伤害或〖北伐〗记录牌名数达到X时，清除所有记录，然后若X大于1，蓄力值上限-1（X为此技能提供的蓄力值上限）。③你的回合内，有转化牌被使用或打出时或有牌被弃置时，你获得对应实体牌数点蓄力值。",
	sb_fazheng: "谋法正",
	sbxuanhuo: "眩惑",
	...
	sb_zhurong: "谋祝融",
	sblieren: "烈刃",
	sblieren_info: "当你使用【杀】指定唯一目标后，然后与其拼点。若你赢，此【杀】结算结束后，你可以对另一名其他角色造成1点伤害。",
	sbjuxiang: "巨象",
	...
	sbzhenliang: "贞良",
	sbzhenliang_info: "转换技。阳：出牌阶段限一次，你可以弃置X张与“任”颜色相同的牌并对攻击范围内的一名角色造成1点伤害（X为你与其体力值值差且X至少为1）。阴：你的回合外，一名角色使用或打出牌结算完成后，若此牌与“任”类别相同，则你可以令至多两名角色各摸两张牌。",
	sb_xiaoqiao: "谋小乔",
	sb_xiaoqiao_prefix: "谋",
	sbtianxiang: "天香",
	sbtianxiang_info_identity: "①出牌阶段限三次，你可以交给一名没有“天香”标记的其他角色一张红色手牌，然后令其获得此牌花色的“天香”标记。②当你受到伤害时，你可以移去一名角色的“天香”标记，若此“天香”标记为：红桃，你防止此伤害，其受到伤害来源对其造成的1点伤害（若没有伤害来源则改为无来源伤害）；方片，其交给你两张牌。③准备阶段，你移去场上所有的“天香”标记，然后摸等量的牌。",
	sbtianxiang_info: "①出牌阶段限三次，你可以交给一名没有“天香”标记的其他角色一张红色手牌，然后令其获得此牌花色的“天香”标记。②当你受到伤害时，你可以移去一名角色的“天香”标记，若此“天香”标记为：红桃，你防止此伤害，其受到伤害来源对其造成的1点伤害（若没有伤害来源则改为无来源伤害）；方片，其交给你两张牌。③准备阶段，你移去场上所有的“天香”标记，然后摸X张牌（X为移去的“天香”标记数+2）。",
	...
	sb_caopi_prefix: "谋",
	sbxingshang: "行殇",
	sbxingshang_info: "①当一名角色受到伤害后（每回合限一次）或死亡时，你获得2个“颂”标记（你至多拥有9个“颂”标记）。②出牌阶段限两次，你可以：1.移去2个“颂”标记，令一名角色复原武将牌；2.移去2个“颂”标记，令一名角色摸三张牌；3.移去3个“颂”标记，令一名体力上限小于10的角色回复1点体力，增加1点体力上限，随机恢复一个已废除的装备栏；4.移去4个“颂”标记，获得一名阵亡角色武将牌上的所有技能，然后你失去〖行殇〗〖放逐〗〖颂威〗。",
	sbfangzhu: "放逐",
	sbfangzhu_info: "出牌阶段限一次，你可以：1.移去2个“颂”标记，令一名其他角色于手牌中只能使用基本牌直到其回合结束；2.移去6个“颂”标记，令一名其他角色于手牌中只能使用锦囊牌直到其回合结束。3.移去8个“颂”标记，令一名其他角色于手牌中只能使用装备牌直到其回合结束；4.移去6个“颂”标记，令一名其他角色的非Charlotte技能失效直到其回合结束；5.移去4个“颂”标记，令一名其他角色不能响应除其以外的角色使用的牌直到其回合结束；6.移去8个“颂”标记，令一名其他角色将武将牌翻面；",
	sbfangzhu_info_doudizhu: "出牌阶段限一次，你可以：1.移去6个“颂”标记，令一名其他角色于手牌中只能使用锦囊牌直到其回合结束。2.移去4个“颂”标记，令一名其他角色不能响应除其以外的角色使用的牌直到其回合结束；3.移去8个“颂”标记，令一名其他角色将武将牌翻面；",
	sbsongwei: "颂威",
	...
	sbyicong: "义从",
	sbyicong_info: "蓄力技（2/4）。①每轮开始时，你可以消耗任意点蓄力值并选择一项：⒈你于本轮内至其他角色的距离-1，令系统选择牌堆中的X张【杀】；⒉其他角色于本轮内至你的距离+1，令系统选择牌堆中的X张【闪】（X为你消耗的蓄力值）。然后若你的“扈”数小于4，你将系统选择的牌置于武将牌上，称为“扈”。②你可以将“扈”如手牌般使用或打出。",
	sbqiaomeng: "趫猛",
	...
	sbmingzhe: "明哲",
	sbmingzhe_info: "锁定技，每轮限两次，你于回合外失去牌时，你选择一名角色：若其有蓄力技，其获得1点蓄力值；若你失去的牌中有非基本牌，其摸一张牌。",
	sb_guojia: "谋郭嘉",
	sb_guojia_prefix: "谋",
	sbtiandu: "天妒",
	...
	sb_lvbu_prefix: "谋",
	sbwushuang: "无双",
	sbwushuang_info: "锁定技。①你使用的【杀】需两张【闪】才能抵消；与你进行【决斗】的角色每次需要打出两张【杀】。②每回合限一次，当你使用【杀】或【决斗】造成伤害时，若受伤角色没有使用或打出过【杀】或【闪】响应此牌，则此伤害+1。",
	sbliyu: "利驭",
	sbliyu_info: "当你使用【杀】对一名其他角色造成伤害后，你可获得其区域内至多等同于伤害值张牌，然后其摸等量张牌。若你与其因此获得了全部类型的牌，其选择一项：①你视为对其指定的另一名其他角色使用一张【决斗】；②其获得〖无双〗直至其回合结束。",
};
