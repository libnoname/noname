...
const translates = {
	...
	twzhenglve_info: "每轮首个回合结束时，你可以摸两张牌，然后令一名没有“猎”标记的角色获得“猎”标记（若一号位本回合没有造成过伤害则改为至多两名）。你对有“猎”的角色使用牌无距离限制，你于出牌阶段使用的第一张牌对有“猎”的角色无任何次数限制。每回合限一次。当你对有“猎”标记的角色造成伤害后，你可以摸一张牌并获得造成伤害的牌。",
	tw_jsrg_hejin: "TW起何进",
