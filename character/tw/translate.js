...
const translates = {
	...
	tw_zhanghong: "张纮",
	twquanqian: "劝迁",
	twquanqian_info: `昂扬技。出牌阶段限一次，你可以将至多四张花色各不相同的手牌交给一名其他角色，然后若你交出的牌数大于1，则你从牌堆中获得一张装备牌，然后选择一项：①将手牌数摸至与其相同；②观看其手牌并获得其一种花色的所有牌。<br>${get.poptip("rule_jiang")}：你弃置六张手牌。`,
	twrouke: "柔克",
	...
	twfuxi: "赴曦",
	twfuxi_info: `${get.poptip("rule_chihengji")}。当你进入濒死状态时或装备栏均废除后，你可选择依次执行一至两项:1.当前回合结束时，你执行一个额外的回合；2. 保留〖炽灰〗直到下次退幻；3.将手牌数摸至体力上限（至多摸至五张）；4.若你的装备栏均废除，恢复所有装备栏。然后你入幻：将体力值回复至体力上限。`,
	twhuangzhu: "煌烛",
