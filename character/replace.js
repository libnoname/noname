window.noname_character_replace = {
	...
	baosanniang: ["baosanniang", "xin_baosanniang", "re_baosanniang", "ddd_baosanniang", "std_baosanniang"],
	...
	caiwenji: ["caiwenji", "sp_caiwenji", "ol_caiwenji", "re_caiwenji", "yue_caiwenji", "diy_caiwenji"],
	...
	caocao: ["caocao", "re_caocao", "sp_ol_caocao", "ol_jsrg_caocao", "dc_caocao", "sb_caocao", "tw_caocao", "jsrg_caocao", "jd_sb_caocao", "yj_caocao", "ns_caocao", "ns_caocaosp", "jy_caocao"],
	caochong: ["caochong", "ol_caochong", "re_caochong", "huan_caochong", "old_caochong"],
	...
	caopi: ["caopi", "v_caopi", "re_caopi", "sb_caopi", "tw_sb_caopi", "huan_caopi", "ps_caopi"],
	...
	caoshuang: ["caoshuang", "dc_caoshuang", "ns_caoshuang", "ddd_caoshuang"],
	...
	fuhuanghou: ["fuhuanghou", "ol_fuhuanghou", "re_fuhuanghou", "xin_fuhuanghou", "tw_fuhuanghou", "std_fuhuanghou", "sp_fuhuanghou", "old_fuhuanghou"],
	...
	guanning: ["guanning", "ddd_guanning"],
	...
	handang: ["handang", "xin_handang", "re_handang", "sb_handang", "tw_handang", "ddd_handang", "old_handang"],
	hanfu: ["hanfu", "ol_hanfu"],
	hanhaoshihuan: ["hanhaoshihuan", "re_hanhaoshihuan"],
	hanlong: ["hanlong", "jd_hanlong", "diy_hanlong"],
	...
	liubei: ["liubei", "re_liubei", "sp_ol_liubei", "dc_liubei", "sb_liubei", "xia_liubei", "jsrg_liubei", "jd_sb_liubei", "ty_liubei", "sp_liubei", "jsp_liubei", "junk_liubei"],
	...
	liuxie: ["liuxie", "dc_sb_liuxie", "sp_liuxie", "std_liuxie", "hs_liuxie"],
	liuyan: ["liuyan", "jsrg_liuyan", "junk_liuyan", "diy_liuyan"],
	liuye: ["dc_liuye", "liuye", "std_liuye", "ddd_liuye"],
	liuyong: ["liuyong", "jsrg_liuyong"],
	liuyu: ["liuyu", "ol_liuyu", "dc_liuyu"],
	liuzan: ["re_liuzan", "liuzan", "std_liuzan", "diy_liuzan"],
	...
	luoxian: ["luoxian", "ddd_luoxian"],
	luxun: ["luxun", "re_luxun", "wu_luxun", "sb_luxun", "jsrg_luxun", "huan_luxun", "ty_luxun", "diy_luxun", "drag_luxun"],
	luyusheng: ["ol_luyusheng", "luyusheng", "mb_luyusheng", "ns_luyusheng"],
	lvbu: ["lvbu", "re_lvbu", "ol_jsrg_lvbu", "v_lvbu", "sb_lvbu", "jsrg_lvbu", "ps_lvbu"],
	...
	sunliang: ["sunliang", "xin_sunliang", "ddd_sunliang"],
	sunluban: ["re_sunluban", "xin_sunluban", "tw_sunluban", "std_sunluban", "sunluban"],
	sunluyu: ["sunluyu", "re_sunluyu", "mb_sunluyu", "std_sunluyu"],
	sunquan: ["sunquan", "re_sunquan", "v_sunquan", "dc_sunquan", "xin_sunquan", "sb_sunquan", "jd_sb_sunquan", "ty_sunquan"],
	...
	tianyu: ["tianyu", "tw_tianyu", "diy_tianyu"],
	...
	wangyun: ["wangyun", "clan_wangyun", "dc_wangyun", "re_wangyun", "jsrg_wangyun", "std_wangyun", "pe_wangyun", "ns_wangyun", "old_wangyun"],
	weiwenzhugezhi: ["weiwenzhugezhi", "re_weiwenzhugezhi", "jsrg_weiwenzhugezhi"],
	weiyan: ["re_weiyan", "ol_weiyan", "weiyan", "yj_weiyan", "huan_weiyan"],
	...
	xiahouxuan: ["xiahouxuan", "ddd_xiahouxuan"],
	xiahouyuan: ["re_xiahouyuan", "ol_xiahouyuan", "sb_xiahouyuan", "xiahouyuan"],
	xianglang: ["xianglang", "mb_xianglang", "ddd_xianglang"],
	xiaoqiao: ["xiaoqiao", "ol_xiaoqiao", "yue_xiaoqiao", "re_xiaoqiao", "sb_xiaoqiao", "jd_sb_xiaoqiao", "old_xiaoqiao"],
	xinpi: ["xinpi", "sp_xinpi"],
	xinxianying: ["xinxianying", "re_xinxianying", "ol_xinxianying", "sp_xinxianying", "ns_xinxianying", "ddd_xinxianying"],
	xuangongzhu: ["xuangongzhu", "yj_xuangongzhu"],
	xuelingyun: ["ol_xuelingyun", "xuelingyun", "ddd_xuelingyun"],
	xuezong: ["xuezong", "mb_xuezong", "tw_xuezong", "std_xuezong"],
	xugong: ["xugong", "re_xugong", "jsrg_xugong"],
	xuhuang: ["re_xuhuang", "ol_xuhuang", "sb_xuhuang", "yj_xuhuang", "jd_sb_xuhuang", "xuhuang"],
	xujing: ["xujing", "dc_xujing", "sp_xujing", "tw_xujing", "ddd_xujing"],
	xunchen: ["xunchen", "clan_xunchen", "re_xunchen", "sp_xunchen", "tw_xunchen"],
	xunyou: ["xunyou", "clan_xunyou", "re_xunyou"],
	xunyu: ["xunyu", "ol_xunyu", "dc_sb_xunyu", "star_xunyu", "re_xunyu", "sb_xunyu"],
	...
	yangyi: ["ol_yangyi", "yangyi", "tw_yangyi", "diy_yangyi", "ns_yangyi"],
	...
	zhangkai: ["zhangkai", "ddd_zhangkai"],
	...
	zhouchu: ["jin_zhouchu", "zhouchu", "tw_zhouchu", "std_zhouchu", "ddd_zhouchu"],
	zhoufei: ["zhoufei", "yue_zhoufei"],
	zhouqun: ["ol_zhouqun", "zhouqun"],
	zhoutai: ["zhoutai", "xin_zhoutai", "old_zhoutai"],
	zhouyu: ["zhouyu", "re_zhouyu", "dc_sb_zhouyu", "yue_zhouyu", "sb_zhouyu", "jx_zhouyu", "ps1062_zhouyu", "ps2080_zhouyu", "diy_zhouyu", "jy_zhouyu"],
	...
	zhugeliang: ["zhugeliang", "re_zhugeliang", "wu_zhugeliang", "friend_zhugeliang", "huan_zhugeliang", "jsrg_zhugeliang", "ps_zhugeliang", "ps2066_zhugeliang", "prp_zhugeliang", "ns_zhugeliang", "jy_zhugeliang"],
	...
	re_lusu: ["re_lusu", "ol_lusu", "dc_sb_lusu", "xia_lusu", "jy_lusu"],
	re_yuanshao: ["re_yuanshao", "ol_yuanshao", "ol_sb_yuanshao", "star_yuanshao", "xin_yuanshao", "sb_yuanshao", "jsrg_yuanshao", "jd_sb_yuanshao", "yy_yuanshao"],
	...
	tw_jianshuo: ["tw_jianshuo", "ddd_jianshuo"],
