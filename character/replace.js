window.noname_character_replace = {
	...
	shen_caocao: ["shen_caocao", "old_caocao", "ca_shen_caocao", "mb_shen_caocao", "ps_shen_caocao"],
	shen_guanyu: ["shen_guanyu", "dc_shen_guanyu", "tw_shen_guanyu", "ty_shen_guanyu", "hl_shen_guanyu"],
	...
	shen_lvbu: ["shen_lvbu", "hl_shen_lvbu", "mb_shen_lvbu"],
	shen_lvmeng: ["shen_lvmeng", "tw_shen_lvmeng", "hl_shen_lvmeng"],
	shen_machao: ["shen_machao", "ps_shen_machao", "wn_shen_machao", "mark_shen_machao", "sm_shen_machao", "sp_sm_shen_machao", "mb_shen_machao", "lx_mb_shen_machao"],
	shen_simayi: ["shen_simayi", "xin_simayi", "new_simayi"],
	shen_sunquan: ["shen_sunquan", "junk_sunquan", "dc_shen_sunquan", "sm_shenmo_sunquan"],
	...
	caiwenji: ["caiwenji", "sp_caiwenji", "ol_caiwenji", "re_caiwenji", "yue_caiwenji", "ylyg_caiwenji"],
	...
	caocao: ["caocao", "re_caocao", "sp_ol_caocao", "dm_caocao", "ol_jsrg_caocao", "dc_caocao", "v_caocao", "sb_caocao", "mb_caocao", "tw_jsrg_caocao", "tw_sxrm_caocao", "jsrg_caocao", "jd_sb_caocao", "yj_caocao", "ns_caocao", "ns_caocaosp", "jy_caocao", "ps_caocao", "sxrm_caocao", "sxrm_chen_caocao", "wn_caocao", "pe_jun_caocao", "xy_caocao", "wxdl_caocao"],
	caochong: ["caochong", "ol_caochong", "re_caochong", "huan_caochong", "old_caochong", "strong_caochong", "boxue_caochong"],
	...
	caomao: ["caomao", "mb_caomao", "lx_caomao"],
	caopi: ["caopi", "ol_le_caopi", "v_caopi", "re_caopi", "sb_caopi", "tw_sb_caopi", "huan_caopi", "ps_caopi", "sxrm_caopi", "pe_jun_caopi", "xia_caopi", "wxdl_caopi"],
	caoren: ["caoren", "old_caoren", "sp_caoren", "star_caoren", "sb_caoren", "jsp_caoren", "drag_caoren", "new_caoren", "jy_caoren", "sxrm_caoren"],
	caorui: ["caorui", "re_caorui", "std_caorui", "yy_caorui", "old_caorui"],
	caoshuang: ["caoshuang", "dc_caoshuang", "pot_caoshuang", "ns_caoshuang"],
	...
	caozhen: ["caozhen", "re_caozhen", "xin_caozhen", "pot_caozhen", "old_caozhen", "std_caozhen"],
	caozhi: ["caozhi", "ol_caozhi", "dc_caozhi", "yue_caozhi", "re_caozhi", "mb_caozhi", "huan_caozhi", "ps_caozhi", "wxdl_caozhi"],
	...
	chenqun: ["chenqun", "clan_chenqun", "dc_chenqun", "re_chenqun", "pot_chenqun", "old_chenqun"],
	...
	daqiao: ["daqiao", "re_daqiao", "yue_daqiao", "sb_daqiao", "huan_daqiao", "jd_sb_daqiao", "sp_daqiao"],
	daxiaoqiao: ["daxiaoqiao", "dc_daxiaoqiao", "tw_daxiaoqiao"],
	dengai: ["dengai", "ol_dengai", "ol_sb_dengai", "re_dengai", "jsrg_dengai", "ren_dengai", "dc_sb_dengai", "bigsb_dengai", "pot_dengai", "old_pot_dengai"],
	...
	dingshangwan: ["dingshangwan", "ol_dingshangwan", "mb_dingshangwan", "huan_dingshangwan"],
	...
	duanwei: ["duanwei", "ol_duanwei", "junk_duanwei"],
	...
	guanqiujian: ["guanqiujian", "re_guanqiujian", "mb_sp_guanqiujian", "tw_guanqiujian", "old_guanqiujian", "lx_guanqiujian"],
	guansuo: ["guansuo", "dc_guansuo", "std_guansuo", "drag_guansuo"],
	guanyinping: ["guanyinping", "v_guanyinping", "mb_guanyinping", "old_guanyinping", "ty_guanyinping", "drag_guanyinping", "sxrm_guanyinping", "ym_guanyinping"],
	...
	huatuo: ["huatuo", "re_huatuo", "old_huatuo", "tw_sxrm_huatuo", "sxrm_huatuo"],
	...
	jiachong: ["jin_jiachong", "dc_jiachong", "mb_jiachong", "jiachong", "lx_jiachong"],
	...
	liubei: ["liubei", "re_liubei", "sp_ol_liubei", "dc_liubei", "v_liubei", "sb_liubei", "xia_liubei", "tw_jsrg_liubei", "tw_sxrm_liubei", "jd_sb_liubei", "ty_liubei", "sp_liubei", "jsrg_liubei", "jsp_liubei", "junk_liubei", "ps_liubei", "sxrm_liubei", "pe_jun_liubei"],
	...
	liufeng: ["liufeng", "ol_liufeng", "re_liufeng", "huan_liufeng", "sxrm_liufeng"],
	liuhong: ["liuhong", "ol_jsrg_liuhong", "tw_liuhong", "jsrg_liuhong", "pe_jun_liuhong"],
	liuhui: ["liuhui", "mb_liuhui", "pe_liuhui"],
	liupi: ["ol_liupi", "liupi"],
	liushan: ["liushan", "ol_liushan", "re_liushan", "huan_liushan", "pe_jun_liushan", "ol_le_liushan", "xiangxue_liushan"],
	...
	luxun: ["luxun", "re_luxun", "wu_luxun", "dc_sb_luxun", "sb_luxun", "jsrg_luxun", "huan_luxun", "ty_luxun", "drag_luxun", "sxrm_luxun"],
	...
	lvmeng: ["lvmeng", "re_lvmeng", "sb_lvmeng", "sp_lvmeng", "ns_lvmeng", "she_lvmeng", "sxrm_lvmeng", "dc_sb_lvmeng", "haoxue_lvmeng"],
	...
	simafu: ["yj_simafu", "mb_simafu", "simafu", "lx_simafu"],
	...
	simazhao: ["jin_simazhao", "mb_simazhao", "simazhao", "sp_simazhao", "jsrg_simazhao", "jin_jsrg_simazhao", "jd_jin_simazhao", "ns_simazhao", "std_simazhao", "lx_simazhao"],
	simazhou: ["simazhou", "mb_simazhou", "lx_simazhou"],
	sunce: ["sunce", "re_sunce", "sp_sunce", "dc_sunce", "re_sunben", "sb_sunce", "jsrg_sunce", "pe_jun_sunce", "v_sunce", "huan_sunce", "ylyg_sunce"],
	...
	sunshangxiang: ["sunshangxiang", "re_sunshangxiang", "sp_sunshangxiang", "star_sunshangxiang", "v_sunshangxiang", "sb_sunshangxiang", "jsrg_sunshangxiang", "jd_sb_sunshangxiang", "sxrm_sunshangxiang"],
	...
	xiahouba: ["xiahouba", "dc_xiahouba", "star_xiahouba", "pot_xiahouba", "tw_xiahouba", "std_xiahouba"],
	xiahoudun: ["xiahoudun", "re_xiahoudun", "xin_xiahoudun", "sb_xiahoudun", "tw_sb_xiahoudun", "xia_xiahoudun", "sp_xiahoudun"],
	...
	xiaoqiao: ["xiaoqiao", "ol_xiaoqiao", "ol_sb_xiaoqiao", "yue_xiaoqiao", "re_xiaoqiao", "sb_xiaoqiao", "jd_sb_xiaoqiao", "old_xiaoqiao", "ylyg_xiaoqiao", "pot_xiaoqiao", "huan_xiaoqiao"],
	...
	yangfeng: ["ol_yangfeng", "yangfeng", "dc_sb_yangfeng"],
	...
	zhangfei: ["zhangfei", "re_zhangfei", "ol_sb_zhangfei", "dm_zhangfei", "wu_zhangfei", "xin_zhangfei", "sb_zhangfei", "tw_zhangfei", "old_zhangfei", "jsrg_zhangfei", "jd_sb_zhangfei", "sp_zhangfei", "yj_zhangfei"],
	...
	zhouyu: ["zhouyu", "re_zhouyu", "dc_sb_zhouyu", "yue_zhouyu", "sb_zhouyu", "pot_zhouyu", "mb_zhouyu", "jx_zhouyu", "ps1062_zhouyu", "ps2080_zhouyu", "jy_zhouyu", "tw_dm_zhouyu", "sxrm_zhouyu"],
	...
	zhugejin: ["zhugejin", "dc_sb_zhugejin", "sb_zhugejin", "star_zhugejin"],
	zhugeliang: ["zhugeliang", "re_zhugeliang", "ol_sb_zhugeliang", "dc_sb_zhugeliang", "wu_zhugeliang", "friend_zhugeliang", "huan_zhugeliang", "jsrg_zhugeliang", "ps_zhugeliang", "ps2066_zhugeliang", "prp_zhugeliang", "ns_zhugeliang", "jy_zhugeliang", "zj_zhugeliang", "ol_le_zhugeliang", "you_zhugeliang", "ym_friend_zhugeliang", "natu_zhugeliang", "sxrm_zhugeliang"],
	zhugezhan: ["zhugezhan", "old_zhugezhan", "zj_zhugezhan", "clan_zhugezhan"],
	...
	dc_zhangren: ["dc_zhangren", "dc_sb_zhangren", "pot_zhangren", "jsrg_zhangren", "zhangren"],
	...
	ol_wenqin: ["ol_wenqin", "mb_wenqin", "pe_wenqin", "lx_wenqin"],
	re_lidian: ["re_lidian", "old_re_lidian", "junk_lidian", "hefei_lidian"],
	re_lusu: ["re_lusu", "ol_lusu", "ol_sb_lusu", "dc_sb_lusu", "pot_lusu", "xia_lusu", "jy_lusu", "zc26_lusu", "sxrm_lusu"],
	...
	tw_xiahouen: ["ol_xiahouen", "dc_xiahouen", "tw_xiahouen", "jsrg_xiahouen"],
	...
	tw_zhangzhao: ["star_zhangzhao", "tw_zhangzhao", "jy_zhangzhao", "sxrm_zhangzhao"],
	xf_huangquan: ["xf_huangquan", "dc_huangquan", "dc_sb_huangquan"],
	yj_jushou: ["yj_jushou", "ol_sb_jushou", "re_jushou", "dc_sb_jushou", "xin_jushou", "std_jushou", "tw_jushou"],
	yj_sufei: ["xf_sufei", "yj_sufei", "sp_sufei"],
	yl_luzhi: ["yl_luzhi", "ol_sb_yl_luzhi", "sb_yl_luzhi", "tw_yl_luzhi", "jsrg_yl_luzhi", "tw_sb_yl_luzhi"],
