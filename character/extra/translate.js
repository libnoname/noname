...
const translates = {
	...
	shen_xunyu_prefix: "神",
	tianzuo: "天佐",
	tianzuo_info: "锁定技。①游戏开始时，你将八张【奇正相生】加入牌堆。②【奇正相生】对你无效。",
	lingce: "灵策",
	...
	qiexie: "挈挟",
	qiexie_info: "锁定技。准备阶段，你在剩余武将牌堆中随机观看五张牌，选择其中的任意张，将其按照如下规则转化为武器牌置入你的武器栏：{⒈此牌不具有花色和点数，且其攻击范围等于此武将牌的体力上限。⒉此武器牌的技能为该武将牌上所有描述中包含“【杀】”且不具有锁定技以外的标签的技能。⒊此武器牌离开你的装备区时，改为放回武将牌堆。}",
	cuijue: "摧决",
	...
	wuling: "五灵",
	wuling_info: `①出牌阶段限两次。你可以选择一名没有“${get.poptip("wuling_wuqinxi")}”的角色，按照你选择的顺序向其传授“${get.poptip("wuling_wuqinxi")}”，且其获得如下效果：其获得你选择的第一种“${get.poptip("wuling_wuqinxi")}”的效果，并在其每个准备阶段移除当前“${get.poptip("wuling_wuqinxi")}”的效果并切换为下一种。②当你死亡时，你令场上的角色失去你传授的“${get.poptip("wuling_wuqinxi")}”。`,
	wuling_wuqinxi: "五禽戏",
	wuling_wuqinxi_info: "<li>“五禽戏”分为“虎、鹿、熊、猿、鹤”五个不同的效果：" + "<br><li>虎：当你使用指定唯一目标的牌对目标角色造成伤害时，此伤害+1。" + "<br><li>鹿：①当你获得此效果时，你回复1点体力并弃置判定区的所有牌。②你不能成为延时锦囊牌的目标。" + "<br><li>熊：每回合限一次，当你受到伤害时，此伤害-1。" + "<br><li>猿：当你获得此效果时，你选择一名其他角色，获得其装备区里的一张牌。" + "<br><li>鹤：当你获得此效果时，你摸三张牌。",
	youyi: "游医",
	...
	new_dclieqiong: "裂穹",
	new_dclieqiong_info: "当你对一名其他角色造成伤害后，你可以在任意部位中选择一个“击伤”；若你击伤了一名角色，则本回合再次击伤该角色时出现“天冲”选项。",
	...
	mark_shouli_jun: "骏",
	mark_shouli_jun_info: "①若你持有的“骏”数量大于：0，你计算与其他角色的距离-1；1，摸牌阶段你额外摸一张牌；2，你使用【杀】指定目标时，令其本回合非锁定技失效。②当你受到属性伤害或【南蛮入侵】、【万箭齐发】造成的伤害时，你将所有“骏”移动至你上家。",
	mark_shouli_li: "骊",
	mark_shouli_li_info: "①若你持有的“骊”数量大于：0，其他角色计算与你的距离+1；1，摸牌阶段你额外摸一张牌；2，你造成或受到的伤害视为雷电伤害；3，你造成或受到的伤害+1。②当你受到属性伤害或【南蛮入侵】、【万箭齐发】造成的伤害时，你将所有“骊”移动至你下家。",
	mark_hengwu: "横骛",
