const translates = {
	...
	caocaoyuanshao: "曹操袁绍",
	peguibei: "贵卑",
	peguibei_info: "锁定技，游戏开始时，你摸四张牌，然后与一号位的上家交换位置。",
	pejiechu: "劫出",
	pejiechu_info: "转换技，阳：出牌阶段，你可以视为使用一张【顺手牵羊】，此牌结算完成后目标角色可以对你使用一张【杀】；阴：你成为【杀】的目标时，可以弃置一张手牌改变此【杀】的花色和属性。",
	pedaojue: "道抉",
	pedaojue_info: "使命技，①你首次受到一种花色的牌造成的伤害时，防止此伤害并选择一项：1.获得造成伤害的牌；2.使用一张指定其他所有角色的【杀】。②成功：你因〖道抉〗获得至少三张牌后，失去〖劫出〗并变更势力为魏，获得〖清正〗〖治暗〗和〖护驾〗。③失败：你因〖道抉〗使用的第三张【杀】结算完成后，失去〖劫出〗并变更势力为群，获得〖神离〗〖诛逆〗和〖士首〗。",
	peqingzheng: "清正",
	peqingzheng_info: "出牌阶段开始时，你可以展示所有手牌并弃置其中一种花色的所有牌，然后展示一名其他角色的所有手牌并弃置其中一种花色的所有牌。若其被弃置的牌数小于你以此法弃置的牌数，你对其造成1点伤害。",
	pezhian: "治暗",
	pezhian_info: "每回合限X次。一名角色使用非基本牌后，你可选择：1.弃置一张手牌并获得场上或弃牌堆中的此牌；2.回复1点体力，此技能本轮失效；3.对其造成X点伤害，然后你获得〖飞影〗并删去此项（X为你已损失体力值且至少为1）。",
	pezhuni: "诛逆",
	pezhuni_info: "出牌阶段限一次，你可以令所有角色同时选择一名除你之外的其他角色。若有角色本回合内被指定过的次数唯一最多，则你本回合内对该角色使用牌没有次数和距离限制，然后摸其被指定次数张牌。",
	petuonan: "脱难",
	petuonan_info: "限定技，你进入濒死时，可以回复1点体力，然后失去一个带标签的技能。",
	drag_huaci: "龙华雌",
	drag_huaci_prefix: "龙",
	dragshiyao: "试药",
	dragshiyao_info: "每名角色的出牌阶段限一次，其可以摸一张牌并令你获得一张【毒】，然后进行判定。若结果为：红色，你减少1点体力上限并令其获得一张【毒】；黑色，其可以将一张红色牌当【桃】使用。",
	dragzuoyu: "佐愈",
	...
	dragzhawang: "诈亡",
	dragzhawang_info: "回合开始时，你可选择一项：1.本回合获得〖诈降〗；2.失去1点体力，将本回合准备阶段和结束阶段改为摸牌阶段；3.背水，减少1点体力上限。",
	dragxigui: "西归",
	...
	dragpanfeng: "叛封",
	dragpanfeng_info: "你使用【杀】或失去最后的手牌时，可以变更势力并将手牌补至体力上限，然后对一名与你势力相同的角色造成一点伤害。",
	drag_luxun: "龙陆逊",
	drag_luxun_prefix: "龙",
	dragqianxun: "谦逊",
	...
	shefujing_fu: "伏",
	shefujing_fu_info: "你每回合首次造成/受到伤害后，令你获得此标记的角色可以：1.摸一张牌；2.获得1点护甲；3.背水，失去1点体力并对你发动一次〖攻心〗。",
	shefujiang: "浮江",
	...
	hm_sanshou: "三首",
	hm_sanshou_info: "锁定技，你的准备阶段和结束阶段改为出牌阶段，并在此阶段将武将牌改为张宝或张梁。此阶段结束后把武将牌替换回张角。",
	hm_jijun: "集军",
	...
	hm_zhouyuan: "咒怨",
	hm_zhouyuan_info: "出牌阶段限一次，你可以选择你和一名其他角色所有手牌，然后其将所有黑色/红色扣置于其武将牌上，你将所有红色/黑色手牌置于武将牌上，这些牌称为“咒兵”，出牌阶段结束时，你与其收回“咒兵”。",
	hm_zhaobing: "诏兵",
	...
	hm_zongfu: "众附",
	hm_zongfu_info: "每轮开始时，你可以声明一种花色，然后令手牌最少的角色依次选择一项：1.将一张牌置于牌堆顶；2.从牌堆底摸一张牌，当以此法失去牌的角色造成伤害，你发动一次〖覆道〗。",
	hm_dangjing: "荡京",
	hm_dangjing_info: "当你发动〖众附〗后，若你伤害/回复值为全场最高，你可以令一名角色进行一次判定，若结果为你〖众附〗声明的花色，你对其造成1点雷电伤害并重复此流程。",
	hm_didao: "地道",
	hm_didao_info: "锁定技，出牌阶段开始时，若你已受伤，你可以将所有手牌当一张无距离限制的伤害为X的【杀】使用(X为此【杀】的实体牌数）。",
	hm_xianxiang: "献降",
	hm_xianxiang_info: "锁定技，当你杀死一名角色时，你令另一名其他角色获得死亡角色区域内的所有牌。",
	hm_juedian: "决巅",
	hm_juedian_info: "锁定技。当你每回合首次使用目标唯一的牌造成伤害后，你选择一项并视为对受伤角色使用一张【决斗】：①失去1点体力。②减1点体力上限。③背水：你令此牌的伤害值基数+1。",
	hm_nitian: "逆天",
	...
	hm_shice: "势策",
	hm_shice_info: "转换技，阴：当你受到属性伤害时，若你的技能数不大于伤害来源，你可以防止此伤害并视为使用一张【火攻】；阳：当你不因此技能使用牌指定唯一目标后，你可以令其弃置装备区任意张牌，然后此牌额外结算X次（X为其装备区的牌数）。",
	hm_podai: "破怠",
	...
	ty_luxun_prefix: "桃",
	tyqianshou: "谦守",
	tyqianshou_info: "转换技，其他角色的回合开始时，若其体力值大于你，或其未处于横置状态，阴：你可展示并交给其一张红色牌，本回合你不能使用手牌且你与其不能成为牌的目标；阳：你可令其展示并交给你一张牌，若此牌不为黑色，你失去1点体力。",
	tytanlong: "探龙",
	...
	yy_simayi_prefix: "燕幽",
	yyyanggu: "佯固",
	yyyanggu_info: "转换技。阴：当你受到伤害后，你可以回复1点体力；阳：你可以将一张手牌当作【声东击西】使用。",
	yyzuifu: "罪缚",
	...
	zombiechuce: "出策",
	zombiechuce_info: "①你可以将一张锦囊牌当作任意基本牌或普通锦囊牌使用。②每回合限一次，其他角色使用锦囊牌时，你可以摸三张牌，令此牌无效，然后你可以视为使用此牌。",
	zombielongmu: "笼墓",
	zombielongmu_info: "锁定技。①你的回合内，其他角色不能回复体力。②当你成为锦囊牌的目标时，取消之。③一名角色死亡时，若你本局游戏对其发动过技能且其武将牌不为“丧尸”，则你取消之，然后使用“丧尸”替换其武将牌。",
	zombie_zombie: "丧尸",
	zombieshibian: "尸变",
	...
	chunqiubi: "春秋笔",
	chunqiubi_skill: "春秋笔",
	chunqiubi_info: "出牌阶段限一次，你可以随机选择一项，然后选择一名其他角色从此项开始正序或逆序依次执行所有项。起：失去1点体力。承：摸已损失体力值张牌。转：回复1点体力。合：弃置已损失体力值张手牌（不足则全弃）。此牌离开你的装备区后销毁。",
	hs_liuxuan: "青史刘璿",
	hs_liuxuan_prefix: "青史",
	hssifen: "俟奋",
	hssifen_info: "出牌阶段限一次，你可令一名其他角色将任意张手牌当作一张【决斗】使用，然后你摸两张牌且此阶段内：你可以无次数限制的将等量张红色牌当作一张【决斗】对其使用。",
	hsfunan: "赴难",
	hsfunan_info: "主公技，每回合限一次，你可以发动一次〖激将〗，若没有角色响应，你失去一点体力并摸两张牌。",
	hs_caohuan: "青史曹奂",
