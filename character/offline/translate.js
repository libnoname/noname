...
const translates = {
	...
	xy_caocao: "徐曹操",
	xy_zuju: "族聚",
	xy_zuju_info: "锁定技，你的摸牌阶段摸牌数，攻击范围，每回合使用【杀】的次数改为x(x为场上魏势力角色数且至多为3)。",
	xy_mintong: "悯恸",
	xy_mintong_info: "每回合限一次，当一名角色对另一名魏势力角色使用仅指定一名角色的伤害牌结算结束后，你可视为对其使用一张【杀】。",
	xy_chengyu_prefix: "徐",
	xy_chengyu: "徐程昱",
	xy_liaofu: "燎伏",
	xy_liaofu_info: "每回合限一次，你可以将一张未以此法放置过的属性【杀】置于武将牌上，其他角色在其回合外使用【杀】时，你可以移去一张与此【杀】属性相同的【杀】并对其造成1点对应属性的伤害。",
	xy_jinshou: "烬守",
	xy_jinshou_info: "回合结束阶段，若你本回合体力值未发生过变化，你可以弃置所有手牌并失去1点体力，若如此做，直到你的下个回合，其他角色不能对你使用仅指定一名角色的伤害牌。",
	xy_xunyu_prefix: "徐",
	xy_xunyu: "徐荀彧",
	xy_jianzu: "谏族",
	xy_jianzu_info: "出牌阶段限一次，你可以与一名角色拼点，赢的角色对其攻击范围内的一名角色造成1点伤害。",
	xy_dishou: "砥守",
	xy_dishou_info: "当你受到伤害时，若伤害来源手牌数和体力值不等，伤害来源选择一项：1.弃置所有手牌；2.失去一点体力，然后重复此过程直到手牌数等于体力值或进入濒死状态。",
	xy_chengong_prefix: "徐",
	xy_chengong: "徐陈宫",
	xy_jizheng: "积诤",
	xy_jizheng_info: "每回合一次，当你摸牌时，你可以改为令一名角色视为使用一张无视距离的【杀】。",
	xy_zhangkai_prefix: "徐",
	xy_zhangkai: "徐张闿",
	xy_luejin: "掠金",
