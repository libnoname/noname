const translates = {
	hanbingjianshaonu: "寒冰剑少女",
	yj_bingling: "冰伶",
	yj_bingling_info: "当你使用杀指定目标时，你可弃置目标角色2张牌。若这两张牌类别/花色/牌名字数/点数相同，则你获得这两张牌/回复一点体力/摸相当于其中一张牌名字数的牌/令其失去所有体力；若皆不同，则你受到一点无来源的火焰伤害。",
	tengjianahai: "藤甲男孩",
	yj_renjia: "韧甲",
	yj_renjia_info: "锁定技，你没有防具区；你每轮前两次受到的非属性伤害-1，受到的火焰伤害+1，且你造成或受到属性伤害后摸一张牌。",
	yj_yanyu: "焰狱",
	yj_yanyu_info: "限定技，出牌阶段，你可以展示两张手牌然后选择一名其他角色，将牌堆中的一张【藤甲】置入该色的防具区内（顶替原装备），若如此做你与其他角色手牌中与这两张牌花色相同的基本牌视为[火杀】、锦囊牌视为【火攻】、装备牌视为【铁索连环】，且这些牌被使用后你摸一张牌。",
	yj_zhanghe: "☆张郃",
	yj_zhanghe_prefix: "☆",
	yj_zhangliao: "☆张辽",
	yj_zhangliao_prefix: "☆",
