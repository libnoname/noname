const translates = {
	...
	dcyongbi: "拥嬖",
	dcyongbi_info: "限定技。出牌阶段，你可以将所有手牌交给一名其他男性角色。你将〖媵予〗的发动时机改为“准备阶段和结束阶段开始时”。然后若这些牌中包含的花色数：大于1，则你与其本局游戏的手牌上限+2；大于2，则当你或其于本局游戏内受到大于1的伤害时，此伤害-2。",
	dc_huangquan: "黄权",
	dcquanjian: "劝谏",
	...
	yue_miheng_prefix: "乐",
	dcjigu: "激鼓",
	dcjigu_info: "锁定技。①游戏开始时，你将手牌标记为“激鼓”。②你的“激鼓”牌不计入手牌上限。③当你造成或受到伤害后，若你的“激鼓”牌数等于你的装备区牌数，你可以摸X张牌（X为你的空缺装备栏数）。然后若你本轮〖激鼓〗发动次数不小于已进行过回合的角色数，此效果本轮失效。",
	dcsirui: "思锐",
	...
	dcremanhou: "蛮后",
	dcremanhou_info: "出牌阶段限一次，你可以摸至多四张牌并根据摸牌数依次执行以下等量项：①失去〖探乱〗；②弃置一张手牌；③失去1点体力，弃置场上的一张牌；④弃置一张牌，获得〖探乱〗。",
	dcretanluan: "探乱",
	dcretanluan_info: "出牌阶段限一次，你可以使用本回合弃牌堆中因弃置进入弃牌堆的一张牌，若你因此使用的牌对其他角色造成了伤害，则你重置〖蛮后〗。",
	dcmanhou: "蛮后",
	...
	jimiaojimu: "吉邈吉穆",
	dczouyi: "诹议",
	dczouyi_info: "出牌阶段限一次，你可执行至多两项：1.你摸两张牌并可弃置一名其他角色一张牌；2.你弃置一张牌并可令一名其他角色摸两张牌。结算后〖掩袭〗使用次数增加手牌数与你相同的角色数。",
	dcyanxi: "掩袭",
	dcyanxi_info: "每局游戏限零次，其他角色回合结束时，你可视为对其使用一张【杀】，结算后若此技能可使用次数不为0，再次发动直至此技能无使用次数或其阵亡。",
};
