...
export default {
	...
	heyi: "鹤翼",
	heyi_info: `${get.poptip("guozhan_zhenfa")}。与你处于同一${get.poptip("guozhan_duilie")}的角色视为拥有技能〖飞影〗。`,
	...
	tianfu: "天覆",
	tianfu_info: `主将技，${get.poptip("guozhan_zhenfa")}，若当前回合角色与你处于同一${get.poptip("guozhan_duilie")}，则你视为拥有技能〖看破〗。`,
