...
export default {
	...
	gzzhenxi: "震袭",
	gzzhenxi_info: `当你使用【杀】指定目标后，你可以选择一项：1.弃置目标角色一张牌；2.将一张♦非锦囊牌当做【乐不思蜀】或♣非锦囊牌当做【兵粮寸断】对目标角色使用；3.${get.poptip("beishui")}：若其有暗置的武将牌且你的武将牌均明置，则你可以依次执行这两项。`,
	gzjiansu: "俭素",
	gzjiansu_tag: "俭",
	...
	gzmoukui: "谋溃",
	gzmoukui_info: `当你使用【杀】指定目标后，你可以选择一项：①摸一张牌；②弃置该角色的一张牌；③${get.poptip("beishui")}：若此【杀】未对其造成过伤害，则该角色弃置你的一张牌。`,
	gzjinghe_new: "经合",
